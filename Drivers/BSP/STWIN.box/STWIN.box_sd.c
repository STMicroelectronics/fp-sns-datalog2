/**
  ...
  * @file    STWIN.box_sd.c
  * @author  SRA
  * @brief   This file provides a set of functions needed to manage sd card 
  *          interface.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STWIN_BOX_SD_Private_TypesDefinitions SD Private TypesDefinitions
  * @{
  */
...
/** @defgroup STWIN_BOX_SD_Exported_Variables SD Exported Variables
  * @{
  */
...
/** @defgroup STWIN_BOX_SD_Private_Variables SD Private Variables
  * @{
  */
...
/** @defgroup STWIN_BOX_SD_Private_Functions_Prototypes SD Private Functions Prototypes
  * @{
  */
...
/** @defgroup STWIN_BOX_SD_Exported_Functions SD Exported Functions
  * @{
  */
...
/** @defgroup STWIN_BOX_SD_Private_Functions SD Private Functions
  * @{
  */
#if (USE_HAL_SD_REGISTER_CALLBACKS > 0)
/**
