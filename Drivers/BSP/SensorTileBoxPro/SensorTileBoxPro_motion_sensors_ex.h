/**
  ******************************************************************************
  * @file    SensorTileBoxPro_motion_sensors_ex.h
  * @author  MEMS Application Team
  * @brief   This file contains definitions for the BSP Motion Sensors Extended interface for SensorTileBoxPro
  ******************************************************************************
  * @attention
  *
...
#ifndef __SENSORTILEBOXPRO_MOTION_SENSORS_EX_H__
#define __SENSORTILEBOXPRO_MOTION_SENSORS_EX_H__
...
#endif /* __SENSORTILEBOXPRO_MOTION_SENSORS_EX_H__ */
