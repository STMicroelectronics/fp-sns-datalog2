...
/** @defgroup ST_BOX_PRO SD
  * @{
  */

/** @defgroup ST_BOX_PRO_SD_Private_TypesDefinitions SD Private TypesDefinitions
  * @{
  */
...
/** @defgroup ST_BOX_PRO_SD_Exported_Variables SD Exported Variables
  * @{
  */
...
/** @defgroup ST_BOX_PRO_SD_Private_Variables SD Private Variables
  * @{
  */
...
/** @defgroup ST_BOX_PRO_SD_Private_Functions_Prototypes SD Private Functions Prototypes
  * @{
  */
...
/** @defgroup ST_BOX_PRO_SD_Exported_Functions SD Exported Functions
  * @{
  */
...
/** @defgroup ST_BOX_PRO_SD_Private_Functions SD Private Functions
  * @{
  */
#if (USE_HAL_SD_REGISTER_CALLBACKS > 0)
/**
...
static void SD_MspInit(SD_HandleTypeDef *hsd)
{
#define ENABLE_SD_Pin GPIO_PIN_10
