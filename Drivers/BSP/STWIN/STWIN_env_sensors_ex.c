...
/** @defgroup STWIN_ENV_SENSOR_EX STWIN ENV SENSOR EX
  * @{
  */

/** @defgroup STWIN_ENV_SENSOR_EX_Imported_Variables STWIN ENV SENSOR EX Imported Variables
  * @{
  */
...
/** @defgroup STWIN_ENV_SENSOR_EX_Exported_Functions STWIN ENV SENSOR EX Exported Functions
  * @{
  */

/**
  * @brief  Get the status of data ready bit (available only for HTS221, LPS22HH sensors)
  * @param  Instance the device instance
  * @param  Function Environmental sensor function. Could be:
  *         - ENV_HUMIDITY or ENV_TEMPERATURE for instance HTS221_0
...
/**
  * @brief  Get the register value (available only for HTS221, LPS22HH, STTS751 sensors)
  * @param  Instance the device instance
