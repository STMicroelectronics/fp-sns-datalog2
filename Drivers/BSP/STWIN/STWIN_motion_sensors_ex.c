/**
  ******************************************************************************
  * @file    STWIN_motion_sensors_ex.c
  * @author  SRA
  *
  *
...
/**
  * @brief  Enable the wake up detection (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @param  IntPin the interrupt pin to be used
  * @note   This function sets the IIS2DH accelerometer ODR to 200Hz and the IIS2DH accelerometer full scale to 2g
  * @retval BSP status
  */
int32_t BSP_MOTION_SENSOR_Enable_Wake_Up_Detection(uint32_t Instance, MOTION_SENSOR_IntPin_t IntPin)
{
  ...
  switch (Instance)
  {
    ...
    case IIS2DH_0:
      if (IIS2DH_ACC_Enable_Wake_Up_Detection(MotionCompObj[Instance]) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_ISM330DHCX_0 == 1)
    case ISM330DHCX_0:
      if (ISM330DHCX_ACC_Enable_Wake_Up_Detection(MotionCompObj[Instance],
                                                  (ISM330DHCX_SensorIntPin_t)IntPin) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Disable the wake up detection (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @retval BSP status
  */
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Disable_Wake_Up_Detection(MotionCompObj[Instance]) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Set the wake up detection threshold (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Set_Wake_Up_Threshold(MotionCompObj[Instance], Threshold) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Set the wake up detection duration (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Set_Wake_Up_Duration(MotionCompObj[Instance], Duration) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Enable the inactivity detection (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @param  IntPin the interrupt pin to be used
  * @note   This function sets the IIS2DH accelerometer ODR to 50Hz and the IIS2DH accelerometer full scale to 2g
  * @retval BSP status
  */
int32_t BSP_MOTION_SENSOR_Enable_Inactivity_Detection(uint32_t Instance, MOTION_SENSOR_IntPin_t IntPin,
                                                      uint8_t inact_mode)
{
  UNUSED(inact_mode);
  UNUSED(IntPin);
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Enable_Inactivity_Detection(MotionCompObj[Instance]) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Disable the inactivity detection (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @retval BSP status
  */
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Disable_Inactivity_Detection(MotionCompObj[Instance]) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Set the sleep duration (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @param  Duration the duration to be set
  * @retval BSP status
  */
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Set_Sleep_Duration(MotionCompObj[Instance], Duration) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Enable 6D Orientation (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @param  IntPin the interrupt pin to be used
  * @note   This function sets the IIS2DH accelerometer ODR to 200Hz and the IIS2DH accelerometer full scale to 2g
  * @retval BSP status
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Enable_6D_Orientation(MotionCompObj[Instance]) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Disable 6D Orientation (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @retval BSP status
  */
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Disable_6D_Orientation(MotionCompObj[Instance]) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Set the 6D orientation threshold (available only for IIS2DH sensor)
  * @param  Instance the device instance
  * @param  Threshold the threshold to be set
  * @retval BSP status
  */
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Set_6D_Orientation_Threshold(MotionCompObj[Instance], Threshold) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Get 6D Orientation XL (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Get_6D_Orientation_XL(MotionCompObj[Instance], xl) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Get 6D Orientation XH (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Get_6D_Orientation_XH(MotionCompObj[Instance], xh) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Get 6D Orientation YL (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Get_6D_Orientation_YL(MotionCompObj[Instance], yl) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Get 6D Orientation YH (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Get_6D_Orientation_YH(MotionCompObj[Instance], yh) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Get 6D Orientation ZL (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Get_6D_Orientation_ZL(MotionCompObj[Instance], zl) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  * @brief  Get 6D Orientation ZH (available only for IIS2DH sensor)
  * @param  Instance the device instance
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_ACC_Get_6D_Orientation_ZH(MotionCompObj[Instance], zh) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
int32_t BSP_MOTION_SENSOR_Get_Event_Status(uint32_t Instance, MOTION_SENSOR_Event_Status_t *Status)
{
  ...
  switch (Instance)
  {
    ...
    case IIS2DH_0:
      ...
      if (IIS2DH_ACC_Get_Event_Status(MotionCompObj[Instance], (IIS2DH_Event_Status_t *)(void *)Status) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_ISM330DHCX_0 == 1)
    case ISM330DHCX_0:
      if (ISM330DHCX_ACC_Get_Event_Status(MotionCompObj[Instance],
                                          (ISM330DHCX_Event_Status_t *)(void *)Status) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
/**
  ...
  * @param  Instance the device instance
  * @param  Function Motion sensor function. Could be:
  *         - MOTION_ACCELERO for instance IIS2DH_0
...
int32_t BSP_MOTION_SENSOR_Get_DRDY_Status(uint32_t Instance, uint32_t Function, uint8_t *Status)
{
  ...
  switch (Instance)
  {
    ...
    case IIS2DH_0:
      if ((Function & MOTION_ACCELERO) == MOTION_ACCELERO)
      {
        if (IIS2DH_ACC_Get_DRDY_Status(MotionCompObj[Instance], Status) != BSP_ERROR_NONE)
        {
          ret = BSP_ERROR_COMPONENT_FAILURE;
        }
        else
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_Read_Reg(MotionCompObj[Instance], Reg, Data) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_Write_Reg(MotionCompObj[Instance], Reg, Data) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_FIFO_Set_Mode(MotionCompObj[Instance], Mode) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
...
#if (USE_MOTION_SENSOR_IIS2DH_0 == 1)
    case IIS2DH_0:
      if (IIS2DH_FIFO_Get_Num_Samples(MotionCompObj[Instance], NumSamples) != BSP_ERROR_NONE)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
