...
void HAL_I2C_MspInit(I2C_HandleTypeDef *i2cHandle)
{
  ...
  else if (i2cHandle->Instance == I2C3)
  {
    ...
    handle_GPDMA1_Channel8.Init.Request = GPDMA1_REQUEST_I2C3_RX;
    ...
    __HAL_LINKDMA(i2cHandle, hdmarx, handle_GPDMA1_Channel8);
    ...
    handle_GPDMA1_Channel4.Init.Request = GPDMA1_REQUEST_I2C3_TX;
    ...
    __HAL_LINKDMA(i2cHandle, hdmatx, handle_GPDMA1_Channel4);
