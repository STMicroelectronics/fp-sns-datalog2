...
typedef enum
{
  pnpl_ism330is_acc_odr_hz12_5 = 0,
  pnpl_ism330is_acc_odr_hz26 = 1,
  pnpl_ism330is_acc_odr_hz52 = 2,
  pnpl_ism330is_acc_odr_hz104 = 3,
  pnpl_ism330is_acc_odr_hz208 = 4,
  pnpl_ism330is_acc_odr_hz416 = 5,
  pnpl_ism330is_acc_odr_hz833 = 6,
  pnpl_ism330is_acc_odr_hz1667 = 7,
  pnpl_ism330is_acc_odr_hz3333 = 8,
  pnpl_ism330is_acc_odr_hz6667 = 9,
} pnpl_ism330is_acc_odr_t;
typedef enum
{
  pnpl_ism330is_acc_fs_g2 = 0,
  pnpl_ism330is_acc_fs_g4 = 1,
  pnpl_ism330is_acc_fs_g8 = 2,
  pnpl_ism330is_acc_fs_g16 = 3,
} pnpl_ism330is_acc_fs_t;
