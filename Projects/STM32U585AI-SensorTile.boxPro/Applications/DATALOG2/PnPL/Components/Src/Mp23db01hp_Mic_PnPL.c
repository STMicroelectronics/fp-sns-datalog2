                                          ...
                                          uint8_t pretty)
{
  ...
  pnpl_mp23db01hp_mic_odr_t temp_odr_e = (pnpl_mp23db01hp_mic_odr_t)0;
  mp23db01hp_mic_get_odr(&temp_odr_e);
  json_object_dotset_number(JSON_Status, "mp23db01hp_mic.odr", temp_odr_e);
  pnpl_mp23db01hp_mic_aop_t temp_aop_e = (pnpl_mp23db01hp_mic_aop_t)0;
  mp23db01hp_mic_get_aop(&temp_aop_e);
  json_object_dotset_number(JSON_Status, "mp23db01hp_mic.aop", temp_aop_e);
  bool temp_b = 0;
  mp23db01hp_mic_get_enable(&temp_b);
  json_object_dotset_boolean(JSON_Status, "mp23db01hp_mic.enable", temp_b);
  int32_t temp_i = 0;
  mp23db01hp_mic_get_volume(&temp_i);
  json_object_dotset_number(JSON_Status, "mp23db01hp_mic.volume", temp_i);
  pnpl_mp23db01hp_mic_resolution_t temp_resolution_e = (pnpl_mp23db01hp_mic_resolution_t)0;
  mp23db01hp_mic_get_resolution(&temp_resolution_e);
  json_object_dotset_number(JSON_Status, "mp23db01hp_mic.resolution", temp_resolution_e);
                                            ...
                                            uint32_t *size, uint8_t pretty)
{
  ...
  {
    int32_t odr = (int32_t)json_object_dotget_number(tempJSONObject, "mp23db01hp_mic.odr");
    valid_property = true;
    ret = mp23db01hp_mic_set_odr((pnpl_mp23db01hp_mic_odr_t)odr, &resp_msg);
    ...
    {
      pnpl_mp23db01hp_mic_odr_t old_odr;
      mp23db01hp_mic_get_odr(&old_odr);
  ...
  if (json_object_dothas_value(tempJSONObject, "mp23db01hp_mic.enable"))
  {
    ...
    valid_property = true;
    ret = mp23db01hp_mic_set_enable(enable, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      bool old_enable;
      mp23db01hp_mic_get_enable(&old_enable);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.value", old_enable);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "mp23db01hp_mic.volume"))
  {
    int32_t volume = (int32_t)json_object_dotget_number(tempJSONObject, "mp23db01hp_mic.volume");
    valid_property = true;
    ret = mp23db01hp_mic_set_volume(volume, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      int32_t old_volume;
      mp23db01hp_mic_get_volume(&old_volume);
  ...
  if (json_object_dothas_value(tempJSONObject, "mp23db01hp_mic.samples_per_ts"))
  {
    ...
    valid_property = true;
    ret = mp23db01hp_mic_set_samples_per_ts(samples_per_ts, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      mp23db01hp_mic_get_samples_per_ts(&old_samples_per_ts);
  ...
  if (json_object_dothas_value(tempJSONObject, "mp23db01hp_mic.sensor_annotation"))
  {
    ...
    valid_property = true;
    ret = mp23db01hp_mic_set_sensor_annotation(sensor_annotation, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      mp23db01hp_mic_get_sensor_annotation(&old_sensor_annotation);
  ...
  else
  {
    ...
    char *log_message = "Invalid property for mp23db01hp_mic";
