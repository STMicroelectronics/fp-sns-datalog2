                                         ...
                                         uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream.mag.enable"))
    {
      ...
      else
      {
        ...
        lis2mdl_mag_get_st_ble_stream__mag_enable(&old_st_ble_stream__mag_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream.mag.unit"))
    {
      ...
      else
      {
        ...
        lis2mdl_mag_get_st_ble_stream__mag_unit(&old_st_ble_stream__mag_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream.mag.format"))
    {
      ...
      valid_property = true;
      ret = lis2mdl_mag_set_st_ble_stream__mag_format(st_ble_stream__mag_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lis2mdl_mag_get_st_ble_stream__mag_format(&old_st_ble_stream__mag_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream.mag.elements"))
    {
      ...
      valid_property = true;
      ret = lis2mdl_mag_set_st_ble_stream__mag_elements(st_ble_stream__mag_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lis2mdl_mag_get_st_ble_stream__mag_elements(&old_st_ble_stream__mag_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream.mag.channels"))
    {
      ...
      valid_property = true;
      ret = lis2mdl_mag_set_st_ble_stream__mag_channels(st_ble_stream__mag_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lis2mdl_mag_get_st_ble_stream__mag_channels(&old_st_ble_stream__mag_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream.mag.multiply_factor"))
    {
      ...
      valid_property = true;
      ret = lis2mdl_mag_set_st_ble_stream__mag_multiply_factor(st_ble_stream__mag_multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lis2mdl_mag_get_st_ble_stream__mag_multiply_factor(&old_st_ble_stream__mag_multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lis2mdl_mag.st_ble_stream.mag.odr"))
    {
      ...
      valid_property = true;
      ret = lis2mdl_mag_set_st_ble_stream__mag_odr(st_ble_stream__mag_odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lis2mdl_mag_get_st_ble_stream__mag_odr(&old_st_ble_stream__mag_odr);
  ...
  else
  {
    ...
    char *log_message = "Invalid property for lis2mdl_mag";
