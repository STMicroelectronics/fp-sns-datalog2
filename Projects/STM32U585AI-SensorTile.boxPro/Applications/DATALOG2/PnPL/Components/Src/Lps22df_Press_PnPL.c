                                           ...
                                           uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream.press.enable"))
    {
      ...
      valid_property = true;
      ret = lps22df_press_set_st_ble_stream__press_enable(st_ble_stream__press_enable, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lps22df_press_get_st_ble_stream__press_enable(&old_st_ble_stream__press_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream.press.unit"))
    {
      ...
      valid_property = true;
      ret = lps22df_press_set_st_ble_stream__press_unit(st_ble_stream__press_unit, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lps22df_press_get_st_ble_stream__press_unit(&old_st_ble_stream__press_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream.press.format"))
    {
      ...
      valid_property = true;
      ret = lps22df_press_set_st_ble_stream__press_format(st_ble_stream__press_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lps22df_press_get_st_ble_stream__press_format(&old_st_ble_stream__press_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream.press.elements"))
    {
      ...
      valid_property = true;
      ret = lps22df_press_set_st_ble_stream__press_elements(st_ble_stream__press_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lps22df_press_get_st_ble_stream__press_elements(&old_st_ble_stream__press_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream.press.channels"))
    {
      ...
      valid_property = true;
      ret = lps22df_press_set_st_ble_stream__press_channels(st_ble_stream__press_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lps22df_press_get_st_ble_stream__press_channels(&old_st_ble_stream__press_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream.press.multiply_factor"))
    {
      ...
      valid_property = true;
      ret = lps22df_press_set_st_ble_stream__press_multiply_factor(st_ble_stream__press_multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lps22df_press_get_st_ble_stream__press_multiply_factor(&old_st_ble_stream__press_multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "lps22df_press.st_ble_stream.press.odr"))
    {
      ...
      valid_property = true;
      ret = lps22df_press_set_st_ble_stream__press_odr(st_ble_stream__press_odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        lps22df_press_get_st_ble_stream__press_odr(&old_st_ble_stream__press_odr);
  ...
  else
  {
    ...
    char *log_message = "Invalid property for lps22df_press";
