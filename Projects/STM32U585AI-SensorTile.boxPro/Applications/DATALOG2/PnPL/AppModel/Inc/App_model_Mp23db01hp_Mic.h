/**
  ******************************************************************************
  * @file    App_model_Mp23db01hp_Mic.h
  * @author  SRA
...
#ifndef APP_MODEL_MP23DB01HP_MIC_H_
#define APP_MODEL_MP23DB01HP_MIC_H_
...
uint8_t mp23db01hp_mic_get_ioffset(float_t *value);
uint8_t mp23db01hp_mic_get_usb_dps(int32_t *value);
uint8_t mp23db01hp_mic_get_sd_dps(int32_t *value);
uint8_t mp23db01hp_mic_get_sensitivity(float_t *value);
...
#endif /* APP_MODEL_MP23DB01HP_MIC_H_ */
