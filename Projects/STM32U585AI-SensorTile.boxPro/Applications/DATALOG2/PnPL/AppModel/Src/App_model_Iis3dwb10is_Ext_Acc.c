...
uint8_t iis3dwb10is_ext_acc_comp_init(void)
{
  ...
  iis3dwb10is_ext_acc_set_st_ble_stream__id(id, NULL);
  ...
  iis3dwb10is_ext_acc_set_st_ble_stream__acc_unit("g", NULL);
  iis3dwb10is_ext_acc_set_st_ble_stream__acc_format("int24_t", NULL);
  ...
  int32_t value = 0;
  iis3dwb10is_ext_acc_get_dim(&value);
  iis3dwb10is_ext_acc_set_st_ble_stream__acc_channels(value, NULL);
  float_t sensitivity = 0.0f;
  iis3dwb10is_ext_acc_get_sensitivity(&sensitivity);
  iis3dwb10is_ext_acc_set_st_ble_stream__acc_multiply_factor(sensitivity, NULL);

  __stream_control(true);
  __sc_set_ble_stream_params(iis3dwb10is_ext_acc_model.id);
...
uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__id(int32_t *value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_id;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__acc_enable(bool *value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.status;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__acc_unit(char **value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.unit;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__acc_format(char **value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.format;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__acc_elements(int32_t *value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.elements;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__acc_channels(int32_t *value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.channel;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__acc_multiply_factor(float_t *value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.multiply_factor;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_get_st_ble_stream__acc_odr(int32_t *value)
{
  *value = iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.odr;
  return PNPL_NO_ERROR_CODE;
}
...
uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__id(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  }
  iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_id = value;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__acc_enable(bool value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  /* USER Code */
  iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.status = value;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__acc_unit(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  /* USER Code */
  strcpy(iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.unit, value);
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__acc_format(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  /* USER Code */
  strcpy(iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.format, value);
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__acc_elements(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  }
  iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.elements = value;
  return PNPL_NO_ERROR_CODE;
}

uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__acc_channels(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.channel = value;
  return ret;
}

uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__acc_multiply_factor(float_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.multiply_factor = value;
  return ret;
}

uint8_t iis3dwb10is_ext_acc_set_st_ble_stream__acc_odr(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  iis3dwb10is_ext_acc_model.st_ble_stream.st_ble_stream_objects.odr = value;
  return ret;
}
