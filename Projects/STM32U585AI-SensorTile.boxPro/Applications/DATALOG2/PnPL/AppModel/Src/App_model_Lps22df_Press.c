...
uint8_t lps22df_press_comp_init(void)
{
  ...
  lps22df_press_set_st_ble_stream__id(id, NULL);
  ...
  lps22df_press_set_st_ble_stream__press__unit("hPa", NULL);
  lps22df_press_set_st_ble_stream__press__format("float", NULL);

  addSensorToAppModel(id, &lps22df_press_model);

  lps22df_press_set_sensor_annotation("\0", NULL);
  lps22df_press_set_odr(pnpl_lps22df_press_odr_hz1, NULL);
  lps22df_press_set_enable(true, NULL);
  ...
  lps22df_press_set_st_ble_stream__press__channels(value, NULL);
  float sensitivity = 0.0f;
  lps22df_press_get_sensitivity(&sensitivity);
  lps22df_press_set_st_ble_stream__press__multiply_factor(sensitivity, NULL);

  __stream_control(true);
  __sc_set_ble_stream_params(lps22df_press_model.id);
...
{
  float fs = lps22df_press_model.sensor_status->type.mems.fs;
...
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_id;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22df_press_get_st_ble_stream__press__enable(bool *value)
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_objects.status;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22df_press_get_st_ble_stream__press__unit(char **value)
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_objects.unit;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22df_press_get_st_ble_stream__press__format(char **value)
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_objects.format;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22df_press_get_st_ble_stream__press__elements(int32_t *value)
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_objects.elements;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22df_press_get_st_ble_stream__press__channels(int32_t *value)
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_objects.channel;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22df_press_get_st_ble_stream__press__multiply_factor(float *value)
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_objects.multiply_factor;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22df_press_get_st_ble_stream__press__odr(int32_t *value)
{
  /* USER Code */
  *value = lps22df_press_model.st_ble_stream.st_ble_stream_objects.odr;
  return PNPL_NO_ERROR_CODE;
}
...
uint8_t lps22df_press_set_st_ble_stream__id(int32_t value, char **response_message)
{
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22df_press_model.st_ble_stream.st_ble_stream_id = value;
  return ret;
}

uint8_t lps22df_press_set_st_ble_stream__press__enable(bool value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22df_press_model.st_ble_stream.st_ble_stream_objects.status = value;
  return ret;
}

uint8_t lps22df_press_set_st_ble_stream__press__unit(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  strcpy(lps22df_press_model.st_ble_stream.st_ble_stream_objects.unit, value);
  return ret;
}

uint8_t lps22df_press_set_st_ble_stream__press__format(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  strcpy(lps22df_press_model.st_ble_stream.st_ble_stream_objects.format, value);
  return ret;
}

uint8_t lps22df_press_set_st_ble_stream__press__elements(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22df_press_model.st_ble_stream.st_ble_stream_objects.elements = value;
  return ret;
}

uint8_t lps22df_press_set_st_ble_stream__press__channels(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22df_press_model.st_ble_stream.st_ble_stream_objects.channel = value;
  return ret;
}

uint8_t lps22df_press_set_st_ble_stream__press__multiply_factor(float value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22df_press_model.st_ble_stream.st_ble_stream_objects.multiply_factor = value;
  return ret;
}

uint8_t lps22df_press_set_st_ble_stream__press__odr(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
