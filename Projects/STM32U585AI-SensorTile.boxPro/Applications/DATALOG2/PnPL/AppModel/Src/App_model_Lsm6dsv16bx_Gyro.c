...
uint8_t lsm6dsv16bx_gyro_get_st_ble_stream__gyro_multiply_factor(float *value)
{
...
uint8_t lsm6dsv16bx_gyro_set_st_ble_stream__gyro_multiply_factor(float value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
