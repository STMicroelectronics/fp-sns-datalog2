...
uint8_t lsm6dsv16x_acc_comp_init(void)
{
  ...
  lsm6dsv16x_acc_set_st_ble_stream__id(id, NULL);
  ...
  lsm6dsv16x_acc_set_st_ble_stream__acc_unit("g", NULL);
  lsm6dsv16x_acc_set_st_ble_stream__acc_format("int16_t", NULL);

  addSensorToAppModel(id, &lsm6dsv16x_acc_model);

  lsm6dsv16x_acc_set_sensor_annotation("\0", NULL);
  lsm6dsv16x_acc_set_odr(pnpl_lsm6dsv16x_acc_odr_hz7680, NULL);
  ...
  lsm6dsv16x_acc_set_st_ble_stream__acc_channels(value, NULL);
  float sensitivity = 0.0f;
  lsm6dsv16x_acc_get_sensitivity(&sensitivity);
  lsm6dsv16x_acc_set_st_ble_stream__acc_multiply_factor(sensitivity, NULL);

  __stream_control(true);
  __sc_set_ble_stream_params(lsm6dsv16x_acc_model.id);
...
{
  float odr = lsm6dsv16x_acc_model.sensor_status->type.mems.odr;
  if (odr < 8.0f)
  {
...
{
  float fs = lsm6dsv16x_acc_model.sensor_status->type.mems.fs;
  if (fs < 3.0f)
  {
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__id(int32_t *value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_id;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_enable(bool *value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.status;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_unit(char **value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.unit;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_format(char **value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.format;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_elements(int32_t *value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.elements;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_channels(int32_t *value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.channel;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_multiply_factor(float *value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.multiply_factor;
  return PNPL_NO_ERROR_CODE;
}

uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_odr(int32_t *value)
{
  *value = lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.odr;
  return PNPL_NO_ERROR_CODE;
}
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__id(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_id = value;
  return ret;
}

uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_enable(bool value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.status = value;
  return ret;
}

uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_unit(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  strcpy(lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.unit, value);
  return ret;
}

uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_format(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  strcpy(lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.format, value);
  return ret;
}

uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_elements(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.elements = value;
  return ret;
}

uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_channels(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.channel = value;
  return ret;
}

uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_multiply_factor(float value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lsm6dsv16x_acc_model.st_ble_stream.st_ble_stream_objects.multiply_factor = value;
  return ret;
}

uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_odr(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
