...
uint8_t lsm6dsv16x_acc_comp_init(void)
{
  ...
  lsm6dsv16x_acc_set_st_ble_stream__acc__unit("g", NULL);
  lsm6dsv16x_acc_set_st_ble_stream__acc__format("int16_t", NULL);
  ...
  lsm6dsv16x_acc_set_st_ble_stream__acc__channels(value, NULL);
  float sensitivity = 0.0f;
  lsm6dsv16x_acc_get_sensitivity(&sensitivity);
  lsm6dsv16x_acc_set_st_ble_stream__acc__multiply_factor(sensitivity, NULL);
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc__enable(bool *value)
{
  /* USER Code */
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc__unit(char **value)
{
  /* USER Code */
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc__format(char **value)
{
  /* USER Code */
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc__elements(int32_t *value)
{
  /* USER Code */
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc__channels(int32_t *value)
{
  /* USER Code */
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc__multiply_factor(float *value)
{
  /* USER Code */
...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc__odr(int32_t *value)
{
  /* USER Code */
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc__enable(bool value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc__unit(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc__format(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc__elements(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc__channels(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc__multiply_factor(float value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc__odr(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
