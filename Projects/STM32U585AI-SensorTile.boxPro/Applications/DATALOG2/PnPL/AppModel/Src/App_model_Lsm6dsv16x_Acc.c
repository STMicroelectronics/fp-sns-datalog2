...
uint8_t lsm6dsv16x_acc_get_st_ble_stream__acc_multiply_factor(float_t *value)
{
...
uint8_t lsm6dsv16x_acc_set_st_ble_stream__acc_multiply_factor(float_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
