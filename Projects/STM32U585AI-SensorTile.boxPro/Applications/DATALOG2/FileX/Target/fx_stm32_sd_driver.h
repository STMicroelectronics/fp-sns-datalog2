...
#define invalidate_cache_by_addr(__ptr__, __size__)           HAL_DCACHE_InvalidateByAddr(&\
    hdcache1, (UINT *)__ptr__, (UINT)__size__)
#define clean_cache_by_addr(__ptr__, __size__)                HAL_DCACHE_CleanByAddr(&\
    hdcache1, (UINT *)__ptr__, (UINT)__size__)
#endif
...
#define FX_STM32_SD_POST_INIT(_media_ptr)                do {                                                                                                \
