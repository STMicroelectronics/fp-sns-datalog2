...
uint8_t lis2mdl_mag_comp_init(void)
{
  ...
  lis2mdl_mag_set_samples_per_ts__val(0);
#else
  lis2mdl_mag_set_samples_per_ts__val(100);
#endif
...
uint8_t lis2mdl_mag_set_samples_per_ts__val(int32_t value)
{
  /* User code */
  int32_t min_v = 0;
  lis2mdl_mag_get_samples_per_ts__min(&min_v);
  int32_t max_v = 0;
  lis2mdl_mag_get_samples_per_ts__max(&max_v);
...
uint8_t lis2du12_acc_comp_init(void)
{
  ...
  /* User code */
#if (HSD_USE_DUMMY_DATA == 1)
  lis2du12_acc_set_samples_per_ts__val(0);
#else
  lis2du12_acc_set_samples_per_ts__val(1000);
#endif
...
uint8_t lis2du12_acc_set_samples_per_ts__val(int32_t value)
{
  /* User code */
  int32_t min_v = 0;
  lis2du12_acc_get_samples_per_ts__min(&min_v);
  int32_t max_v = 0;
  lis2du12_acc_get_samples_per_ts__max(&max_v);
  if(value >= min_v && value <= max_v)
  {
...
uint8_t lsm6dsv16x_acc_comp_init(void)
{
  ...
  /* User code */
#if (HSD_USE_DUMMY_DATA == 1)
  lsm6dsv16x_acc_set_samples_per_ts__val(0);
#else
  lsm6dsv16x_acc_set_samples_per_ts__val(1000);
#endif
...
uint8_t lsm6dsv16x_acc_set_samples_per_ts__val(int32_t value)
{
  /* User code */
  int32_t min_v = 0;
  lsm6dsv16x_acc_get_samples_per_ts__min(&min_v);
  int32_t max_v = 0;
  lsm6dsv16x_acc_get_samples_per_ts__max(&max_v);
  if(value >= min_v && value <= max_v)
  {
...
uint8_t lsm6dsv16x_gyro_comp_init(void)
{
  ...
  /* User code */
#if (HSD_USE_DUMMY_DATA == 1)
  lsm6dsv16x_gyro_set_samples_per_ts__val(0);
#else
  lsm6dsv16x_gyro_set_samples_per_ts__val(1000);
#endif
...
uint8_t lsm6dsv16x_gyro_set_samples_per_ts__val(int32_t value)
{
  /* User code */
  int32_t min_v = 0;
  lsm6dsv16x_gyro_get_samples_per_ts__min(&min_v);
  int32_t max_v = 0;
  lsm6dsv16x_gyro_get_samples_per_ts__max(&max_v);
  if(value >= min_v && value <= max_v)
  {
...
uint8_t lsm6dsv16x_mlc_comp_init(void)
{
  ...
  /* User code */
  lsm6dsv16x_mlc_set_samples_per_ts__val(1);
...
uint8_t lsm6dsv16x_mlc_set_samples_per_ts__val(int32_t value)
{
  /* User code */
  int32_t min_v = 0;
  lsm6dsv16x_mlc_get_samples_per_ts__min(&min_v);
  int32_t max_v = 0;
  lsm6dsv16x_mlc_get_samples_per_ts__max(&max_v);
  if(value >= min_v && value <= max_v)
  {
...
uint8_t mp23db01hp_mic_comp_init(void)
{
  ...
  /* User code */
#if (HSD_USE_DUMMY_DATA == 1)
  mp23db01hp_mic_set_samples_per_ts__val(0);
#else
  mp23db01hp_mic_set_samples_per_ts__val(1000);
#endif
...
uint8_t mp23db01hp_mic_set_samples_per_ts__val(int32_t value)
{
  /* User code */
  int32_t min_v = 0;
  mp23db01hp_mic_get_samples_per_ts__min(&min_v);
  int32_t max_v = 0;
  mp23db01hp_mic_get_samples_per_ts__max(&max_v);
  if(value >= min_v && value <= max_v)
  {
...
uint8_t lps22df_press_comp_init(void)
{
  ...
  /* User code */
#if (HSD_USE_DUMMY_DATA == 1)
  lps22df_press_set_samples_per_ts__val(0);
#else
  lps22df_press_set_samples_per_ts__val(200);
#endif
...
{
  /* User code */
  sys_error_code_t ret_t = SMSensorSetODR(lps22df_press_model.id, value);
  if(ret_t == SYS_NO_ERROR_CODE)
  {
...
uint8_t lps22df_press_set_samples_per_ts__val(int32_t value)
{
  /* User code */
  int32_t min_v = 0;
  lps22df_press_get_samples_per_ts__min(&min_v);
  int32_t max_v = 0;
  lps22df_press_get_samples_per_ts__max(&max_v);
  if(value >= min_v && value <= max_v)
  {
