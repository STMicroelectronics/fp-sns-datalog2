...
{
  uint8_t (*ism330is_ispu_load_file)(IIsm330is_Ispu_t *_this, const char *ucf_data, int32_t ucf_size,
...
inline uint8_t IIsm330is_Ispu_load_file(IIsm330is_Ispu_t *_this, const char *ucf_data, int32_t ucf_size,
                                        const char *output_data, int32_t output_size)
{
