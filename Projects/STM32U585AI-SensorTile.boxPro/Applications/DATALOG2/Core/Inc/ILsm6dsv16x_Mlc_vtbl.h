...
{
  uint8_t (*lsm6dsv16x_mlc_load_file)(ILsm6dsv16x_Mlc_t *_this, int32_t size, const char *data);
};
...
inline uint8_t ILsm6dsv16x_Mlc_load_file(ILsm6dsv16x_Mlc_t *_this, int32_t size, const char *data)
{
