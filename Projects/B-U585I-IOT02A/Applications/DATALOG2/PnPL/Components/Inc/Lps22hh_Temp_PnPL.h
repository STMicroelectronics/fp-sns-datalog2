...
typedef enum
{
  ...
  pnpl_lps22hh_temp_odr_hz4 = 1,
  pnpl_lps22hh_temp_odr_hz10 = 2,
  pnpl_lps22hh_temp_odr_hz25 = 3,
  pnpl_lps22hh_temp_odr_hz50 = 4,
  pnpl_lps22hh_temp_odr_hz75 = 5,
  pnpl_lps22hh_temp_odr_hz100 = 6,
  pnpl_lps22hh_temp_odr_hz200 = 7,
} pnpl_lps22hh_temp_odr_t;
typedef enum
{
  pnpl_lps22hh_temp_fs_cdeg85 = 0,
