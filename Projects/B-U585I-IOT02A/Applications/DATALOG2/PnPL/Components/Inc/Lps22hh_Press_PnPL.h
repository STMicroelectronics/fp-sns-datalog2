...
typedef enum
{
  pnpl_lps22hh_press_odr_hz1 = 0,
  pnpl_lps22hh_press_odr_hz4 = 1,
  pnpl_lps22hh_press_odr_hz10 = 2,
  pnpl_lps22hh_press_odr_hz25 = 3,
  pnpl_lps22hh_press_odr_hz50 = 4,
  pnpl_lps22hh_press_odr_hz75 = 5,
  pnpl_lps22hh_press_odr_hz100 = 6,
  pnpl_lps22hh_press_odr_hz200 = 7,
} pnpl_lps22hh_press_odr_t;
typedef enum
{
  pnpl_lps22hh_press_fs_hpa1260 = 0,
  pnpl_lps22hh_press_fs_hpa4060 = 1,
} pnpl_lps22hh_press_fs_t;
...
uint8_t Lps22hh_Press_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size,
                                         uint8_t pretty);
