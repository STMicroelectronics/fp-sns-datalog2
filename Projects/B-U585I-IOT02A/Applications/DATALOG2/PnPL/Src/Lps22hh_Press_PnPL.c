...
uint8_t Lps22hh_Press_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size, uint8_t pretty)
{
  ...
  else if(temp_f == lps22hh_press_odr_hz4)
  {
    enum_id = 1;
  }
  ...
  else if(temp_f == lps22hh_press_fs_hpa4060)
  {
    enum_id = 1;
  }
...
uint8_t Lps22hh_Press_PnPL_vtblSetProperty(IPnPLComponent_t *_this, char *serializedJSON)
{
  ...
  if(json_object_dothas_value(tempJSONObject, "lps22hh_press.odr"))
  {
    ...
    case 0:
      ...
      break;
    case 1:
      lps22hh_press_set_odr(lps22hh_press_odr_hz4);
      break;
    case 2:
  ...
  if(json_object_dothas_value(tempJSONObject, "lps22hh_press.fs"))
  {
    int fs = (int)json_object_dotget_number(tempJSONObject, "lps22hh_press.fs");
    switch(fs)
    {
    case 0:
      lps22hh_press_set_fs(lps22hh_press_fs_hpa1260);
      break;
    case 1:
      lps22hh_press_set_fs(lps22hh_press_fs_hpa4060);
      break;
    }
  }
