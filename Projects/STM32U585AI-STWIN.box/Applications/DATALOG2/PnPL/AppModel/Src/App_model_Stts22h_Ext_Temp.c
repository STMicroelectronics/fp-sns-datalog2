...
uint8_t stts22h_ext_temp_comp_init(void)
{
  ...
  stts22h_ext_temp_set_st_ble_stream__temp_format("float_t", NULL);
...
{
  float_t odr = stts22h_ext_temp_model.sensor_status->type.mems.odr;
  if (odr < 2.0f)
  {
...
{
  float_t fs = stts22h_ext_temp_model.sensor_status->type.mems.fs;
...
uint8_t stts22h_ext_temp_get_ioffset(float_t *value)
{
...
uint8_t stts22h_ext_temp_get_measodr(float_t *value)
{
...
uint8_t stts22h_ext_temp_get_sensitivity(float_t *value)
{
...
uint8_t stts22h_ext_temp_get_st_ble_stream__temp_multiply_factor(float_t *value)
{
...
uint8_t stts22h_ext_temp_set_st_ble_stream__temp_multiply_factor(float_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
