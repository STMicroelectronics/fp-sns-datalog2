...
uint8_t ism330dhcx_gyro_comp_init(void)
{
  ...
  ism330dhcx_gyro_set_st_ble_stream__gyro__unit("dps", NULL);
  ism330dhcx_gyro_set_st_ble_stream__gyro__format("int16_t", NULL);
  ...
  ism330dhcx_gyro_set_enable(true, NULL);
  ...
  ism330dhcx_gyro_set_st_ble_stream__gyro__channels(value, NULL);
  float sensitivity = 0.0f;
  ism330dhcx_gyro_get_sensitivity(&sensitivity);
  ism330dhcx_gyro_set_st_ble_stream__gyro__multiply_factor(sensitivity, NULL);
...
uint8_t ism330dhcx_gyro_get_st_ble_stream__gyro__enable(bool *value)
{
  /* USER Code */
...
uint8_t ism330dhcx_gyro_get_st_ble_stream__gyro__unit(char **value)
{
  /* USER Code */
...
uint8_t ism330dhcx_gyro_get_st_ble_stream__gyro__format(char **value)
{
  /* USER Code */
...
uint8_t ism330dhcx_gyro_get_st_ble_stream__gyro__elements(int32_t *value)
{
  /* USER Code */
...
uint8_t ism330dhcx_gyro_get_st_ble_stream__gyro__channels(int32_t *value)
{
  /* USER Code */
...
uint8_t ism330dhcx_gyro_get_st_ble_stream__gyro__multiply_factor(float *value)
{
  /* USER Code */
...
uint8_t ism330dhcx_gyro_get_st_ble_stream__gyro__odr(int32_t *value)
{
  /* USER Code */
...
uint8_t ism330dhcx_gyro_set_st_ble_stream__gyro__enable(bool value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t ism330dhcx_gyro_set_st_ble_stream__gyro__unit(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t ism330dhcx_gyro_set_st_ble_stream__gyro__format(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t ism330dhcx_gyro_set_st_ble_stream__gyro__elements(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t ism330dhcx_gyro_set_st_ble_stream__gyro__channels(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t ism330dhcx_gyro_set_st_ble_stream__gyro__multiply_factor(float value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t ism330dhcx_gyro_set_st_ble_stream__gyro__odr(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
