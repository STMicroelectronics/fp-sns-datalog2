...
uint8_t iis2iclx_acc_get_st_ble_stream__acc_multiply_factor(float *value)
{
...
uint8_t iis2iclx_acc_set_st_ble_stream__acc_multiply_factor(float value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
