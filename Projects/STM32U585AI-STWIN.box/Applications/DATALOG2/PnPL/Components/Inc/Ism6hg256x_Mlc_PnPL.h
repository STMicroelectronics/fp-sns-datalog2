...
/**
  ...
  * dtmi:appconfig:steval_stwinbx1:fpSnsDatalog2_datalog2:sensors:ism6hg256x_mlc;1
  *
...
#ifndef _PNPL_ISM6HG256X_MLC_H_
#define _PNPL_ISM6HG256X_MLC_H_
...
/**
  * Create a type name for _Ism6hg256x_Mlc_PnPL.
 */
typedef struct _Ism6hg256x_Mlc_PnPL Ism6hg256x_Mlc_PnPL;

/* Public API declaration ----------------------------------------------------*/

IPnPLComponent_t *Ism6hg256x_Mlc_PnPLAlloc(void);
 ...
 */
IPnPLComponent_t *Ism6hg256x_Mlc_PnPLGetComponentIF(Ism6hg256x_Mlc_PnPL *_this);

#ifdef __cplusplus
}
#endif

#endif /* _PNPL_ISM6HG256X_MLC_H_ */
