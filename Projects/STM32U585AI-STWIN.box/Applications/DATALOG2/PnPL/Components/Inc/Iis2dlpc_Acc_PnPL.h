...
typedef enum
{
  pnpl_iis2dlpc_acc_odr_hz12_5 = 0,
  pnpl_iis2dlpc_acc_odr_hz25 = 1,
  pnpl_iis2dlpc_acc_odr_hz50 = 2,
  pnpl_iis2dlpc_acc_odr_hz100 = 3,
  pnpl_iis2dlpc_acc_odr_hz200 = 4,
  pnpl_iis2dlpc_acc_odr_hz400 = 5,
  pnpl_iis2dlpc_acc_odr_hz800 = 6,
  pnpl_iis2dlpc_acc_odr_hz1600 = 7,
} pnpl_iis2dlpc_acc_odr_t;
typedef enum
{
  pnpl_iis2dlpc_acc_fs_g2 = 0,
  pnpl_iis2dlpc_acc_fs_g4 = 1,
  pnpl_iis2dlpc_acc_fs_g8 = 2,
  pnpl_iis2dlpc_acc_fs_g16 = 3,
} pnpl_iis2dlpc_acc_fs_t;
