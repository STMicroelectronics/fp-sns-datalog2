...
#ifndef _PNPL_WIFI_CONFIG_H_
#define _PNPL_WIFI_CONFIG_H_
...
/**
  * Create a type name for _Wifi_Config_PnPL.
 */
typedef struct _Wifi_Config_PnPL Wifi_Config_PnPL;

/* Public API declaration ----------------------------------------------------*/

IPnPLComponent_t *Wifi_Config_PnPLAlloc(void);
 ...
 */
IPnPLComponent_t *Wifi_Config_PnPLGetComponentIF(Wifi_Config_PnPL *_this);

#ifdef __cplusplus
}
#endif

#endif /* _PNPL_WIFI_CONFIG_H_ */
