...
#ifndef _PNPL_ISM330BX_MLC_H_
#define _PNPL_ISM330BX_MLC_H_
...
/**
  * Create a type name for _Ism330bx_Mlc_PnPL.
 */
typedef struct _Ism330bx_Mlc_PnPL Ism330bx_Mlc_PnPL;

/* Public API declaration ----------------------------------------------------*/

IPnPLComponent_t *Ism330bx_Mlc_PnPLAlloc(void);
 ...
 */
IPnPLComponent_t *Ism330bx_Mlc_PnPLGetComponentIF(Ism330bx_Mlc_PnPL *_this);

#ifdef __cplusplus
}
#endif

#endif /* _PNPL_ISM330BX_MLC_H_ */
