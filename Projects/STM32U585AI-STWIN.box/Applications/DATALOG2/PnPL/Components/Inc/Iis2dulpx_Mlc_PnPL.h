...
#ifndef _PNPL_IIS2DULPX_MLC_H_
#define _PNPL_IIS2DULPX_MLC_H_
...
uint8_t Iis2dulpx_Mlc_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size,
                                         uint8_t pretty);
...
/**
  * Create a type name for _Iis2dulpx_Mlc_PnPL.
 */
typedef struct _Iis2dulpx_Mlc_PnPL Iis2dulpx_Mlc_PnPL;

/* Public API declaration ----------------------------------------------------*/

IPnPLComponent_t *Iis2dulpx_Mlc_PnPLAlloc(void);
 ...
 */
IPnPLComponent_t *Iis2dulpx_Mlc_PnPLGetComponentIF(Iis2dulpx_Mlc_PnPL *_this);

#ifdef __cplusplus
}
#endif

#endif /* _PNPL_IIS2DULPX_MLC_H_ */
