...
#ifndef _PNPL_STTS22H_EXT_TEMP_H_
#define _PNPL_STTS22H_EXT_TEMP_H_

typedef enum
{
  pnpl_stts22h_ext_temp_odr_hz1 = 0,
  pnpl_stts22h_ext_temp_odr_hz25 = 1,
  pnpl_stts22h_ext_temp_odr_hz50 = 2,
  pnpl_stts22h_ext_temp_odr_hz100 = 3,
  pnpl_stts22h_ext_temp_odr_hz200 = 4,
} pnpl_stts22h_ext_temp_odr_t;
typedef enum
{
  pnpl_stts22h_ext_temp_fs_cdeg100 = 0,
} pnpl_stts22h_ext_temp_fs_t;
...
/**
  * Create a type name for _Stts22h_Ext_Temp_PnPL.
 */
typedef struct _Stts22h_Ext_Temp_PnPL Stts22h_Ext_Temp_PnPL;

/* Public API declaration ----------------------------------------------------*/

IPnPLComponent_t *Stts22h_Ext_Temp_PnPLAlloc(void);
 ...
 */
IPnPLComponent_t *Stts22h_Ext_Temp_PnPLGetComponentIF(Stts22h_Ext_Temp_PnPL *_this);

#ifdef __cplusplus
}
#endif

#endif /* _PNPL_STTS22H_EXT_TEMP_H_ */
