...
uint8_t Iis2dulpx_Acc_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size, uint8_t pretty)
{
  ...
  iis2dulpx_acc_get_st_ble_stream__id(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2dulpx_acc.st_ble_stream.id", temp_i);
  iis2dulpx_acc_get_st_ble_stream__acc_enable(&temp_b);
  json_object_dotset_boolean(JSON_Status, "iis2dulpx_acc.st_ble_stream.acc.enable", temp_b);
  iis2dulpx_acc_get_st_ble_stream__acc_unit(&temp_s);
  json_object_dotset_string(JSON_Status, "iis2dulpx_acc.st_ble_stream.acc.unit", temp_s);
  iis2dulpx_acc_get_st_ble_stream__acc_format(&temp_s);
  json_object_dotset_string(JSON_Status, "iis2dulpx_acc.st_ble_stream.acc.format", temp_s);
  iis2dulpx_acc_get_st_ble_stream__acc_elements(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2dulpx_acc.st_ble_stream.acc.elements", temp_i);
  iis2dulpx_acc_get_st_ble_stream__acc_channels(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2dulpx_acc.st_ble_stream.acc.channels", temp_i);
  iis2dulpx_acc_get_st_ble_stream__acc_multiply_factor(&temp_f);
  json_object_dotset_number(JSON_Status, "iis2dulpx_acc.st_ble_stream.acc.multiply_factor", temp_f);
  iis2dulpx_acc_get_st_ble_stream__acc_odr(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2dulpx_acc.st_ble_stream.acc.odr", temp_i);
                                           ...
                                           uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream.id"))
    {
      int32_t st_ble_stream__id = (int32_t)json_object_dotget_number(tempJSONObject, "iis2dulpx_acc.st_ble_stream.id");
      valid_property = true;
      ret = iis2dulpx_acc_set_st_ble_stream__id(st_ble_stream__id, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dulpx_acc_get_st_ble_stream__id(&old_st_ble_stream__id);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream.acc.enable"))
    {
      ...
      else
      {
        ...
        iis2dulpx_acc_get_st_ble_stream__acc_enable(&old_st_ble_stream__acc_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream.acc.unit"))
    {
      ...
      else
      {
        ...
        iis2dulpx_acc_get_st_ble_stream__acc_unit(&old_st_ble_stream__acc_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream.acc.format"))
    {
      const char *st_ble_stream__acc_format = json_object_dotget_string(tempJSONObject,
                                                                        "iis2dulpx_acc.st_ble_stream.acc.format");
      valid_property = true;
      ret = iis2dulpx_acc_set_st_ble_stream__acc_format(st_ble_stream__acc_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dulpx_acc_get_st_ble_stream__acc_format(&old_st_ble_stream__acc_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream.acc.elements"))
    {
      int32_t st_ble_stream__acc_elements = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                               "iis2dulpx_acc.st_ble_stream.acc.elements");
      valid_property = true;
      ret = iis2dulpx_acc_set_st_ble_stream__acc_elements(st_ble_stream__acc_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dulpx_acc_get_st_ble_stream__acc_elements(&old_st_ble_stream__acc_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream.acc.channels"))
    {
      int32_t st_ble_stream__acc_channels = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                               "iis2dulpx_acc.st_ble_stream.acc.channels");
      valid_property = true;
      ret = iis2dulpx_acc_set_st_ble_stream__acc_channels(st_ble_stream__acc_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dulpx_acc_get_st_ble_stream__acc_channels(&old_st_ble_stream__acc_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dulpx_acc.st_ble_stream.acc.odr"))
    {
      int32_t st_ble_stream__acc_odr = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                          "iis2dulpx_acc.st_ble_stream.acc.odr");
      valid_property = true;
      ret = iis2dulpx_acc_set_st_ble_stream__acc_odr(st_ble_stream__acc_odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dulpx_acc_get_st_ble_stream__acc_odr(&old_st_ble_stream__acc_odr);
