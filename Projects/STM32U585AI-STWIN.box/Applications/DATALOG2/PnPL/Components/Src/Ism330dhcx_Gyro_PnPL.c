...
/**
  ...
  * dtmi:vespucci:steval_stwinbx1:fpSnsDatalog2_datalog2:sensors:ism330dhcx_gyro;4
  *
                                             ...
                                             uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.enable"))
    {
      ...
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro__enable(st_ble_stream__gyro__enable, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro__enable(&old_st_ble_stream__gyro__enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.unit"))
    {
      ...
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro__unit(st_ble_stream__gyro__unit, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro__unit(&old_st_ble_stream__gyro__unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.format"))
    {
      ...
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro__format(st_ble_stream__gyro__format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro__format(&old_st_ble_stream__gyro__format);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.elements"))
    {
      ...
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro__elements(st_ble_stream__gyro__elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro__elements(&old_st_ble_stream__gyro__elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.channels"))
    {
      ...
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro__channels(st_ble_stream__gyro__channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro__channels(&old_st_ble_stream__gyro__channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.multiply_factor"))
    {
      ...
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro__multiply_factor(st_ble_stream__gyro__multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro__multiply_factor(&old_st_ble_stream__gyro__multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.odr"))
    {
      ...
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro__odr(st_ble_stream__gyro__odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro__odr(&old_st_ble_stream__gyro__odr);
