                                           ...
                                           uint8_t pretty)
{
  ...
  ism330dhcx_gyro_get_st_ble_stream__id(&temp_i);
  json_object_dotset_number(JSON_Status, "ism330dhcx_gyro.st_ble_stream.id", temp_i);
  ism330dhcx_gyro_get_st_ble_stream__gyro_enable(&temp_b);
  json_object_dotset_boolean(JSON_Status, "ism330dhcx_gyro.st_ble_stream.gyro.enable", temp_b);
  ism330dhcx_gyro_get_st_ble_stream__gyro_unit(&temp_s);
  json_object_dotset_string(JSON_Status, "ism330dhcx_gyro.st_ble_stream.gyro.unit", temp_s);
  ism330dhcx_gyro_get_st_ble_stream__gyro_format(&temp_s);
  json_object_dotset_string(JSON_Status, "ism330dhcx_gyro.st_ble_stream.gyro.format", temp_s);
  ism330dhcx_gyro_get_st_ble_stream__gyro_elements(&temp_i);
  json_object_dotset_number(JSON_Status, "ism330dhcx_gyro.st_ble_stream.gyro.elements", temp_i);
  ism330dhcx_gyro_get_st_ble_stream__gyro_channels(&temp_i);
  json_object_dotset_number(JSON_Status, "ism330dhcx_gyro.st_ble_stream.gyro.channels", temp_i);
  ism330dhcx_gyro_get_st_ble_stream__gyro_multiply_factor(&temp_f);
  json_object_dotset_number(JSON_Status, "ism330dhcx_gyro.st_ble_stream.gyro.multiply_factor", temp_f);
  ism330dhcx_gyro_get_st_ble_stream__gyro_odr(&temp_i);
  json_object_dotset_number(JSON_Status, "ism330dhcx_gyro.st_ble_stream.gyro.odr", temp_i);
                                             ...
                                             uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.id"))
    {
      int32_t st_ble_stream__id = (int32_t)json_object_dotget_number(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.id");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__id(st_ble_stream__id, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__id(&old_st_ble_stream__id);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.enable"))
    {
      bool st_ble_stream__gyro_enable = json_object_dotget_boolean(tempJSONObject,
                                                                   "ism330dhcx_gyro.st_ble_stream.gyro.enable");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro_enable(st_ble_stream__gyro_enable, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro_enable(&old_st_ble_stream__gyro_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.unit"))
    {
      const char *st_ble_stream__gyro_unit = json_object_dotget_string(tempJSONObject,
                                                                       "ism330dhcx_gyro.st_ble_stream.gyro.unit");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro_unit(st_ble_stream__gyro_unit, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro_unit(&old_st_ble_stream__gyro_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.format"))
    {
      const char *st_ble_stream__gyro_format = json_object_dotget_string(tempJSONObject,
                                                                         "ism330dhcx_gyro.st_ble_stream.gyro.format");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro_format(st_ble_stream__gyro_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro_format(&old_st_ble_stream__gyro_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.elements"))
    {
      int32_t st_ble_stream__gyro_elements = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                                "ism330dhcx_gyro.st_ble_stream.gyro.elements");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro_elements(st_ble_stream__gyro_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro_elements(&old_st_ble_stream__gyro_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.channels"))
    {
      int32_t st_ble_stream__gyro_channels = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                                "ism330dhcx_gyro.st_ble_stream.gyro.channels");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro_channels(st_ble_stream__gyro_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro_channels(&old_st_ble_stream__gyro_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.multiply_factor"))
    {
      float st_ble_stream__gyro_multiply_factor = (float)json_object_dotget_number(tempJSONObject,
                                                                                   "ism330dhcx_gyro.st_ble_stream.gyro.multiply_factor");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro_multiply_factor(st_ble_stream__gyro_multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro_multiply_factor(&old_st_ble_stream__gyro_multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.st_ble_stream.gyro.odr"))
    {
      int32_t st_ble_stream__gyro_odr = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                           "ism330dhcx_gyro.st_ble_stream.gyro.odr");
      valid_property = true;
      ret = ism330dhcx_gyro_set_st_ble_stream__gyro_odr(st_ble_stream__gyro_odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330dhcx_gyro_get_st_ble_stream__gyro_odr(&old_st_ble_stream__gyro_odr);
  ...
  else
  {
    ...
    char *log_message = "Invalid property for ism330dhcx_gyro";
