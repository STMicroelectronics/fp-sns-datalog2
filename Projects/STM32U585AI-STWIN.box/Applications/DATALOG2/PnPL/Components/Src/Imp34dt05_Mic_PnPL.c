...
uint8_t Imp34dt05_Mic_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size, uint8_t pretty)
{
  ...
  pnpl_imp34dt05_mic_odr_t temp_odr_e = (pnpl_imp34dt05_mic_odr_t)0;
  imp34dt05_mic_get_odr(&temp_odr_e);
  json_object_dotset_number(JSON_Status, "imp34dt05_mic.odr", temp_odr_e);
  pnpl_imp34dt05_mic_aop_t temp_aop_e = (pnpl_imp34dt05_mic_aop_t)0;
  imp34dt05_mic_get_aop(&temp_aop_e);
  json_object_dotset_number(JSON_Status, "imp34dt05_mic.aop", temp_aop_e);
  bool temp_b = 0;
  ...
  pnpl_imp34dt05_mic_resolution_t temp_resolution_e = (pnpl_imp34dt05_mic_resolution_t)0;
  imp34dt05_mic_get_resolution(&temp_resolution_e);
  json_object_dotset_number(JSON_Status, "imp34dt05_mic.resolution", temp_resolution_e);
                                           ...
                                           uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "imp34dt05_mic.odr"))
  {
    ...
    {
      pnpl_imp34dt05_mic_odr_t old_odr;
      imp34dt05_mic_get_odr(&old_odr);
  ...
  if (json_object_dothas_value(tempJSONObject, "imp34dt05_mic.enable"))
  {
    ...
    {
      bool old_enable;
      imp34dt05_mic_get_enable(&old_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "imp34dt05_mic.volume"))
  {
    ...
    {
      int32_t old_volume;
      imp34dt05_mic_get_volume(&old_volume);
  ...
  if (json_object_dothas_value(tempJSONObject, "imp34dt05_mic.samples_per_ts"))
  {
    ...
    else
    {
      ...
      imp34dt05_mic_get_samples_per_ts(&old_samples_per_ts);
  ...
  if (json_object_dothas_value(tempJSONObject, "imp34dt05_mic.sensor_annotation"))
  {
    ...
    else
    {
      ...
      imp34dt05_mic_get_sensor_annotation(&old_sensor_annotation);
