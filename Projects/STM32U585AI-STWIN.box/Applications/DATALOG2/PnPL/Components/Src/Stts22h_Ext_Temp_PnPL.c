                                              ...
                                              uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream.temp.enable"))
    {
      ...
      valid_property = true;
      ret = stts22h_ext_temp_set_st_ble_stream__temp_enable(st_ble_stream__temp_enable, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts22h_ext_temp_get_st_ble_stream__temp_enable(&old_st_ble_stream__temp_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream.temp.unit"))
    {
      ...
      valid_property = true;
      ret = stts22h_ext_temp_set_st_ble_stream__temp_unit(st_ble_stream__temp_unit, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts22h_ext_temp_get_st_ble_stream__temp_unit(&old_st_ble_stream__temp_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream.temp.format"))
    {
      ...
      valid_property = true;
      ret = stts22h_ext_temp_set_st_ble_stream__temp_format(st_ble_stream__temp_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts22h_ext_temp_get_st_ble_stream__temp_format(&old_st_ble_stream__temp_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream.temp.elements"))
    {
      ...
      valid_property = true;
      ret = stts22h_ext_temp_set_st_ble_stream__temp_elements(st_ble_stream__temp_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts22h_ext_temp_get_st_ble_stream__temp_elements(&old_st_ble_stream__temp_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream.temp.channels"))
    {
      ...
      valid_property = true;
      ret = stts22h_ext_temp_set_st_ble_stream__temp_channels(st_ble_stream__temp_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts22h_ext_temp_get_st_ble_stream__temp_channels(&old_st_ble_stream__temp_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream.temp.multiply_factor"))
    {
      ...
      valid_property = true;
      ret = stts22h_ext_temp_set_st_ble_stream__temp_multiply_factor(st_ble_stream__temp_multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts22h_ext_temp_get_st_ble_stream__temp_multiply_factor(&old_st_ble_stream__temp_multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.st_ble_stream.temp.odr"))
    {
      ...
      valid_property = true;
      ret = stts22h_ext_temp_set_st_ble_stream__temp_odr(st_ble_stream__temp_odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts22h_ext_temp_get_st_ble_stream__temp_odr(&old_st_ble_stream__temp_odr);
  ...
  else
  {
    ...
    char *log_message = "Invalid property for stts22h_ext_temp";
