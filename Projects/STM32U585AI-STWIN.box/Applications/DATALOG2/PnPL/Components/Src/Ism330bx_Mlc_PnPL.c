                                          ...
                                          uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream"))
  {
    ...
    {
      valid_property = true;
      bool st_ble_stream__mlc__enable = json_object_dotget_boolean(tempJSONObject, "ism330bx_mlc.st_ble_stream.mlc.enable");
      ret = ism330bx_mlc_set_st_ble_stream__mlc__enable(st_ble_stream__mlc__enable, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330bx_mlc_get_st_ble_stream__mlc__enable(&old_st_ble_stream__mlc__enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream"))
  {
    ...
    {
      valid_property = true;
      const char *st_ble_stream__mlc__unit = json_object_dotget_string(tempJSONObject, "ism330bx_mlc.st_ble_stream.mlc.unit");
      ret = ism330bx_mlc_set_st_ble_stream__mlc__unit(st_ble_stream__mlc__unit, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330bx_mlc_get_st_ble_stream__mlc__unit(&old_st_ble_stream__mlc__unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream.mlc.format"))
    {
      ...
      ret = ism330bx_mlc_set_st_ble_stream__mlc__format(st_ble_stream__mlc__format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330bx_mlc_get_st_ble_stream__mlc__format(&old_st_ble_stream__mlc__format);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream.mlc.elements"))
    {
      ...
      ret = ism330bx_mlc_set_st_ble_stream__mlc__elements(st_ble_stream__mlc__elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330bx_mlc_get_st_ble_stream__mlc__elements(&old_st_ble_stream__mlc__elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream.mlc.channels"))
    {
      ...
      ret = ism330bx_mlc_set_st_ble_stream__mlc__channels(st_ble_stream__mlc__channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330bx_mlc_get_st_ble_stream__mlc__channels(&old_st_ble_stream__mlc__channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream.mlc.multiply_factor"))
    {
      ...
      ret = ism330bx_mlc_set_st_ble_stream__mlc__multiply_factor(st_ble_stream__mlc__multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330bx_mlc_get_st_ble_stream__mlc__multiply_factor(&old_st_ble_stream__mlc__multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism330bx_mlc.st_ble_stream.mlc.odr"))
    {
      ...
      ret = ism330bx_mlc_set_st_ble_stream__mlc__odr(st_ble_stream__mlc__odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism330bx_mlc_get_st_ble_stream__mlc__odr(&old_st_ble_stream__mlc__odr);
