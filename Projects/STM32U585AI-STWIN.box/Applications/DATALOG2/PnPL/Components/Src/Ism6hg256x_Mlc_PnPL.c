                                          ...
                                          uint8_t pretty)
{
  ...
  ism6hg256x_mlc_get_st_ble_stream__id(&temp_i);
  json_object_dotset_number(JSON_Status, "ism6hg256x_mlc.st_ble_stream.id", temp_i);
  ism6hg256x_mlc_get_st_ble_stream__mlc_enable(&temp_b);
  json_object_dotset_boolean(JSON_Status, "ism6hg256x_mlc.st_ble_stream.mlc.enable", temp_b);
  ism6hg256x_mlc_get_st_ble_stream__mlc_unit(&temp_s);
  json_object_dotset_string(JSON_Status, "ism6hg256x_mlc.st_ble_stream.mlc.unit", temp_s);
  ism6hg256x_mlc_get_st_ble_stream__mlc_format(&temp_s);
  json_object_dotset_string(JSON_Status, "ism6hg256x_mlc.st_ble_stream.mlc.format", temp_s);
  ism6hg256x_mlc_get_st_ble_stream__mlc_elements(&temp_i);
  json_object_dotset_number(JSON_Status, "ism6hg256x_mlc.st_ble_stream.mlc.elements", temp_i);
  ism6hg256x_mlc_get_st_ble_stream__mlc_channels(&temp_i);
  json_object_dotset_number(JSON_Status, "ism6hg256x_mlc.st_ble_stream.mlc.channels", temp_i);
  ism6hg256x_mlc_get_st_ble_stream__mlc_multiply_factor(&temp_f);
  json_object_dotset_number(JSON_Status, "ism6hg256x_mlc.st_ble_stream.mlc.multiply_factor", temp_f);
  ism6hg256x_mlc_get_st_ble_stream__mlc_odr(&temp_i);
  json_object_dotset_number(JSON_Status, "ism6hg256x_mlc.st_ble_stream.mlc.odr", temp_i);
                                            ...
                                            uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.id"))
    {
      int32_t st_ble_stream__id = (int32_t)json_object_dotget_number(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.id");
      valid_property = true;
      ret = ism6hg256x_mlc_set_st_ble_stream__id(st_ble_stream__id, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__id(&old_st_ble_stream__id);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.mlc.enable"))
    {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__mlc_enable(&old_st_ble_stream__mlc_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.mlc.unit"))
    {
      const char *st_ble_stream__mlc_unit = json_object_dotget_string(tempJSONObject,
                                                                      "ism6hg256x_mlc.st_ble_stream.mlc.unit");
      valid_property = true;
      ret = ism6hg256x_mlc_set_st_ble_stream__mlc_unit(st_ble_stream__mlc_unit, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__mlc_unit(&old_st_ble_stream__mlc_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.mlc.format"))
    {
      const char *st_ble_stream__mlc_format = json_object_dotget_string(tempJSONObject,
                                                                        "ism6hg256x_mlc.st_ble_stream.mlc.format");
      valid_property = true;
      ret = ism6hg256x_mlc_set_st_ble_stream__mlc_format(st_ble_stream__mlc_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__mlc_format(&old_st_ble_stream__mlc_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.mlc.elements"))
    {
      int32_t st_ble_stream__mlc_elements = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                               "ism6hg256x_mlc.st_ble_stream.mlc.elements");
      valid_property = true;
      ret = ism6hg256x_mlc_set_st_ble_stream__mlc_elements(st_ble_stream__mlc_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__mlc_elements(&old_st_ble_stream__mlc_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.mlc.channels"))
    {
      int32_t st_ble_stream__mlc_channels = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                               "ism6hg256x_mlc.st_ble_stream.mlc.channels");
      valid_property = true;
      ret = ism6hg256x_mlc_set_st_ble_stream__mlc_channels(st_ble_stream__mlc_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__mlc_channels(&old_st_ble_stream__mlc_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.mlc.multiply_factor"))
    {
      float_t st_ble_stream__mlc_multiply_factor = (float_t)json_object_dotget_number(tempJSONObject,
                                                                                      "ism6hg256x_mlc.st_ble_stream.mlc.multiply_factor");
      valid_property = true;
      ret = ism6hg256x_mlc_set_st_ble_stream__mlc_multiply_factor(st_ble_stream__mlc_multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__mlc_multiply_factor(&old_st_ble_stream__mlc_multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "ism6hg256x_mlc.st_ble_stream.mlc.odr"))
    {
      int32_t st_ble_stream__mlc_odr = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                          "ism6hg256x_mlc.st_ble_stream.mlc.odr");
      valid_property = true;
      ret = ism6hg256x_mlc_set_st_ble_stream__mlc_odr(st_ble_stream__mlc_odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        ism6hg256x_mlc_get_st_ble_stream__mlc_odr(&old_st_ble_stream__mlc_odr);
