...
/**
  ...
  * dtmi:vespucci:steval_stwinbx1:fpSnsDatalog2_datalog2:sensors:iis2iclx_acc;5
  *
...
uint8_t Iis2iclx_Acc_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size, uint8_t pretty)
{
  ...
  pnpl_iis2iclx_acc_odr_t temp_odr_e = (pnpl_iis2iclx_acc_odr_t)0;
  iis2iclx_acc_get_odr(&temp_odr_e);
  json_object_dotset_number(JSON_Status, "iis2iclx_acc.odr", temp_odr_e);
  pnpl_iis2iclx_acc_fs_t temp_fs_e = (pnpl_iis2iclx_acc_fs_t)0;
  iis2iclx_acc_get_fs(&temp_fs_e);
  json_object_dotset_number(JSON_Status, "iis2iclx_acc.fs", temp_fs_e);
  bool temp_b = 0;
  ...
  iis2iclx_acc_get_st_ble_stream__id(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2iclx_acc.st_ble_stream.id", temp_i);
  iis2iclx_acc_get_st_ble_stream__acc_enable(&temp_b);
  json_object_dotset_boolean(JSON_Status, "iis2iclx_acc.st_ble_stream.acc.enable", temp_b);
  iis2iclx_acc_get_st_ble_stream__acc_unit(&temp_s);
  json_object_dotset_string(JSON_Status, "iis2iclx_acc.st_ble_stream.acc.unit", temp_s);
  iis2iclx_acc_get_st_ble_stream__acc_format(&temp_s);
  json_object_dotset_string(JSON_Status, "iis2iclx_acc.st_ble_stream.acc.format", temp_s);
  iis2iclx_acc_get_st_ble_stream__acc_elements(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2iclx_acc.st_ble_stream.acc.elements", temp_i);
  iis2iclx_acc_get_st_ble_stream__acc_channels(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2iclx_acc.st_ble_stream.acc.channels", temp_i);
  iis2iclx_acc_get_st_ble_stream__acc_multiply_factor(&temp_f);
  json_object_dotset_number(JSON_Status, "iis2iclx_acc.st_ble_stream.acc.multiply_factor", temp_f);
  iis2iclx_acc_get_st_ble_stream__acc_odr(&temp_i);
  json_object_dotset_number(JSON_Status, "iis2iclx_acc.st_ble_stream.acc.odr", temp_i);
...
uint8_t Iis2iclx_Acc_PnPL_vtblSetProperty(IPnPLComponent_t *_this, char *serializedJSON, char **response,
                                          uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.odr"))
  {
    ...
    {
      pnpl_iis2iclx_acc_odr_t old_odr;
      iis2iclx_acc_get_odr(&old_odr);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.fs"))
  {
    ...
    {
      pnpl_iis2iclx_acc_fs_t old_fs;
      iis2iclx_acc_get_fs(&old_fs);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.enable"))
  {
    ...
    {
      bool old_enable;
      iis2iclx_acc_get_enable(&old_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.samples_per_ts"))
  {
    ...
    else
    {
      ...
      iis2iclx_acc_get_samples_per_ts(&old_samples_per_ts);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.sensor_annotation"))
  {
    ...
    else
    {
      ...
      iis2iclx_acc_get_sensor_annotation(&old_sensor_annotation);
      json_object_dotset_string(respJSONObject, "PnPL_Response.value", old_sensor_annotation);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.id"))
    {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__id(&old_st_ble_stream__id);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.acc.enable"))
    {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__acc_enable(&old_st_ble_stream__acc_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.acc.unit"))
    {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__acc_unit(&old_st_ble_stream__acc_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.acc.format"))
    {
      ...
      valid_property = true;
      ret = iis2iclx_acc_set_st_ble_stream__acc_format(st_ble_stream__acc_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__acc_format(&old_st_ble_stream__acc_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.acc.elements"))
    {
      ...
      valid_property = true;
      ret = iis2iclx_acc_set_st_ble_stream__acc_elements(st_ble_stream__acc_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__acc_elements(&old_st_ble_stream__acc_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.acc.channels"))
    {
      ...
      valid_property = true;
      ret = iis2iclx_acc_set_st_ble_stream__acc_channels(st_ble_stream__acc_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__acc_channels(&old_st_ble_stream__acc_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.acc.multiply_factor"))
    {
      ...
      valid_property = true;
      ret = iis2iclx_acc_set_st_ble_stream__acc_multiply_factor(st_ble_stream__acc_multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__acc_multiply_factor(&old_st_ble_stream__acc_multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2iclx_acc.st_ble_stream.acc.odr"))
    {
      ...
      valid_property = true;
      ret = iis2iclx_acc_set_st_ble_stream__acc_odr(st_ble_stream__acc_odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2iclx_acc_get_st_ble_stream__acc_odr(&old_st_ble_stream__acc_odr);
...
uint8_t Iis2iclx_Acc_PnPL_vtblExecuteFunction(IPnPLComponent_t *_this, char *serializedJSON, char **response,
                                              uint32_t *size, uint8_t pretty)
{
