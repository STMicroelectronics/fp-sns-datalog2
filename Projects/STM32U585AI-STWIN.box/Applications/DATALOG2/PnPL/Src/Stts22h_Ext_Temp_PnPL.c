...
uint8_t Stts22h_Ext_Temp_PnPL_vtblSetProperty(IPnPLComponent_t *_this, char *serializedJSON, char **response, uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "stts22h_ext_temp.odr"))
  {
    ...
    {
      case 0:
        ret = stts22h_ext_temp_set_odr(stts22h_ext_temp_odr_hz1);
        break;
      case 1:
        ret = stts22h_ext_temp_set_odr(stts22h_ext_temp_odr_hz25);
        break;
      case 2:
        ret = stts22h_ext_temp_set_odr(stts22h_ext_temp_odr_hz50);
        break;
      case 3:
        ret = stts22h_ext_temp_set_odr(stts22h_ext_temp_odr_hz100);
        break;
      case 4:
