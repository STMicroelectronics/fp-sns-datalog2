                                           ...
                                           uint8_t pretty)
{
  ...
  float temp_f = 0;
  ism330dhcx_gyro_get_odr(&temp_f);
  uint8_t enum_id = 0;
  if (temp_f == ism330dhcx_gyro_odr_hz12_5)
  {
    enum_id = 0;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz26)
  {
    enum_id = 1;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz52)
  {
    enum_id = 2;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz104)
  {
    enum_id = 3;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz208)
  {
    enum_id = 4;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz416)
  {
    enum_id = 5;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz833)
  {
    enum_id = 6;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz1666)
  {
    enum_id = 7;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz3332)
  {
    enum_id = 8;
  }
  else if (temp_f == ism330dhcx_gyro_odr_hz6667)
  {
    enum_id = 9;
  }
  json_object_dotset_number(JSON_Status, "ism330dhcx_gyro.odr", enum_id);
  ism330dhcx_gyro_get_fs(&temp_f);
  enum_id = 0;
  if (temp_f == ism330dhcx_gyro_fs_dps125)
  {
    enum_id = 0;
  }
  else if (temp_f == ism330dhcx_gyro_fs_dps250)
  {
    enum_id = 1;
  }
  else if (temp_f == ism330dhcx_gyro_fs_dps500)
  {
    enum_id = 2;
  }
  else if (temp_f == ism330dhcx_gyro_fs_dps1000)
  {
    enum_id = 3;
  }
  else if (temp_f == ism330dhcx_gyro_fs_dps2000)
  {
    enum_id = 4;
  }
  else if (temp_f == ism330dhcx_gyro_fs_dps4000)
  {
    enum_id = 5;
  }
  json_object_dotset_number(JSON_Status, "ism330dhcx_gyro.fs", enum_id);
  bool temp_b = 0;
...
uint8_t Ism330dhcx_Gyro_PnPL_vtblSetProperty(IPnPLComponent_t *_this, char *serializedJSON, char **response, uint32_t *size, uint8_t pretty)
{
  ...
  {
    int odr = (int)json_object_dotget_number(tempJSONObject, "ism330dhcx_gyro.odr");
    switch (odr)
    {
      case 0:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz12_5);
        break;
      case 1:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz26);
        break;
      case 2:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz52);
        break;
      case 3:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz104);
        break;
      case 4:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz208);
        break;
      case 5:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz416);
        break;
      case 6:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz833);
        break;
      case 7:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz1666);
        break;
      case 8:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz3332);
        break;
      case 9:
        ret = ism330dhcx_gyro_set_odr(ism330dhcx_gyro_odr_hz6667);
        break;
    }
    if(ret == 0){
      json_object_dotset_number(respJSONObject, "ism330dhcx_gyro.odr.value", odr);
    } else {
      json_object_dotset_string(respJSONObject, "ism330dhcx_gyro.odr.value", "PNPL_SET_ERROR");
    }
  }
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.fs"))
  {
    int fs = (int)json_object_dotget_number(tempJSONObject, "ism330dhcx_gyro.fs");
    switch (fs)
    {
      case 0:
        ret = ism330dhcx_gyro_set_fs(ism330dhcx_gyro_fs_dps125);
        break;
      case 1:
        ret = ism330dhcx_gyro_set_fs(ism330dhcx_gyro_fs_dps250);
        break;
      case 2:
        ret = ism330dhcx_gyro_set_fs(ism330dhcx_gyro_fs_dps500);
        break;
      case 3:
        ret = ism330dhcx_gyro_set_fs(ism330dhcx_gyro_fs_dps1000);
        break;
      case 4:
        ret = ism330dhcx_gyro_set_fs(ism330dhcx_gyro_fs_dps2000);
        break;
      case 5:
        ret = ism330dhcx_gyro_set_fs(ism330dhcx_gyro_fs_dps4000);
        break;
    }
    if(ret == 0){
      json_object_dotset_number(respJSONObject, "ism330dhcx_gyro.fs.value", fs);
    } else {
      json_object_dotset_string(respJSONObject, "ism330dhcx_gyro.fs.value", "PNPL_SET_ERROR");
    }
  }
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.enable"))
  {
    ...
    ret = ism330dhcx_gyro_set_enable(enable);
    if(ret == 0){
      json_object_dotset_boolean(respJSONObject, "ism330dhcx_gyro.enable.value", enable);
    } else {
      json_object_dotset_string(respJSONObject, "ism330dhcx_gyro.enable.value", "PNPL_SET_ERROR");
    }
  }
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.samples_per_ts"))
  {
    ...
    ret = ism330dhcx_gyro_set_samples_per_ts(samples_per_ts);
    if(ret == 0){
      json_object_dotset_number(respJSONObject, "ism330dhcx_gyro.samples_per_ts.value", samples_per_ts);
    } else {
      json_object_dotset_string(respJSONObject, "ism330dhcx_gyro.samples_per_ts.value", "PNPL_SET_ERROR");
    }
  }
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.sensor_annotation"))
  {
    ...
    ret = ism330dhcx_gyro_set_sensor_annotation(sensor_annotation);
    json_object_dotset_string(respJSONObject, "ism330dhcx_gyro.sensor_annotation.value", ret == 0 ? sensor_annotation : "PNPL_SET_ERROR");
  }
  json_value_free(tempJSON);
  if (pretty == 1)
  {
...
uint8_t Ism330dhcx_Gyro_PnPL_vtblExecuteFunction(IPnPLComponent_t *_this, char *serializedJSON, char **response, uint32_t *size, uint8_t pretty)
{
  return 1;
}
