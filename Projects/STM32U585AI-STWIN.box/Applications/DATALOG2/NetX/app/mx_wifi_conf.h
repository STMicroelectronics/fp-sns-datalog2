...
#define MX_WIFI_RESET_PORT       WIFI_EN_GPIO_Port

/* wifi spi cs */
#define MX_WIFI_SPI_CS_PIN       WIFI_CS_Pin
#define MX_WIFI_SPI_CS_PORT      WIFI_CS_GPIO_Port

/* wifi spi slave notify */
#define MX_WIFI_SPI_IRQ_PIN      WIFI_NOTIFY_Pin
#define MX_WIFI_SPI_IRQ_PORT     WIFI_NOTIFY_GPIO_Port
#define MX_WIFI_SPI_IRQ          WIFI_NOTIFY_EXTI_IRQn
...
/* this two arrays must be defined as global and initialized before nx_system_initialize() */
