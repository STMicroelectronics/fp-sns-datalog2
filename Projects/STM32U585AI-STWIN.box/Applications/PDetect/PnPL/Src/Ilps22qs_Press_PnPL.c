                                          ...
                                          uint8_t pretty)
{
  ...
  int32_t temp_i = 0;
  ilps22qs_press_get_odr(&temp_i);
  uint8_t enum_id = 0;
  if (temp_i == ilps22qs_press_odr_hz1)
  {
    enum_id = 0;
  }
  else if (temp_i == ilps22qs_press_odr_hz4)
  {
    enum_id = 1;
  }
  else if (temp_i == ilps22qs_press_odr_hz10)
  {
    enum_id = 2;
  }
  else if (temp_i == ilps22qs_press_odr_hz25)
  {
    enum_id = 3;
  }
  else if (temp_i == ilps22qs_press_odr_hz50)
  {
    enum_id = 4;
  }
  else if (temp_i == ilps22qs_press_odr_hz75)
  {
    enum_id = 5;
  }
  else if (temp_i == ilps22qs_press_odr_hz100)
  {
    enum_id = 6;
  }
  else if (temp_i == ilps22qs_press_odr_hz200)
  {
    enum_id = 7;
  }
  json_object_dotset_number(JSON_Status, "ilps22qs_press.odr", enum_id);
  ilps22qs_press_get_fs(&temp_i);
  enum_id = 0;
  if (temp_i == ilps22qs_press_fs_hpa1260)
  {
    enum_id = 0;
  }
  else if (temp_i == ilps22qs_press_fs_hpa4060)
  {
    enum_id = 1;
  }
                                            ...
                                            uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "ilps22qs_press.odr"))
  {
    ...
    {
      case 0:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz1);
        break;
      case 1:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz4);
        break;
      case 2:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz10);
        break;
      case 3:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz25);
        break;
      case 4:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz50);
        break;
      case 5:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz75);
        break;
      case 6:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz100);
        break;
      case 7:
        ret = ilps22qs_press_set_odr(ilps22qs_press_odr_hz200);
        break;
    }
    if (ret == 0)
    {
  ...
  if (json_object_dothas_value(tempJSONObject, "ilps22qs_press.fs"))
  {
    ...
    {
      case 0:
        ret = ilps22qs_press_set_fs(ilps22qs_press_fs_hpa1260);
        break;
      case 1:
        ret = ilps22qs_press_set_fs(ilps22qs_press_fs_hpa4060);
        break;
    }
    if (ret == 0)
    {
