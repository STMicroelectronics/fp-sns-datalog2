/**
  ******************************************************************************
  * @file    App_model_Vl53l8cx_Tof.c
  * @author  SRA
  * @brief   Vl53l8cx_Tof PnPL Components APIs
  ******************************************************************************
  * @attention
  *
...
uint8_t vl53l8cx_tof_comp_init(void)
{
  ...
  vl53l8cx_tof_model.sensor_status = SMSensorGetStatusPointer(id);
  vl53l8cx_tof_model.stream_params.stream_id = -1;
  vl53l8cx_tof_model.stream_params.usb_ep = -1;

  addSensorToAppModel(id, &vl53l8cx_tof_model);

  vl53l8cx_tof_set_sensor_annotation("[EXTERN]\0", NULL);
  vl53l8cx_tof_set_resolution(pnpl_vl53l8cx_tof_resolution_n8x8, NULL);
  vl53l8cx_tof_set_odr(10, NULL);
  vl53l8cx_tof_set_ranging_mode(pnpl_vl53l8cx_tof_ranging_mode_continuous, NULL);
  vl53l8cx_tof_set_integration_time(10, NULL);
...
//  #define VL53L8CX_PROFILE_8x8_AUTONOMOUS        (4U)
  ...
  switch (resolution)
  {
    case 1:
    case 2:
      *enum_id = pnpl_vl53l8cx_tof_resolution_n4x4;
      break;
    case 3:
    case 4:
      *enum_id = pnpl_vl53l8cx_tof_resolution_n8x8;
      break;
    default:
      return 1;
  }
...
//  #define VL53L8CX_PROFILE_8x8_AUTONOMOUS        (4U)
  ...
  switch (ranging_mode)
  {
    case 1:
    case 3:
      *enum_id = pnpl_vl53l8cx_tof_ranging_mode_continuous;
      break;
    case 2:
    case 4:
      *enum_id = pnpl_vl53l8cx_tof_ranging_mode_autonomous;
      break;
    default:
      return 1;
  }
...
uint8_t vl53l8cx_tof_get_mounted(bool *value)
{
  *value = true;
  /* USER Code */
  return PNPL_NO_ERROR_CODE;
...
uint8_t vl53l8cx_tof_get_output_format__target_status__start_id(int32_t *value)
{
  *value = 0;
  return PNPL_NO_ERROR_CODE;
}

uint8_t vl53l8cx_tof_get_output_format__target_distance__start_id(int32_t *value)
{
  *value = 1;
  return PNPL_NO_ERROR_CODE;
}

uint8_t vl53l8cx_tof_get_output_format__nof_outputs(int32_t *value)
{
  *value = 2;
  return PNPL_NO_ERROR_CODE;
}
...
uint8_t vl53l8cx_tof_set_enable(bool value, char **response_message)
{
...
uint8_t vl53l8cx_tof_set_resolution(pnpl_vl53l8cx_tof_resolution_t enum_id, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  switch (enum_id)
  {
    case pnpl_vl53l8cx_tof_resolution_n4x4:
      value = 16;
      break;
    case pnpl_vl53l8cx_tof_resolution_n8x8:
      value = 64;
      break;
    default:
      return 1;
  }
  ret = SMSensorSetResolution(vl53l8cx_tof_model.id, value);
  if (ret == SYS_NO_ERROR_CODE)
  {
#if (HSD_USE_DUMMY_DATA != 1)
...
uint8_t vl53l8cx_tof_set_odr(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  ret = SMSensorSetFrequency(vl53l8cx_tof_model.id, value);
  if (ret == SYS_NO_ERROR_CODE)
  {
#if (HSD_USE_DUMMY_DATA != 1)
...
uint8_t vl53l8cx_tof_set_ranging_mode(pnpl_vl53l8cx_tof_ranging_mode_t enum_id, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  switch (enum_id)
  {
    case pnpl_vl53l8cx_tof_ranging_mode_continuous:
      if (mode == 1 || mode == 2)
      {
        value = 1;
      }
      ...
      break;
    case pnpl_vl53l8cx_tof_ranging_mode_autonomous:
      if (mode == 1 || mode == 2)
      {
        value = 2;
      }
  ...
  ret = SMSensorSetRangingMode(vl53l8cx_tof_model.id, value);
  if (ret == SYS_NO_ERROR_CODE)
  {
    /* USER Code */
  }
...
uint8_t vl53l8cx_tof_set_integration_time(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  {
    ret = SMSensorSetIntegrationTime(vl53l8cx_tof_model.id, value);
  }
  return ret;
}

uint8_t vl53l8cx_tof_set_samples_per_ts(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t vl53l8cx_tof_set_sensor_annotation(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
