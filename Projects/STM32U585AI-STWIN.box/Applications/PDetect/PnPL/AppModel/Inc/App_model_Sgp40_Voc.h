...
#ifndef APP_MODEL_SGP40_VOC_H_
#define APP_MODEL_SGP40_VOC_H_
...
uint8_t sgp40_voc_get_ioffset(float *value);
uint8_t sgp40_voc_get_measodr(float *value);
uint8_t sgp40_voc_get_usb_dps(int32_t *value);
uint8_t sgp40_voc_get_sd_dps(int32_t *value);
uint8_t sgp40_voc_get_sensitivity(float *value);
