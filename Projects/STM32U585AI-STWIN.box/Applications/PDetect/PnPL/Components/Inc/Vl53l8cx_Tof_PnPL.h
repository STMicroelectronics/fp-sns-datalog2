...
typedef enum
{
  pnpl_vl53l8cx_tof_resolution_n4x4 = 0,
  pnpl_vl53l8cx_tof_resolution_n8x8 = 1,
} pnpl_vl53l8cx_tof_resolution_t;
typedef enum
{
  pnpl_vl53l8cx_tof_ranging_mode_continuous = 0,
  pnpl_vl53l8cx_tof_ranging_mode_autonomous = 1,
} pnpl_vl53l8cx_tof_ranging_mode_t;
