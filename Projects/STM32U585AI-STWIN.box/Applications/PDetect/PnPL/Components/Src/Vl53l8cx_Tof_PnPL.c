...
uint8_t Vl53l8cx_Tof_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size, uint8_t pretty)
{
  ...
  pnpl_vl53l8cx_tof_resolution_t temp_resolution_e = (pnpl_vl53l8cx_tof_resolution_t)0;
  vl53l8cx_tof_get_resolution(&temp_resolution_e);
  json_object_dotset_number(JSON_Status, "vl53l8cx_tof.resolution", temp_resolution_e);
  int32_t temp_i = 0;
  vl53l8cx_tof_get_odr(&temp_i);
  json_object_dotset_number(JSON_Status, "vl53l8cx_tof.odr", temp_i);
  pnpl_vl53l8cx_tof_ranging_mode_t temp_ranging_mode_e = (pnpl_vl53l8cx_tof_ranging_mode_t)0;
  vl53l8cx_tof_get_ranging_mode(&temp_ranging_mode_e);
  json_object_dotset_number(JSON_Status, "vl53l8cx_tof.ranging_mode", temp_ranging_mode_e);
                                          ...
                                          uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "vl53l8cx_tof.enable"))
  {
    ...
    {
      bool old_enable;
      vl53l8cx_tof_get_enable(&old_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "vl53l8cx_tof.resolution"))
  {
    ...
    {
      pnpl_vl53l8cx_tof_resolution_t old_resolution;
      vl53l8cx_tof_get_resolution(&old_resolution);
  ...
  if (json_object_dothas_value(tempJSONObject, "vl53l8cx_tof.ranging_mode"))
  {
    ...
    {
      pnpl_vl53l8cx_tof_ranging_mode_t old_ranging_mode;
      vl53l8cx_tof_get_ranging_mode(&old_ranging_mode);
  ...
  if (json_object_dothas_value(tempJSONObject, "vl53l8cx_tof.integration_time"))
  {
    ...
    else
    {
      ...
      vl53l8cx_tof_get_integration_time(&old_integration_time);
  ...
  if (json_object_dothas_value(tempJSONObject, "vl53l8cx_tof.samples_per_ts"))
  {
    ...
    else
    {
      ...
      vl53l8cx_tof_get_samples_per_ts(&old_samples_per_ts);
  ...
  if (json_object_dothas_value(tempJSONObject, "vl53l8cx_tof.sensor_annotation"))
  {
    ...
    else
    {
      ...
      vl53l8cx_tof_get_sensor_annotation(&old_sensor_annotation);
