...
static const IPnPLComponent_vtbl sVd6283tx_2_Als_PnPL_CompIF_vtbl =
{
  Vd6283tx_2_Als_PnPL_vtblGetKey,
  Vd6283tx_2_Als_PnPL_vtblGetNCommands,
  Vd6283tx_2_Als_PnPL_vtblGetCommandKey,
  Vd6283tx_2_Als_PnPL_vtblGetStatus,
  Vd6283tx_2_Als_PnPL_vtblSetProperty,
  Vd6283tx_2_Als_PnPL_vtblExecuteFunction
};

/**
  *  Vd6283tx_2_Als_PnPL internal structure.
  */
struct _Vd6283tx_2_Als_PnPL
{
...
/* Objects instance ----------------------------------------------------------*/
static Vd6283tx_2_Als_PnPL sVd6283tx_2_Als_PnPL;

/* Public API definition -----------------------------------------------------*/
IPnPLComponent_t *Vd6283tx_2_Als_PnPLAlloc()
{
  IPnPLComponent_t *pxObj = (IPnPLComponent_t *) &sVd6283tx_2_Als_PnPL;
  if (pxObj != NULL)
  {
    pxObj->vptr = &sVd6283tx_2_Als_PnPL_CompIF_vtbl;
  }
  return pxObj;
}
                                          ...
                                          uint8_t pretty)
{
  ...
  bool temp_b = 0;
  vd6283tx_2_als_get_enable(&temp_b);
  json_object_dotset_boolean(JSON_Status, "vd6283tx_2_als.enable", temp_b);
  int32_t temp_i = 0;
  vd6283tx_2_als_get_exposure_time(&temp_i);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.exposure_time", temp_i);
  vd6283tx_2_als_get_intermeasurement_time(&temp_i);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.intermeasurement_time", temp_i);
  pnpl_vd6283tx_2_als_channel1_gain_t temp_channel1_gain_e = (pnpl_vd6283tx_2_als_channel1_gain_t)0;
  vd6283tx_2_als_get_channel1_gain(&temp_channel1_gain_e);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.channel1_gain", temp_channel1_gain_e);
  pnpl_vd6283tx_2_als_channel2_gain_t temp_channel2_gain_e = (pnpl_vd6283tx_2_als_channel2_gain_t)0;
  vd6283tx_2_als_get_channel2_gain(&temp_channel2_gain_e);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.channel2_gain", temp_channel2_gain_e);
  pnpl_vd6283tx_2_als_channel3_gain_t temp_channel3_gain_e = (pnpl_vd6283tx_2_als_channel3_gain_t)0;
  vd6283tx_2_als_get_channel3_gain(&temp_channel3_gain_e);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.channel3_gain", temp_channel3_gain_e);
  pnpl_vd6283tx_2_als_channel4_gain_t temp_channel4_gain_e = (pnpl_vd6283tx_2_als_channel4_gain_t)0;
  vd6283tx_2_als_get_channel4_gain(&temp_channel4_gain_e);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.channel4_gain", temp_channel4_gain_e);
  pnpl_vd6283tx_2_als_channel5_gain_t temp_channel5_gain_e = (pnpl_vd6283tx_2_als_channel5_gain_t)0;
  vd6283tx_2_als_get_channel5_gain(&temp_channel5_gain_e);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.channel5_gain", temp_channel5_gain_e);
  pnpl_vd6283tx_2_als_channel6_gain_t temp_channel6_gain_e = (pnpl_vd6283tx_2_als_channel6_gain_t)0;
  vd6283tx_2_als_get_channel6_gain(&temp_channel6_gain_e);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.channel6_gain", temp_channel6_gain_e);
  vd6283tx_2_als_get_samples_per_ts(&temp_i);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.samples_per_ts", temp_i);
  float temp_f = 0;
  vd6283tx_2_als_get_ioffset(&temp_f);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.ioffset", temp_f);
  vd6283tx_2_als_get_usb_dps(&temp_i);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.usb_dps", temp_i);
  vd6283tx_2_als_get_sd_dps(&temp_i);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.sd_dps", temp_i);
  char *temp_s = "";
  vd6283tx_2_als_get_data_type(&temp_s);
  json_object_dotset_string(JSON_Status, "vd6283tx_2_als.data_type", temp_s);
  vd6283tx_2_als_get_sensor_annotation(&temp_s);
  ...
  int8_t temp_int8 = 0;
  vd6283tx_2_als_get_stream_id(&temp_int8);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.stream_id", temp_int8);
  vd6283tx_2_als_get_ep_id(&temp_int8);
  json_object_dotset_number(JSON_Status, "vd6283tx_2_als.ep_id", temp_int8);
                                            ...
                                            uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.enable"))
  {
    ...
    {
      bool old_enable;
      vd6283tx_2_als_get_enable(&old_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.exposure_time"))
  {
    ...
    else
    {
      ...
      vd6283tx_2_als_get_exposure_time(&old_exposure_time);
      json_object_dotset_number(respJSONObject, "PnPL_Response.value", old_exposure_time);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.intermeasurement_time"))
  {
    ...
    else
    {
      ...
      vd6283tx_2_als_get_intermeasurement_time(&old_intermeasurement_time);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.channel1_gain"))
  {
    ...
    {
      pnpl_vd6283tx_2_als_channel1_gain_t old_channel1_gain;
      vd6283tx_2_als_get_channel1_gain(&old_channel1_gain);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.channel2_gain"))
  {
    ...
    {
      pnpl_vd6283tx_2_als_channel2_gain_t old_channel2_gain;
      vd6283tx_2_als_get_channel2_gain(&old_channel2_gain);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.channel3_gain"))
  {
    ...
    {
      pnpl_vd6283tx_2_als_channel3_gain_t old_channel3_gain;
      vd6283tx_2_als_get_channel3_gain(&old_channel3_gain);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.channel4_gain"))
  {
    ...
    {
      pnpl_vd6283tx_2_als_channel4_gain_t old_channel4_gain;
      vd6283tx_2_als_get_channel4_gain(&old_channel4_gain);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.channel5_gain"))
  {
    ...
    {
      pnpl_vd6283tx_2_als_channel5_gain_t old_channel5_gain;
      vd6283tx_2_als_get_channel5_gain(&old_channel5_gain);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.channel6_gain"))
  {
    ...
    {
      pnpl_vd6283tx_2_als_channel6_gain_t old_channel6_gain;
      vd6283tx_2_als_get_channel6_gain(&old_channel6_gain);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.samples_per_ts"))
  {
    ...
    else
    {
      ...
      vd6283tx_2_als_get_samples_per_ts(&old_samples_per_ts);
  ...
  if (json_object_dothas_value(tempJSONObject, "vd6283tx_2_als.sensor_annotation"))
  {
    ...
    else
    {
      ...
      vd6283tx_2_als_get_sensor_annotation(&old_sensor_annotation);
