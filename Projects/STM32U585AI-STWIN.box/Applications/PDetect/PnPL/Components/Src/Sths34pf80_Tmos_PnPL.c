                                           ...
                                           uint8_t pretty)
{
  ...
  pnpl_sths34pf80_tmos_odr_t temp_odr_e = (pnpl_sths34pf80_tmos_odr_t)0;
  sths34pf80_tmos_get_odr(&temp_odr_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.odr", temp_odr_e);
  float_t temp_f = 0;
  sths34pf80_tmos_get_transmittance(&temp_f);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.transmittance", temp_f);
  pnpl_sths34pf80_tmos_avg_tobject_num_t temp_avg_tobject_num_e = (pnpl_sths34pf80_tmos_avg_tobject_num_t)0;
  sths34pf80_tmos_get_avg_tobject_num(&temp_avg_tobject_num_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.avg_tobject_num", temp_avg_tobject_num_e);
  pnpl_sths34pf80_tmos_avg_tambient_num_t temp_avg_tambient_num_e = (pnpl_sths34pf80_tmos_avg_tambient_num_t)0;
  sths34pf80_tmos_get_avg_tambient_num(&temp_avg_tambient_num_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.avg_tambient_num", temp_avg_tambient_num_e);
  pnpl_sths34pf80_tmos_lpf_p_m_bandwidth_t temp_lpf_p_m_bandwidth_e = (pnpl_sths34pf80_tmos_lpf_p_m_bandwidth_t)0;
  sths34pf80_tmos_get_lpf_p_m_bandwidth(&temp_lpf_p_m_bandwidth_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.lpf_p_m_bandwidth", temp_lpf_p_m_bandwidth_e);
  pnpl_sths34pf80_tmos_lpf_p_bandwidth_t temp_lpf_p_bandwidth_e = (pnpl_sths34pf80_tmos_lpf_p_bandwidth_t)0;
  sths34pf80_tmos_get_lpf_p_bandwidth(&temp_lpf_p_bandwidth_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.lpf_p_bandwidth", temp_lpf_p_bandwidth_e);
  pnpl_sths34pf80_tmos_lpf_m_bandwidth_t temp_lpf_m_bandwidth_e = (pnpl_sths34pf80_tmos_lpf_m_bandwidth_t)0;
  sths34pf80_tmos_get_lpf_m_bandwidth(&temp_lpf_m_bandwidth_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.lpf_m_bandwidth", temp_lpf_m_bandwidth_e);
  int32_t temp_i = 0;
  ...
  pnpl_sths34pf80_tmos_compensation_type_t temp_compensation_type_e = (pnpl_sths34pf80_tmos_compensation_type_t)0;
  sths34pf80_tmos_get_compensation_type(&temp_compensation_type_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_tmos.compensation_type", temp_compensation_type_e);
                                             ...
                                             uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.enable"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_enable(enable, &resp_msg);
    ...
    {
      bool old_enable;
      sths34pf80_tmos_get_enable(&old_enable);
  ...
  {
    int32_t odr = (int32_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.odr");
    valid_property = true;
    ret = sths34pf80_tmos_set_odr((pnpl_sths34pf80_tmos_odr_t)odr, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      pnpl_sths34pf80_tmos_odr_t old_odr;
      sths34pf80_tmos_get_odr(&old_odr);
  ...
  {
    float_t transmittance = (float_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.transmittance");
    valid_property = true;
    ret = sths34pf80_tmos_set_transmittance(transmittance, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_transmittance(&old_transmittance);
  ...
  {
    int32_t avg_tobject_num = (int32_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.avg_tobject_num");
    valid_property = true;
    ret = sths34pf80_tmos_set_avg_tobject_num((pnpl_sths34pf80_tmos_avg_tobject_num_t)avg_tobject_num, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      pnpl_sths34pf80_tmos_avg_tobject_num_t old_avg_tobject_num;
      sths34pf80_tmos_get_avg_tobject_num(&old_avg_tobject_num);
  ...
  {
    int32_t avg_tambient_num = (int32_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.avg_tambient_num");
    valid_property = true;
    ret = sths34pf80_tmos_set_avg_tambient_num((pnpl_sths34pf80_tmos_avg_tambient_num_t)avg_tambient_num, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      pnpl_sths34pf80_tmos_avg_tambient_num_t old_avg_tambient_num;
      sths34pf80_tmos_get_avg_tambient_num(&old_avg_tambient_num);
  ...
  {
    int32_t lpf_p_m_bandwidth = (int32_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.lpf_p_m_bandwidth");
    valid_property = true;
    ret = sths34pf80_tmos_set_lpf_p_m_bandwidth((pnpl_sths34pf80_tmos_lpf_p_m_bandwidth_t)lpf_p_m_bandwidth, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      pnpl_sths34pf80_tmos_lpf_p_m_bandwidth_t old_lpf_p_m_bandwidth;
      sths34pf80_tmos_get_lpf_p_m_bandwidth(&old_lpf_p_m_bandwidth);
  ...
  {
    int32_t lpf_p_bandwidth = (int32_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.lpf_p_bandwidth");
    valid_property = true;
    ret = sths34pf80_tmos_set_lpf_p_bandwidth((pnpl_sths34pf80_tmos_lpf_p_bandwidth_t)lpf_p_bandwidth, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      pnpl_sths34pf80_tmos_lpf_p_bandwidth_t old_lpf_p_bandwidth;
      sths34pf80_tmos_get_lpf_p_bandwidth(&old_lpf_p_bandwidth);
  ...
  {
    int32_t lpf_m_bandwidth = (int32_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.lpf_m_bandwidth");
    valid_property = true;
    ret = sths34pf80_tmos_set_lpf_m_bandwidth((pnpl_sths34pf80_tmos_lpf_m_bandwidth_t)lpf_m_bandwidth, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      pnpl_sths34pf80_tmos_lpf_m_bandwidth_t old_lpf_m_bandwidth;
      sths34pf80_tmos_get_lpf_m_bandwidth(&old_lpf_m_bandwidth);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.presence_threshold"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_presence_threshold(presence_threshold, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_presence_threshold(&old_presence_threshold);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.presence_hysteresis"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_presence_hysteresis(presence_hysteresis, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_presence_hysteresis(&old_presence_hysteresis);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.motion_threshold"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_motion_threshold(motion_threshold, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_motion_threshold(&old_motion_threshold);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.motion_hysteresis"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_motion_hysteresis(motion_hysteresis, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_motion_hysteresis(&old_motion_hysteresis);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.tambient_shock_threshold"))
  {
    int32_t tambient_shock_threshold = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                          "sths34pf80_tmos.tambient_shock_threshold");
    valid_property = true;
    ret = sths34pf80_tmos_set_tambient_shock_threshold(tambient_shock_threshold, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_tambient_shock_threshold(&old_tambient_shock_threshold);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.tambient_shock_hysteresis"))
  {
    int32_t tambient_shock_hysteresis = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                           "sths34pf80_tmos.tambient_shock_hysteresis");
    valid_property = true;
    ret = sths34pf80_tmos_set_tambient_shock_hysteresis(tambient_shock_hysteresis, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_tambient_shock_hysteresis(&old_tambient_shock_hysteresis);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.embedded_compensation"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_embedded_compensation(embedded_compensation, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_embedded_compensation(&old_embedded_compensation);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.software_compensation"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_software_compensation(software_compensation, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_software_compensation(&old_software_compensation);
  ...
  {
    int32_t compensation_type = (int32_t)json_object_dotget_number(tempJSONObject, "sths34pf80_tmos.compensation_type");
    valid_property = true;
    ret = sths34pf80_tmos_set_compensation_type((pnpl_sths34pf80_tmos_compensation_type_t)compensation_type, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    {
      pnpl_sths34pf80_tmos_compensation_type_t old_compensation_type;
      sths34pf80_tmos_get_compensation_type(&old_compensation_type);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.sw_presence_threshold"))
  {
    int32_t sw_presence_threshold = (int32_t)json_object_dotget_number(tempJSONObject,
                                                                       "sths34pf80_tmos.sw_presence_threshold");
    valid_property = true;
    ret = sths34pf80_tmos_set_sw_presence_threshold(sw_presence_threshold, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_sw_presence_threshold(&old_sw_presence_threshold);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.sw_motion_threshold"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_sw_motion_threshold(sw_motion_threshold, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_sw_motion_threshold(&old_sw_motion_threshold);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.compensation_filter_flag"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_compensation_filter_flag(compensation_filter_flag, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_compensation_filter_flag(&old_compensation_filter_flag);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.absence_static_flag"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_absence_static_flag(absence_static_flag, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_absence_static_flag(&old_absence_static_flag);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.samples_per_ts"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_samples_per_ts(samples_per_ts, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_samples_per_ts(&old_samples_per_ts);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_tmos.sensor_annotation"))
  {
    ...
    valid_property = true;
    ret = sths34pf80_tmos_set_sensor_annotation(sensor_annotation, &resp_msg);
    json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
    if (ret == PNPL_NO_ERROR_CODE)
    {
    ...
    else
    {
      ...
      sths34pf80_tmos_get_sensor_annotation(&old_sensor_annotation);
  ...
  else
  {
    ...
    char *log_message = "Invalid property for sths34pf80_tmos";
