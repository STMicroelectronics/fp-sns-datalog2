...
static const IPnPLComponent_vtbl sSths34pf80_3_Tmos_PnPL_CompIF_vtbl =
{
  Sths34pf80_3_Tmos_PnPL_vtblGetKey,
  Sths34pf80_3_Tmos_PnPL_vtblGetNCommands,
  Sths34pf80_3_Tmos_PnPL_vtblGetCommandKey,
  Sths34pf80_3_Tmos_PnPL_vtblGetStatus,
  Sths34pf80_3_Tmos_PnPL_vtblSetProperty,
  Sths34pf80_3_Tmos_PnPL_vtblExecuteFunction
};

/**
  *  Sths34pf80_3_Tmos_PnPL internal structure.
  */
struct _Sths34pf80_3_Tmos_PnPL
{
...
/* Objects instance ----------------------------------------------------------*/
static Sths34pf80_3_Tmos_PnPL sSths34pf80_3_Tmos_PnPL;

/* Public API definition -----------------------------------------------------*/
IPnPLComponent_t *Sths34pf80_3_Tmos_PnPLAlloc()
{
  IPnPLComponent_t *pxObj = (IPnPLComponent_t *) &sSths34pf80_3_Tmos_PnPL;
  if (pxObj != NULL)
  {
    pxObj->vptr = &sSths34pf80_3_Tmos_PnPL_CompIF_vtbl;
  }
  return pxObj;
}
...
{
  return sths34pf80_3_tmos_get_key();
}
                                             ...
                                             uint8_t pretty)
{
  ...
  bool temp_b = 0;
  sths34pf80_3_tmos_get_enable(&temp_b);
  json_object_dotset_boolean(JSON_Status, "sths34pf80_3_tmos.enable", temp_b);
  ...
  sths34pf80_3_tmos_get_avg_tobject_num(&temp_avg_tobject_num_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.avg_tobject_num", temp_avg_tobject_num_e);
  pnpl_sths34pf80_3_tmos_avg_tambient_num_t temp_avg_tambient_num_e = (pnpl_sths34pf80_3_tmos_avg_tambient_num_t)0;
  sths34pf80_3_tmos_get_avg_tambient_num(&temp_avg_tambient_num_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.avg_tambient_num", temp_avg_tambient_num_e);
  pnpl_sths34pf80_3_tmos_lpf_p_m_bandwidth_t temp_lpf_p_m_bandwidth_e = (pnpl_sths34pf80_3_tmos_lpf_p_m_bandwidth_t)0;
  sths34pf80_3_tmos_get_lpf_p_m_bandwidth(&temp_lpf_p_m_bandwidth_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.lpf_p_m_bandwidth", temp_lpf_p_m_bandwidth_e);
  pnpl_sths34pf80_3_tmos_lpf_p_bandwidth_t temp_lpf_p_bandwidth_e = (pnpl_sths34pf80_3_tmos_lpf_p_bandwidth_t)0;
  sths34pf80_3_tmos_get_lpf_p_bandwidth(&temp_lpf_p_bandwidth_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.lpf_p_bandwidth", temp_lpf_p_bandwidth_e);
  pnpl_sths34pf80_3_tmos_lpf_m_bandwidth_t temp_lpf_m_bandwidth_e = (pnpl_sths34pf80_3_tmos_lpf_m_bandwidth_t)0;
  sths34pf80_3_tmos_get_lpf_m_bandwidth(&temp_lpf_m_bandwidth_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.lpf_m_bandwidth", temp_lpf_m_bandwidth_e);
  int32_t temp_i = 0;
  sths34pf80_3_tmos_get_presence_threshold(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.presence_threshold", temp_i);
  sths34pf80_3_tmos_get_presence_hysteresis(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.presence_hysteresis", temp_i);
  sths34pf80_3_tmos_get_motion_threshold(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.motion_threshold", temp_i);
  sths34pf80_3_tmos_get_motion_hysteresis(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.motion_hysteresis", temp_i);
  sths34pf80_3_tmos_get_tambient_shock_threshold(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.tambient_shock_threshold", temp_i);
  sths34pf80_3_tmos_get_tambient_shock_hysteresis(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.tambient_shock_hysteresis", temp_i);
  sths34pf80_3_tmos_get_embedded_compensation(&temp_b);
  json_object_dotset_boolean(JSON_Status, "sths34pf80_3_tmos.embedded_compensation", temp_b);
  sths34pf80_3_tmos_get_software_compensation(&temp_b);
  json_object_dotset_boolean(JSON_Status, "sths34pf80_3_tmos.software_compensation", temp_b);
  pnpl_sths34pf80_3_tmos_compensation_type_t temp_compensation_type_e = (pnpl_sths34pf80_3_tmos_compensation_type_t)0;
  sths34pf80_3_tmos_get_compensation_type(&temp_compensation_type_e);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.compensation_type", temp_compensation_type_e);
  sths34pf80_3_tmos_get_sw_presence_threshold(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.sw_presence_threshold", temp_i);
  sths34pf80_3_tmos_get_sw_motion_threshold(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.sw_motion_threshold", temp_i);
  sths34pf80_3_tmos_get_compensation_filter_flag(&temp_b);
  json_object_dotset_boolean(JSON_Status, "sths34pf80_3_tmos.compensation_filter_flag", temp_b);
  sths34pf80_3_tmos_get_absence_static_flag(&temp_b);
  json_object_dotset_boolean(JSON_Status, "sths34pf80_3_tmos.absence_static_flag", temp_b);
  sths34pf80_3_tmos_get_samples_per_ts(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.samples_per_ts", temp_i);
  sths34pf80_3_tmos_get_ioffset(&temp_f);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.ioffset", temp_f);
  sths34pf80_3_tmos_get_usb_dps(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.usb_dps", temp_i);
  sths34pf80_3_tmos_get_sd_dps(&temp_i);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.sd_dps", temp_i);
  char *temp_s = "";
  sths34pf80_3_tmos_get_data_type(&temp_s);
  json_object_dotset_string(JSON_Status, "sths34pf80_3_tmos.data_type", temp_s);
  sths34pf80_3_tmos_get_sensor_annotation(&temp_s);
  ...
  int8_t temp_int8 = 0;
  sths34pf80_3_tmos_get_stream_id(&temp_int8);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.stream_id", temp_int8);
  sths34pf80_3_tmos_get_ep_id(&temp_int8);
  json_object_dotset_number(JSON_Status, "sths34pf80_3_tmos.ep_id", temp_int8);
                                               ...
                                               uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.enable"))
  {
    ...
    {
      bool old_enable;
      sths34pf80_3_tmos_get_enable(&old_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.odr"))
  {
    ...
    {
      pnpl_sths34pf80_3_tmos_odr_t old_odr;
      sths34pf80_3_tmos_get_odr(&old_odr);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.avg_tobject_num"))
  {
    ...
    {
      pnpl_sths34pf80_3_tmos_avg_tobject_num_t old_avg_tobject_num;
      sths34pf80_3_tmos_get_avg_tobject_num(&old_avg_tobject_num);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.avg_tambient_num"))
  {
    ...
    {
      pnpl_sths34pf80_3_tmos_avg_tambient_num_t old_avg_tambient_num;
      sths34pf80_3_tmos_get_avg_tambient_num(&old_avg_tambient_num);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.lpf_p_m_bandwidth"))
  {
    ...
    {
      pnpl_sths34pf80_3_tmos_lpf_p_m_bandwidth_t old_lpf_p_m_bandwidth;
      sths34pf80_3_tmos_get_lpf_p_m_bandwidth(&old_lpf_p_m_bandwidth);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.lpf_p_bandwidth"))
  {
    ...
    {
      pnpl_sths34pf80_3_tmos_lpf_p_bandwidth_t old_lpf_p_bandwidth;
      sths34pf80_3_tmos_get_lpf_p_bandwidth(&old_lpf_p_bandwidth);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.lpf_m_bandwidth"))
  {
    ...
    {
      pnpl_sths34pf80_3_tmos_lpf_m_bandwidth_t old_lpf_m_bandwidth;
      sths34pf80_3_tmos_get_lpf_m_bandwidth(&old_lpf_m_bandwidth);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.presence_threshold"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_presence_threshold(&old_presence_threshold);
      json_object_dotset_number(respJSONObject, "PnPL_Response.value", old_presence_threshold);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.presence_hysteresis"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_presence_hysteresis(&old_presence_hysteresis);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.motion_threshold"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_motion_threshold(&old_motion_threshold);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.motion_hysteresis"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_motion_hysteresis(&old_motion_hysteresis);
      json_object_dotset_number(respJSONObject, "PnPL_Response.value", old_motion_hysteresis);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.tambient_shock_threshold"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_tambient_shock_threshold(&old_tambient_shock_threshold);
      json_object_dotset_number(respJSONObject, "PnPL_Response.value", old_tambient_shock_threshold);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.tambient_shock_hysteresis"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_tambient_shock_hysteresis(&old_tambient_shock_hysteresis);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.embedded_compensation"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_embedded_compensation(&old_embedded_compensation);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.software_compensation"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_software_compensation(&old_software_compensation);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.compensation_type"))
  {
    ...
    {
      pnpl_sths34pf80_3_tmos_compensation_type_t old_compensation_type;
      sths34pf80_3_tmos_get_compensation_type(&old_compensation_type);
      json_object_dotset_number(respJSONObject, "PnPL_Response.value", old_compensation_type);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.sw_presence_threshold"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_sw_presence_threshold(&old_sw_presence_threshold);
      json_object_dotset_number(respJSONObject, "PnPL_Response.value", old_sw_presence_threshold);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.sw_motion_threshold"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_sw_motion_threshold(&old_sw_motion_threshold);
      json_object_dotset_number(respJSONObject, "PnPL_Response.value", old_sw_motion_threshold);
      json_object_dotset_boolean(respJSONObject, "PnPL_Response.status", false);
    }
  }
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.compensation_filter_flag"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_compensation_filter_flag(&old_compensation_filter_flag);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.absence_static_flag"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_absence_static_flag(&old_absence_static_flag);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.samples_per_ts"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_samples_per_ts(&old_samples_per_ts);
  ...
  if (json_object_dothas_value(tempJSONObject, "sths34pf80_3_tmos.sensor_annotation"))
  {
    ...
    else
    {
      ...
      sths34pf80_3_tmos_get_sensor_annotation(&old_sensor_annotation);
