...
#define STHS34PF80_TASK_CFG_MAX_INSTANCES_COUNT 3
#define VD6283TX_TASK_CFG_MAX_INSTANCES_COUNT 3
#define VL53L8CX_TASK_CFG_MAX_INSTANCES_COUNT 3
...
#define ISM330DHCX_MLC_DISABLED 1
#define IIS2ICLX_MLC_DISABLED 1
...
#ifdef ENABLE_THREADX_DBG_PIN
#define ISM330IS_TASK_CFG_TAG                     (CON34_PIN_12)
#endif

// file VL53L8CXTask.c
#define VL53L8CX_TASK_CFG_STACK_DEPTH             (TX_MINIMUM_STACK*7)
#define VL53L8CX_TASK_CFG_PRIORITY                (8)

// file STHS34PF80Task.c
#define STHS34PF80_TASK_CFG_STACK_DEPTH           (TX_MINIMUM_STACK*7)
#define STHS34PF80_TASK_CFG_PRIORITY              (8)

// file VD6283TXTask.c
#define VD6283TX_TASK_CFG_STACK_DEPTH             (TX_MINIMUM_STACK*7)
#define VD6283TX_TASK_CFG_PRIORITY                (8)

// file SGP40Task.c
#define SGP40_TASK_CFG_STACK_DEPTH                (TX_MINIMUM_STACK*7)
#define SGP40_TASK_CFG_PRIORITY                   (8)
