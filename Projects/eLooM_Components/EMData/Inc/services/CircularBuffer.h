...
#define SYS_NO_ERROR_CODE                                 (uint16_t)0
#endif
#ifndef SYS_CB_BASE_ERROR_CODE
#define SYS_CB_BASE_ERROR_CODE                            (uint16_t)1
#endif
#define SYS_CB_INVALID_ITEM_ERROR_CODE                    SYS_CB_BASE_ERROR_CODE + (uint16_t)1
#define SYS_CB_FULL_ERROR_CODE                            SYS_CB_BASE_ERROR_CODE + (uint16_t)2
#define SYS_CB_NO_READY_ITEM_ERROR_CODE                   SYS_CB_BASE_ERROR_CODE + (uint16_t)3
#define SYS_CB_ERROR_CODE_COUNT                           (uint16_t)3
