...
/**
  * Create  type name for struct _EMData.
  */
typedef struct _EMData EMData_t;
...
/**
  ...
  */
sys_error_code_t EMD_Init(EMData_t *p_data, uint8_t *p_payload, uint16_t type, uint8_t mode, uint32_t dimensions, ...);
...
/**
  ...
  */
sys_error_code_t EMD_GetValueAt(const EMData_t *p_data, void *p_val, uint32_t dimensions, ...);
...
/**
  ...
  */
uint8_t *EMD_DataAt(EMData_t *p_data, uint32_t dimensions, ...);
