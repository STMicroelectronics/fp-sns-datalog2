...
{
  ISensor_vtbl vtbl;
  sys_error_code_t (*SensorGetODR)(ISensorMems_t *_this, float *p_measured, float *p_nominal);
  float (*SensorGetFS)(ISensorMems_t *_this);
  float (*SensorGetSensitivity)(ISensorMems_t *_this);
  sys_error_code_t (*SensorSetODR)(ISensorMems_t *_this, float odr);
  sys_error_code_t (*SensorSetFS)(ISensorMems_t *_this, float fs);
