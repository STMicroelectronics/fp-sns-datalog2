/**
  ...
  ******************************************************************************
  */
#ifndef HSDCORE_INC_DRIVERS_ANALOGDFSDMMICDRIVER_H_
#define HSDCORE_INC_DRIVERS_ANALOGDFSDMMICDRIVER_H_
...
{
  /**
    * Specifies the DFSDM HAL initialization parameters generated by CubeMX.
    */
...
/**
  ...
  */
static inline sys_error_code_t AnalogMicDrvSetDataBuffer(AnalogMicDriver_t *_this, int32_t *p_buffer,
...
SYS_DEFINE_INLINE
sys_error_code_t AnalogMicDrvSetDataBuffer(AnalogMicDriver_t *_this, int32_t *p_buffer, uint32_t buffer_size)
{
  return DFSDMDrvSetDataBuffer((DFSDMDriver_t *)_this, p_buffer, buffer_size);
}
...
#endif /* HSDCORE_INC_DRIVERS_ANALOGDFSDMMICDRIVER_H_ */
