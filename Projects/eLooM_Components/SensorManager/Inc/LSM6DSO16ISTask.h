...
#ifndef LSM6DSO16ISTASK_H_
#define LSM6DSO16ISTASK_H_
...
#define LSM6DSO16IS_MAX_DRDY_PERIOD           (1.0)    /* seconds */

#define LSM6DSO16IS_CFG_MAX_LISTENERS         2

/**
  * Create  type name for _LSM6DSO16ISTask.
  */
typedef struct _LSM6DSO16ISTask LSM6DSO16ISTask;

/**
  *  LSM6DSO16ISTask internal structure.
  */
struct _LSM6DSO16ISTask
{
  /**
    * Base class object.
    */
  ...
  /**
    ...
    */
  ULONG lsm6dso16is_task_cfg_timer_period_ms;
...
/**
  * Allocate an instance of LSM6DSO16ISTask in the system heap.
  *
  * @param pIRQConfig [IN] specifies a ::MX_GPIOParams_t instance declared in the mx.h file.
  *        It must be a GPIO connected to the LSM6DSO16IS sensor and configured in EXTI mode.
  *        If it is NULL then the sensor is configured in polling mode.
  * @param pISPUConfig [IN] specifies a ::MX_GPIOParams_t instance declared in the mx.h file.
  *        It must be a GPIO connected to the LSM6DSO16IS ISPU and configured in EXTI mode.
...
/**
  * Call the default ::LSM6DSO16ISTaskAlloc and then it overwrite sensor name
  *
  * @param pIRQConfig [IN] specifies a ::MX_GPIOParams_t instance declared in the mx.h file.
  *        It must be a GPIO connected to the LSM6DSO16IS sensor and configured in EXTI mode.
  *        If it is NULL then the sensor is configured in polling mode.
...
/**
  * Allocate an instance of ::LSM6DSO16ISTask in a memory block specified by the application.
  * The size of the memory block must be greater or equal to `sizeof(LSM6DSO16ISTask)`.
  * This allocator allows the application to avoid the dynamic allocation.
  *
  * \code
  * LSM6DSO16ISTask sensor_task;
  * LSM6DSO16ISTaskStaticAlloc(&sensor_task);
  * \endcode
  *
...
/**
  * Interrupt callback
  */
void LSM6DSO16ISTask_EXTI_Callback(uint16_t Pin);
