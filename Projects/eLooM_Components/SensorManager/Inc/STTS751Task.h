/**
  ...
  ******************************************************************************
  */
#ifndef STTS751TASK_H_
#define STTS751TASK_H_
...
/**
  * Create  type name for _STTS751Task.
  */
typedef struct _STTS751Task STTS751Task;

/**
  *  STTS751Task internal structure.
  */
struct _STTS751Task
{
  /**
...
/**
  * Allocate an instance of STTS751Task in the system heap.
  *
  * @param pIRQConfig [IN] specifies a ::MX_GPIOParams_t instance declared in the mx.h file.
  *        It must be a GPIO connected to the STTS751 sensor and configured in EXTI mode.
...
/**
  * Call the default ::STTS751TaskAlloc and then it overwrite sensor name
  *
  * @param pIRQConfig [IN] specifies a ::MX_GPIOParams_t instance declared in the mx.h file.
  *        It must be a GPIO connected to the STTS751 sensor and configured in EXTI mode.
  *        If it is NULL then the sensor is configured in polling mode.
...
/**
  * Allocate an instance of ::STTS751Task in a memory block specified by the application.
  * The size of the memory block must be greater or equal to `sizeof(STTS751Task)`.
  * This allocator allows the application to avoid the dynamic allocation.
  *
  * \code
  * STTS751Task sensor_task;
  * STTS751TaskStaticAlloc(&sensor_task);
  * \endcode
  *
