                                               ...
                                               ULONG *pParams)
{
  ...
  {
    p_obj->p_sensor_bus_if = I2CBusIFAlloc(ISM330BX_ID, ISM330BX_I2C_ADD_H, 0);
    if (p_obj->p_sensor_bus_if == NULL)
    {
      res = SYS_TASK_HEAP_OUT_OF_MEMORY_ERROR_CODE;
      SYS_SET_SERVICE_LEVEL_ERROR_CODE(res);
...
sys_error_code_t ISM330BXTask_vtblAccGetODR(ISensorMems_t *_this, float *p_measured, float *p_nominal)
{
  assert_param(_this != NULL);
...
float ISM330BXTask_vtblAccGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  ISM330BXTask *p_if_owner = (ISM330BXTask *)((uint32_t) _this - offsetof(ISM330BXTask, acc_sensor_if));
...
float ISM330BXTask_vtblAccGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  ISM330BXTask *p_if_owner = (ISM330BXTask *)((uint32_t) _this - offsetof(ISM330BXTask, acc_sensor_if));
...
sys_error_code_t ISM330BXTask_vtblGyroGetODR(ISensorMems_t *_this, float *p_measured, float *p_nominal)
{
  assert_param(_this != NULL);
  /*get the object implementing the ISourceObservable IF */
  ISM330BXTask *p_if_owner = (ISM330BXTask *)((uint32_t) _this - offsetof(ISM330BXTask, gyro_sensor_if));
...
float ISM330BXTask_vtblGyroGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  ISM330BXTask *p_if_owner = (ISM330BXTask *)((uint32_t) _this - offsetof(ISM330BXTask, gyro_sensor_if));
...
float ISM330BXTask_vtblGyroGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  ISM330BXTask *p_if_owner = (ISM330BXTask *)((uint32_t) _this - offsetof(ISM330BXTask, gyro_sensor_if));
...
sys_error_code_t ISM330BXTask_vtblMlcGetODR(ISensorMems_t *_this, float *p_measured, float *p_nominal)
{
  assert_param(_this != NULL);
  /*get the object implementing the ISourceObservable IF */
  ISM330BXTask *p_if_owner = (ISM330BXTask *)((uint32_t) _this - offsetof(ISM330BXTask, mlc_sensor_if));
...
float ISM330BXTask_vtblMlcGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
...
float ISM330BXTask_vtblMlcGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
...
sys_error_code_t ISM330BXTask_vtblSensorSetODR(ISensorMems_t *_this, float odr)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
...
sys_error_code_t ISM330BXTask_vtblSensorSetFS(ISensorMems_t *_this, float fs)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  ISM330BXTask *p_if_owner = ISM330BXTaskGetOwnerFromISensorIF((ISensor_t *)_this);
...
static sys_error_code_t ISM330BXTaskSensorInit(ISM330BXTask *_this)
{
  ...
  if (_this->samples_per_it == 0)
  {
    ...
    else if (ism330bx_wtm_level < ISM330BX_MIN_WTM_LEVEL)
    {
      ism330bx_wtm_level = ISM330BX_MIN_WTM_LEVEL;
    }
...
#if ISM330BX_FIFO_ENABLED
  _this->ism330bx_task_cfg_timer_period_ms = (uint16_t)((1000.0f / _this->ism330bx_task_cfg_timer_period_ms) * (((float)(_this->samples_per_it)) / 2.0f));
#else
...
static sys_error_code_t ISM330BXTaskSensorReadData(ISM330BXTask *_this)
{
  ...
  {
    ism330bx_read_reg(p_sensor_drv, ISM330BX_FIFO_DATA_OUT_TAG, _this->p_fast_sensor_data_buff, samples_per_it * 7);
  ...
  if ((_this->acc_sensor_status.is_active) && (_this->gyro_sensor_status.is_active))
  {
    ...
    if (val.xlda == 1U)
    {
      ...
      ism330bx_acceleration_raw_get(p_sensor_drv, p16);
#if (HSD_USE_DUMMY_DATA == 1)
      *p16++ = dummyDataCounter_acc++;
      *p16++ = dummyDataCounter_acc++;
      *p16++ = dummyDataCounter_acc++;
    ...
    if (val.gda == 1U)
    {
      ...
      ism330bx_angular_rate_raw_get(p_sensor_drv, p16);
#if (HSD_USE_DUMMY_DATA == 1)
      *p16++ = dummyDataCounter_gyro++;
      *p16++ = dummyDataCounter_gyro++;
      *p16++ = dummyDataCounter_gyro++;
