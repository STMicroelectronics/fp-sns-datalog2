...
#include "LSM6DSV320XTask_vtbl.h"
...
#ifndef LSM6DSV320X_TASK_CFG_STACK_DEPTH
#define LSM6DSV320X_TASK_CFG_STACK_DEPTH              (TX_MINIMUM_STACK*8)
#endif

#ifndef LSM6DSV320X_TASK_CFG_PRIORITY
#define LSM6DSV320X_TASK_CFG_PRIORITY                 (TX_MAX_PRIORITIES - 1)
#endif

#ifndef LSM6DSV320X_TASK_CFG_IN_QUEUE_LENGTH
#define LSM6DSV320X_TASK_CFG_IN_QUEUE_LENGTH          20u
#endif

#define LSM6DSV320X_TASK_CFG_IN_QUEUE_ITEM_SIZE       sizeof(SMMessage)

#ifndef LSM6DSV320X_TASK_CFG_TIMER_PERIOD_MS
#define LSM6DSV320X_TASK_CFG_TIMER_PERIOD_MS          1000
#endif
#ifndef LSM6DSV320X_TASK_CFG_MLC_TIMER_PERIOD_MS
#define LSM6DSV320X_TASK_CFG_MLC_TIMER_PERIOD_MS      200
#endif

#define LSM6DSV320X_TAG_GYR                           (0x01)
#define LSM6DSV320X_TAG_ACC                           (0x02)
#define LSM6DSV320X_TAG_HG_ACC                        (0x1D)

#ifndef LSM6DSV320X_TASK_CFG_MAX_INSTANCES_COUNT
#define LSM6DSV320X_TASK_CFG_MAX_INSTANCES_COUNT      1
#endif

#define SYS_DEBUGF(level, message)                   SYS_DEBUGF3(SYS_DBG_LSM6DSV320X, level, message)
...
/**
  ...
  */
typedef struct _LSM6DSV320XTaskClass
{
  /**
    * LSM6DSV320XTask class virtual table.
    */
  ...
  /**
    * LSM6DSV320XTask (PM_STATE, ExecuteStepFunc) map.
    */
  ...
  /**
    ...
    */
  MTMapElement_t task_map_elements[2 * LSM6DSV320X_TASK_CFG_MAX_INSTANCES_COUNT];
...
/**
  ...
  */
static sys_error_code_t LSM6DSV320XTaskExecuteStepState1(AManagedTask *_this);
...
/**
  ...
  * @return SYS_NO_EROR_CODE if success, a task specific error code otherwise.
  */
static sys_error_code_t LSM6DSV320XTaskExecuteStepDatalog(AManagedTask *_this);
...
/**
  ...
  * @return SYS_NO_EROR_CODE if success, a task specific error code otherwise.
  */
static sys_error_code_t LSM6DSV320XTaskSensorInit(LSM6DSV320XTask *_this);
...
/**
  ...
  * @return SYS_NO_EROR_CODE if success, a task specific error code otherwise.
  */
static sys_error_code_t LSM6DSV320XTaskSensorReadData(LSM6DSV320XTask *_this);
...
/**
  ...
  * @return SYS_NO_EROR_CODE if success, a task specific error code otherwise.
  */
static sys_error_code_t LSM6DSV320XTaskSensorReadMLC(LSM6DSV320XTask *_this);
...
/**
  ...
  */
static sys_error_code_t LSM6DSV320XTaskSensorRegister(LSM6DSV320XTask *_this);
...
/**
  ...
  * @return SYS_NO_ERROR_CODE if success, an error code otherwise
  */
static sys_error_code_t LSM6DSV320XTaskSensorInitTaskParams(LSM6DSV320XTask *_this);

/**
  * Private implementation of sensor interface methods for LSM6DSV320X sensor
  */
static sys_error_code_t LSM6DSV320XTaskSensorSetODR(LSM6DSV320XTask *_this, SMMessage report);
static sys_error_code_t LSM6DSV320XTaskSensorSetFS(LSM6DSV320XTask *_this, SMMessage report);
static sys_error_code_t LSM6DSV320XTaskSensorSetFifoWM(LSM6DSV320XTask *_this, SMMessage report);
static sys_error_code_t LSM6DSV320XTaskSensorEnable(LSM6DSV320XTask *_this, SMMessage report);
static sys_error_code_t LSM6DSV320XTaskSensorDisable(LSM6DSV320XTask *_this, SMMessage report);
...
/**
  ...
  */
static boolean_t LSM6DSV320XTaskSensorIsActive(const LSM6DSV320XTask *_this);

static sys_error_code_t LSM6DSV320XTaskEnterLowPowerMode(const LSM6DSV320XTask *_this);

static sys_error_code_t LSM6DSV320XTaskConfigureIrqPin(const LSM6DSV320XTask *_this, boolean_t LowPower);
static sys_error_code_t LSM6DSV320XTaskConfigureMLCPin(const LSM6DSV320XTask *_this, boolean_t LowPower);
...
/**
  ...
  */
static void LSM6DSV320XTaskTimerCallbackFunction(ULONG param);
...
/**
  ...
  * @param param [IN] specifies an application defined parameter.
  */
static void LSM6DSV320XTaskMLCTimerCallbackFunction(ULONG param);
...
/**
  ...
  */
static inline LSM6DSV320XTask *LSM6DSV320XTaskGetOwnerFromISensorIF(ISensor_t *p_if);
...
/**
  ...
  * @return the instance of the task object that implements the given interface.
  */
static inline LSM6DSV320XTask *LSM6DSV320XTaskGetOwnerFromISensorLLIF(ISensorLL_t *p_if);

/**
  * Read the odr value from the sensor and update the internal model
  */
static sys_error_code_t LSM6DSV320X_ODR_Sync(LSM6DSV320XTask *_this);

/**
  * Read the odr value from the sensor and update the internal model
  */
static sys_error_code_t LSM6DSV320X_FS_Sync(LSM6DSV320XTask *_this);

/**
  *  Return Min of 3 non negative floats
  */
static float_t LSM6DSV320X_FindMin(float_t Val1, float_t Val2, float_t Val3);

/**
  * Return Max of 3 floats
  */
static float_t __attribute__((unused)) LSM6DSV320X_FindMax(float_t Val1, float_t Val2, float_t Val3);

/**
  * Sort the sensors based on the sensor's ODRs
  */
static sys_error_code_t LSM6DSV320X_SensorSpeedSort(float_t ODR1, float_t ODR2, float_t ODR3, uint8_t *FastSensor,
...
/**
  ...
  */
static inline sys_error_code_t LSM6DSV320XTaskPostReportToFront(LSM6DSV320XTask *_this, SMMessage *pReport);
...
/**
  ...
  * @return SYS_NO_EROR_CODE if success, SYS_SENSOR_TASK_MSG_LOST_ERROR_CODE.
  */
static inline sys_error_code_t LSM6DSV320XTaskPostReportToBack(LSM6DSV320XTask *_this, SMMessage *pReport);
...
/**
  ...
  */
//static LSM6DSV320XTask sTaskObj;
/**
  * The class object.
  */
static LSM6DSV320XTaskClass_t sTheClass =
{
  /* class virtual table */
  {
    LSM6DSV320XTask_vtblHardwareInit,
    LSM6DSV320XTask_vtblOnCreateTask,
    LSM6DSV320XTask_vtblDoEnterPowerMode,
    LSM6DSV320XTask_vtblHandleError,
    LSM6DSV320XTask_vtblOnEnterTaskControlLoop,
    LSM6DSV320XTask_vtblForceExecuteStep,
    LSM6DSV320XTask_vtblOnEnterPowerMode
  },
  ...
  /* class::acc_sensor_if_vtbl virtual table */
  {
    {
      {
        LSM6DSV320XTask_vtblAccGetId,
        LSM6DSV320XTask_vtblAccGetEventSourceIF,
        LSM6DSV320XTask_vtblAccGetDataInfo
      },
      LSM6DSV320XTask_vtblSensorEnable,
      LSM6DSV320XTask_vtblSensorDisable,
      LSM6DSV320XTask_vtblSensorIsEnabled,
      LSM6DSV320XTask_vtblAccGetDescription,
      LSM6DSV320XTask_vtblAccGetStatus,
      LSM6DSV320XTask_vtblAccGetStatusPointer
    },
    LSM6DSV320XTask_vtblAccGetODR,
    LSM6DSV320XTask_vtblAccGetFS,
    LSM6DSV320XTask_vtblAccGetSensitivity,
    LSM6DSV320XTask_vtblSensorSetODR,
    LSM6DSV320XTask_vtblSensorSetFS,
    LSM6DSV320XTask_vtblSensorSetFifoWM
  },
  ...
  /* class::hg_acc_sensor_if_vtbl virtual table */
  {
    {
      {
        LSM6DSV320XTask_vtblHgAccGetId,
        LSM6DSV320XTask_vtblHgAccGetEventSourceIF,
        LSM6DSV320XTask_vtblHgAccGetDataInfo
      },
      LSM6DSV320XTask_vtblSensorEnable,
      LSM6DSV320XTask_vtblSensorDisable,
      LSM6DSV320XTask_vtblSensorIsEnabled,
      LSM6DSV320XTask_vtblHgAccGetDescription,
      LSM6DSV320XTask_vtblHgAccGetStatus,
      LSM6DSV320XTask_vtblHgAccGetStatusPointer
    },
    LSM6DSV320XTask_vtblHgAccGetODR,
    LSM6DSV320XTask_vtblHgAccGetFS,
    LSM6DSV320XTask_vtblHgAccGetSensitivity,
    LSM6DSV320XTask_vtblSensorSetODR,
    LSM6DSV320XTask_vtblSensorSetFS,
    LSM6DSV320XTask_vtblSensorSetFifoWM
  },
  ...
  /* class::gyro_sensor_if_vtbl virtual table */
  {
    {
      {
        LSM6DSV320XTask_vtblGyroGetId,
        LSM6DSV320XTask_vtblGyroGetEventSourceIF,
        LSM6DSV320XTask_vtblGyroGetDataInfo
      },
      LSM6DSV320XTask_vtblSensorEnable,
      LSM6DSV320XTask_vtblSensorDisable,
      LSM6DSV320XTask_vtblSensorIsEnabled,
      LSM6DSV320XTask_vtblGyroGetDescription,
      LSM6DSV320XTask_vtblGyroGetStatus,
      LSM6DSV320XTask_vtblGyroGetStatusPointer
    },
    LSM6DSV320XTask_vtblGyroGetODR,
    LSM6DSV320XTask_vtblGyroGetFS,
    LSM6DSV320XTask_vtblGyroGetSensitivity,
    LSM6DSV320XTask_vtblSensorSetODR,
    LSM6DSV320XTask_vtblSensorSetFS,
    LSM6DSV320XTask_vtblSensorSetFifoWM
  },
  ...
  /* class::mlc_sensor_if_vtbl virtual table */
  {
    {
      {
        LSM6DSV320XTask_vtblMlcGetId,
        LSM6DSV320XTask_vtblMlcGetEventSourceIF,
        LSM6DSV320XTask_vtblMlcGetDataInfo
      },
      LSM6DSV320XTask_vtblSensorEnable,
      LSM6DSV320XTask_vtblSensorDisable,
      LSM6DSV320XTask_vtblSensorIsEnabled,
      LSM6DSV320XTask_vtblMlcGetDescription,
      LSM6DSV320XTask_vtblMlcGetStatus,
      LSM6DSV320XTask_vtblMlcGetStatusPointer
    },
    LSM6DSV320XTask_vtblMlcGetODR,
    LSM6DSV320XTask_vtblMlcGetFS,
    LSM6DSV320XTask_vtblMlcGetSensitivity,
    LSM6DSV320XTask_vtblSensorSetODR,
    LSM6DSV320XTask_vtblSensorSetFS,
    LSM6DSV320XTask_vtblSensorSetFifoWM
  },
  ...
  {
    LSM6DSV320XTask_vtblSensorReadReg,
    LSM6DSV320XTask_vtblSensorWriteReg,
    LSM6DSV320XTask_vtblSensorSyncModel
  },
  ...
  {
    LSM6DSV320XTaskExecuteStepState1,
    NULL,
    LSM6DSV320XTaskExecuteStepDatalog,
  },
...
// *********************
ISourceObservable *LSM6DSV320XTaskGetAccSensorIF(LSM6DSV320XTask *_this)
{
  return (ISourceObservable *) & (_this->acc_sensor_if);
}

ISourceObservable *LSM6DSV320XTaskGetHgAccSensorIF(LSM6DSV320XTask *_this)
{
  return (ISourceObservable *) & (_this->hg_acc_sensor_if);
}

ISourceObservable *LSM6DSV320XTaskGetGyroSensorIF(LSM6DSV320XTask *_this)
{
  return (ISourceObservable *) & (_this->gyro_sensor_if);
}

ISourceObservable *LSM6DSV320XTaskGetMlcSensorIF(LSM6DSV320XTask *_this)
{
  return (ISourceObservable *) & (_this->mlc_sensor_if);
}

ISensorLL_t *LSM6DSV320XTaskGetSensorLLIF(LSM6DSV320XTask *_this)
{
...
{
  LSM6DSV320XTask *p_new_obj = SysAlloc(sizeof(LSM6DSV320XTask));
...
AManagedTaskEx *LSM6DSV320XTaskAllocSetName(const void *pIRQConfig, const void *pMLCConfig, const void *pCSConfig,
                                            const char *p_name)
{
  LSM6DSV320XTask *p_new_obj = (LSM6DSV320XTask *) LSM6DSV320XTaskAlloc(pIRQConfig, pMLCConfig, pCSConfig);
...
{
  LSM6DSV320XTask *p_obj = (LSM6DSV320XTask *) p_mem_block;
...
{
  LSM6DSV320XTask *p_obj = (LSM6DSV320XTask *) LSM6DSV320XTaskStaticAlloc(p_mem_block, pIRQConfig, pMLCConfig, pCSConfig);
...
ABusIF *LSM6DSV320XTaskGetSensorIF(LSM6DSV320XTask *_this)
{
...
IEventSrc *LSM6DSV320XTaskGetAccEventSrcIF(LSM6DSV320XTask *_this)
{
  assert_param(_this != NULL);
...
IEventSrc *LSM6DSV320XTaskGetHgAccEventSrcIF(LSM6DSV320XTask *_this)
{
  assert_param(_this != NULL);
...
IEventSrc *LSM6DSV320XTaskGetGyroEventSrcIF(LSM6DSV320XTask *_this)
{
  assert_param(_this != NULL);
...
IEventSrc *LSM6DSV320XTaskGetMlcEventSrcIF(LSM6DSV320XTask *_this)
{
  assert_param(_this != NULL);
...
sys_error_code_t LSM6DSV320XTask_vtblHardwareInit(AManagedTask *_this, void *pParams)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_obj = (LSM6DSV320XTask *) _this;
...
sys_error_code_t LSM6DSV320XTask_vtblOnCreateTask(AManagedTask *_this, tx_entry_function_t *pTaskCode, CHAR **pName,
                                                  VOID **pvStackStart,
                                                  ...
                                                  ULONG *pParams)
{
  ...
  uint32_t item_size = (uint32_t) LSM6DSV320X_TASK_CFG_IN_QUEUE_ITEM_SIZE;
  VOID *p_queue_items_buff = SysAlloc(LSM6DSV320X_TASK_CFG_IN_QUEUE_LENGTH * item_size);
  ...
  if (TX_SUCCESS != tx_queue_create(&p_obj->in_queue, "LSM6DSV320X_Q", item_size / 4u, p_queue_items_buff,
                                    LSM6DSV320X_TASK_CFG_IN_QUEUE_LENGTH * item_size))
  {
    res = SYS_TASK_HEAP_OUT_OF_MEMORY_ERROR_CODE;
    SYS_SET_SERVICE_LEVEL_ERROR_CODE(res);
    return res;
  ...
  if (TX_SUCCESS
      != tx_timer_create(&p_obj->read_timer, "LSM6DSV320X_T", LSM6DSV320XTaskTimerCallbackFunction, (ULONG)_this,
                         AMT_MS_TO_TICKS(LSM6DSV320X_TASK_CFG_TIMER_PERIOD_MS), 0, TX_NO_ACTIVATE))
  {
    res = SYS_TASK_HEAP_OUT_OF_MEMORY_ERROR_CODE;
    SYS_SET_SERVICE_LEVEL_ERROR_CODE(res);
    return res;
  ...
  if (TX_SUCCESS
      != tx_timer_create(&p_obj->mlc_timer, "LSM6DSV320X_MLC_T", LSM6DSV320XTaskMLCTimerCallbackFunction, (ULONG)_this,
                         AMT_MS_TO_TICKS(LSM6DSV320X_TASK_CFG_MLC_TIMER_PERIOD_MS), 0, TX_NO_ACTIVATE))
  {
    res = SYS_TASK_HEAP_OUT_OF_MEMORY_ERROR_CODE;
    SYS_SET_SERVICE_LEVEL_ERROR_CODE(res);
    return res;
  ...
  if (p_obj->pCSConfig != NULL)
  {
    p_obj->p_sensor_bus_if = SPIBusIFAlloc(LSM6DSV320X_ID, p_obj->pCSConfig->port, (uint16_t) p_obj->pCSConfig->pin, 0);
  ...
  {
    p_obj->p_sensor_bus_if = I2CBusIFAlloc(LSM6DSV320X_ID, LSM6DSV320X_I2C_ADD_H, 0);
    if (p_obj->p_sensor_bus_if == NULL)
    {
      res = SYS_TASK_HEAP_OUT_OF_MEMORY_ERROR_CODE;
      SYS_SET_SERVICE_LEVEL_ERROR_CODE(res);
  ...
  {
    (void) MTMap_Init(&sTheClass.task_map, sTheClass.task_map_elements, 2 * LSM6DSV320X_TASK_CFG_MAX_INSTANCES_COUNT);
  }
  ...
  *pStackDepth = LSM6DSV320X_TASK_CFG_STACK_DEPTH;
  *pParams = (ULONG) _this;
  *pPriority = LSM6DSV320X_TASK_CFG_PRIORITY;
  *pPreemptThreshold = LSM6DSV320X_TASK_CFG_PRIORITY;
  *pTimeSlice = TX_NO_TIME_SLICE;
  *pAutoStart = TX_AUTO_START;

  res = LSM6DSV320XTaskSensorInitTaskParams(p_obj);
  if (SYS_IS_ERROR_CODE(res))
  {
    res = SYS_TASK_HEAP_OUT_OF_MEMORY_ERROR_CODE;
    SYS_SET_SERVICE_LEVEL_ERROR_CODE(res);
  ...
  res = LSM6DSV320XTaskSensorRegister(p_obj);
  if (SYS_IS_ERROR_CODE(res))
  {
    SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("LSM6DSV320X: unable to register with DB\r\n"));
    sys_error_handler();
  }
...
sys_error_code_t LSM6DSV320XTask_vtblDoEnterPowerMode(AManagedTask *_this, const EPowerMode ActivePowerMode,
                                                      const EPowerMode NewPowerMode)
{
  ...
  {
    if (LSM6DSV320XTaskSensorIsActive(p_obj))
    {
      SMMessage report =
      {
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("LSM6DSV320X: -> SENSORS_ACTIVE\r\n"));
  }
  else if (NewPowerMode == E_POWER_MODE_STATE1)
  {
    if (ActivePowerMode == E_POWER_MODE_SENSORS_ACTIVE)
    {
      ...
      lsm6dsv320x_xl_data_rate_set(p_sensor_drv, LSM6DSV320X_ODR_OFF);
      lsm6dsv320x_hg_xl_data_rate_set(p_sensor_drv, LSM6DSV320X_HG_XL_ODR_OFF, 0);
      lsm6dsv320x_gy_data_rate_set(p_sensor_drv, LSM6DSV320X_ODR_OFF);
      lsm6dsv320x_fifo_gy_batch_set(p_sensor_drv, LSM6DSV320X_GY_NOT_BATCHED);
      lsm6dsv320x_fifo_xl_batch_set(p_sensor_drv, LSM6DSV320X_XL_NOT_BATCHED);
      lsm6dsv320x_fifo_hg_xl_batch_set(p_sensor_drv, 0);
      lsm6dsv320x_fifo_mode_set(p_sensor_drv, LSM6DSV320X_BYPASS_MODE);
      p_obj->samples_per_it = 0;
      ...
      {
        LSM6DSV320XTaskConfigureIrqPin(p_obj, TRUE);
      }
      if (p_obj->pMLCConfig == NULL)
      {
      ...
      {
        LSM6DSV320XTaskConfigureMLCPin(p_obj, TRUE);
      }
      memset(p_obj->p_mlc_sensor_data_buff, 0, sizeof(p_obj->p_mlc_sensor_data_buff));
    }
    SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("LSM6DSV320X: -> STATE1\r\n"));
  }
  else if (NewPowerMode == E_POWER_MODE_SLEEP_1)
  {
    /* the MCU is going in stop so I put the sensor in low power
     from the INIT task */
    res = LSM6DSV320XTaskEnterLowPowerMode(p_obj);
    if (SYS_IS_ERROR_CODE(res))
    {
      SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV320X - Enter Low Power Mode failed.\r\n"));
    }
    if (p_obj->pIRQConfig != NULL)
    {
      LSM6DSV320XTaskConfigureIrqPin(p_obj, TRUE);
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("LSM6DSV320X: -> SLEEP_1\r\n"));
  }

  return res;
}

sys_error_code_t LSM6DSV320XTask_vtblHandleError(AManagedTask *_this, SysEvent xError)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  //  LSM6DSV320XTask *p_obj = (LSM6DSV320XTask*)_this;
...
sys_error_code_t LSM6DSV320XTask_vtblOnEnterTaskControlLoop(AManagedTask *_this)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;

  SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("LSM6DSV320X: start.\r\n"));

#if defined (ENABLE_THREADX_DBG_PIN) && defined (LSM6DSV320X_TASK_CFG_TAG)
  LSM6DSV320XTask *p_obj = (LSM6DSV320XTask *) _this;
  p_obj->super.m_xTaskHandle.pxTaskTag = LSM6DSV320X_TASK_CFG_TAG;
#endif
...
sys_error_code_t LSM6DSV320XTask_vtblForceExecuteStep(AManagedTaskEx *_this, EPowerMode ActivePowerMode)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_obj = (LSM6DSV320XTask *) _this;
  ...
  if ((ActivePowerMode == E_POWER_MODE_STATE1) || (ActivePowerMode == E_POWER_MODE_SENSORS_ACTIVE))
  {
    ...
    {
      res = LSM6DSV320XTaskPostReportToFront(p_obj, (SMMessage *) &report);
    }
    else
    {
...
sys_error_code_t LSM6DSV320XTask_vtblOnEnterPowerMode(AManagedTaskEx *_this, const EPowerMode ActivePowerMode,
                                                      const EPowerMode NewPowerMode)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
...
uint8_t LSM6DSV320XTask_vtblAccGetId(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, acc_sensor_if));
  uint8_t res = p_if_owner->acc_id;

  return res;
}

uint8_t LSM6DSV320XTask_vtblHgAccGetId(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, hg_acc_sensor_if));
  uint8_t res = p_if_owner->hg_acc_id;

  return res;
}

uint8_t LSM6DSV320XTask_vtblGyroGetId(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, gyro_sensor_if));
  uint8_t res = p_if_owner->gyro_id;

  return res;
}

uint8_t LSM6DSV320XTask_vtblMlcGetId(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, mlc_sensor_if));
  uint8_t res = p_if_owner->mlc_id;

  return res;
}

IEventSrc *LSM6DSV320XTask_vtblAccGetEventSourceIF(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, acc_sensor_if));
...
IEventSrc *LSM6DSV320XTask_vtblHgAccGetEventSourceIF(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, hg_acc_sensor_if));
...
IEventSrc *LSM6DSV320XTask_vtblGyroGetEventSourceIF(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, gyro_sensor_if));
...
IEventSrc *LSM6DSV320XTask_vtblMlcGetEventSourceIF(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, mlc_sensor_if));
...
sys_error_code_t LSM6DSV320XTask_vtblAccGetODR(ISensorMems_t *_this, float_t *p_measured, float_t *p_nominal)
{
  assert_param(_this != NULL);
...
float_t LSM6DSV320XTask_vtblAccGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, acc_sensor_if));
...
float_t LSM6DSV320XTask_vtblAccGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, acc_sensor_if));
...
EMData_t LSM6DSV320XTask_vtblAccGetDataInfo(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, acc_sensor_if));
...
sys_error_code_t LSM6DSV320XTask_vtblHgAccGetODR(ISensorMems_t *_this, float_t *p_measured, float_t *p_nominal)
{
  assert_param(_this != NULL);
  /*get the object implementing the ISourceObservable IF */
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, hg_acc_sensor_if));
...
float_t LSM6DSV320XTask_vtblHgAccGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, hg_acc_sensor_if));
...
float_t LSM6DSV320XTask_vtblHgAccGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, hg_acc_sensor_if));
...
EMData_t LSM6DSV320XTask_vtblHgAccGetDataInfo(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, hg_acc_sensor_if));
...
sys_error_code_t LSM6DSV320XTask_vtblGyroGetODR(ISensorMems_t *_this, float_t *p_measured, float_t *p_nominal)
{
  assert_param(_this != NULL);
  /*get the object implementing the ISourceObservable IF */
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, gyro_sensor_if));
...
float_t LSM6DSV320XTask_vtblGyroGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, gyro_sensor_if));
...
float_t LSM6DSV320XTask_vtblGyroGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, gyro_sensor_if));
...
EMData_t LSM6DSV320XTask_vtblGyroGetDataInfo(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, gyro_sensor_if));
...
sys_error_code_t LSM6DSV320XTask_vtblMlcGetODR(ISensorMems_t *_this, float_t *p_measured, float_t *p_nominal)
{
  assert_param(_this != NULL);
  /*get the object implementing the ISourceObservable IF */
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, mlc_sensor_if));
...
float_t LSM6DSV320XTask_vtblMlcGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  ...
  SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV320X: warning - MLC GetFS() not supported.\r\n"));

  return -1.0f;
}

float_t LSM6DSV320XTask_vtblMlcGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  ...
  SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV320X: warning - MLC GetSensitivity() not supported.\r\n"));

  return -1.0f;
}

EMData_t LSM6DSV320XTask_vtblMlcGetDataInfo(ISourceObservable *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = (LSM6DSV320XTask *)((uint32_t) _this - offsetof(LSM6DSV320XTask, mlc_sensor_if));
...
sys_error_code_t LSM6DSV320XTask_vtblSensorSetODR(ISensorMems_t *_this, float_t odr)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF((ISensor_t *)_this);
  ...
  else
  {
    ...
    res = LSM6DSV320XTaskPostReportToBack(p_if_owner, (SMMessage *) &report);
  }

  return res;
}

sys_error_code_t LSM6DSV320XTask_vtblSensorSetFS(ISensorMems_t *_this, float_t fs)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF((ISensor_t *)_this);
...
sys_error_code_t LSM6DSV320XTask_vtblSensorSetFifoWM(ISensorMems_t *_this, uint16_t fifoWM)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF((ISensor_t *)_this);
...
sys_error_code_t LSM6DSV320XTask_vtblSensorEnable(ISensor_t *_this)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
sys_error_code_t LSM6DSV320XTask_vtblSensorDisable(ISensor_t *_this)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
boolean_t LSM6DSV320XTask_vtblSensorIsEnabled(ISensor_t *_this)
{
  assert_param(_this != NULL);
  boolean_t res = FALSE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorDescriptor_t LSM6DSV320XTask_vtblAccGetDescription(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorDescriptor_t LSM6DSV320XTask_vtblHgAccGetDescription(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorDescriptor_t LSM6DSV320XTask_vtblGyroGetDescription(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorDescriptor_t LSM6DSV320XTask_vtblMlcGetDescription(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorStatus_t LSM6DSV320XTask_vtblAccGetStatus(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorStatus_t LSM6DSV320XTask_vtblHgAccGetStatus(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorStatus_t LSM6DSV320XTask_vtblGyroGetStatus(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorStatus_t LSM6DSV320XTask_vtblMlcGetStatus(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
...
SensorStatus_t *LSM6DSV320XTask_vtblAccGetStatusPointer(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
  return &p_if_owner->acc_sensor_status;
...
SensorStatus_t *LSM6DSV320XTask_vtblHgAccGetStatusPointer(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
  return &p_if_owner->hg_acc_sensor_status;
...
SensorStatus_t *LSM6DSV320XTask_vtblGyroGetStatusPointer(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
  return &p_if_owner->gyro_sensor_status;
...
SensorStatus_t *LSM6DSV320XTask_vtblMlcGetStatusPointer(ISensor_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorIF(_this);
  return &p_if_owner->mlc_sensor_status;
...
sys_error_code_t LSM6DSV320XTask_vtblSensorReadReg(ISensorLL_t *_this, uint16_t reg, uint8_t *data, uint16_t len)
{
  assert_param(_this != NULL);
  ...
  assert_param(len != 0U);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorLLIF(_this);
  stmdev_ctx_t *p_sensor_drv = (stmdev_ctx_t *) &p_if_owner->p_sensor_bus_if->m_xConnector;
  uint8_t reg8 = (uint8_t)(reg & 0x00FF);

  if (lsm6dsv320x_read_reg(p_sensor_drv, reg8, data, len) != 0)
  {
...
sys_error_code_t LSM6DSV320XTask_vtblSensorWriteReg(ISensorLL_t *_this, uint16_t reg, const uint8_t *data, uint16_t len)
{
  assert_param(_this != NULL);
  assert_param(reg <= 0xFFU);
  assert_param(data != NULL);
  ...
  if (lsm6dsv320x_write_reg(p_sensor_drv, reg8, (uint8_t *) data, len) != 0)
  {
    res = SYS_BASE_ERROR_CODE;
  }
...
sys_error_code_t LSM6DSV320XTask_vtblSensorSyncModel(ISensorLL_t *_this)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV320XTask *p_if_owner = LSM6DSV320XTaskGetOwnerFromISensorLLIF(_this);

  if (LSM6DSV320X_ODR_Sync(p_if_owner) != SYS_NO_ERROR_CODE)
  {
    res = SYS_BASE_ERROR_CODE;
  }
  if (LSM6DSV320X_FS_Sync(p_if_owner) != SYS_NO_ERROR_CODE)
  {
    res = SYS_BASE_ERROR_CODE;
  }
      ...
      case SM_MESSAGE_ID_SENSOR_CMD:
      {
        switch (report.sensorMessage.nCmdID)
        {
          case SENSOR_CMD_ID_SET_ODR:
            res = LSM6DSV320XTaskSensorSetODR(p_obj, report);
            break;
          case SENSOR_CMD_ID_SET_FS:
            res = LSM6DSV320XTaskSensorSetFS(p_obj, report);
            break;
          case SENSOR_CMD_ID_SET_FIFO_WM:
            res = LSM6DSV320XTaskSensorSetFifoWM(p_obj, report);
            break;
          case SENSOR_CMD_ID_ENABLE:
            res = LSM6DSV320XTaskSensorEnable(p_obj, report);
            break;
          case SENSOR_CMD_ID_DISABLE:
            res = LSM6DSV320XTaskSensorDisable(p_obj, report);
            break;
          default:
            /* unwanted report */
            ...
            SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV320X: unexpected report in Run: %i\r\n", report.messageID));
            break;
        }
        break;
      }
...
static sys_error_code_t LSM6DSV320XTaskExecuteStepDatalog(AManagedTask *_this)
{
  ...
  if (TX_SUCCESS == tx_queue_receive(&p_obj->in_queue, &report, TX_WAIT_FOREVER))
  {
    ...
    switch (report.messageID)
    {
      ...
      {
        SYS_DEBUGF(SYS_DBG_LEVEL_ALL, ("LSM6DSV320X: new data.\r\n"));
        res = LSM6DSV320XTaskSensorReadData(p_obj);
        if (!SYS_IS_ERROR_CODE(res))
        {
#if LSM6DSV320X_FIFO_ENABLED
...
#endif
            SYS_DEBUGF(SYS_DBG_LEVEL_ALL, ("LSM6DSV320X: ts = %f\r\n", (float_t)timestamp));
#if LSM6DSV320X_FIFO_ENABLED
          }
#endif
        }
...
//          {
//            if(TX_SUCCESS
//                != tx_timer_change(&p_obj->mlc_timer, AMT_MS_TO_TICKS(LSM6DSV320X_TASK_CFG_MLC_TIMER_PERIOD_MS),
//                                   AMT_MS_TO_TICKS(LSM6DSV320X_TASK_CFG_MLC_TIMER_PERIOD_MS)))
//            {
//              return SYS_UNDEFINED_ERROR_CODE;
//            }
//          }
        res = LSM6DSV320XTaskSensorReadMLC(p_obj);
        if (!SYS_IS_ERROR_CODE(res))
        {
          // notify the listeners...
          double_t timestamp = report.sensorDataReadyMessage.fTimestamp;
      ...
      case SM_MESSAGE_ID_SENSOR_CMD:
      {
        switch (report.sensorMessage.nCmdID)
        {
          case SENSOR_CMD_ID_INIT:
            res = LSM6DSV320XTaskSensorInit(p_obj);
            if (!SYS_IS_ERROR_CODE(res))
            {
              if (p_obj->acc_sensor_status.is_active == true || p_obj->gyro_sensor_status.is_active == true)
              {
                ...
                {
                  if (TX_SUCCESS
                      != tx_timer_change(&p_obj->read_timer, AMT_MS_TO_TICKS(p_obj->lsm6dsv320x_task_cfg_timer_period_ms),
                                         AMT_MS_TO_TICKS(p_obj->lsm6dsv320x_task_cfg_timer_period_ms)))
                  {
                    res = SYS_UNDEFINED_ERROR_CODE;
                  }
                  if (TX_SUCCESS != tx_timer_activate(&p_obj->read_timer))
                ...
                {
                  LSM6DSV320XTaskConfigureIrqPin(p_obj, FALSE);
                }
              }
            }
            if (!SYS_IS_ERROR_CODE(res))
            {
              if (p_obj->mlc_sensor_status.is_active == true)
              {
                ...
                {
                  LSM6DSV320XTaskConfigureMLCPin(p_obj, FALSE);
                }
              }
            }
            break;
          ...
          default:
            ...
            SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV320X: unexpected report in Datalog: %i\r\n", report.messageID));
            break;
        }
        break;
      }
        ...
        if (!SYS_IS_ERROR_CODE(res))
        {
          ...
          if (p_obj->fifo_level != 0)
          {
            ...
            if (true == SensorActive)
            {
              ...
              LSM6DSV320X_SensorSpeedSort(hg_acc_odr, acc_odr, gyro_odr, &FastSensor, &MediumSensor, &SlowSensor);
...
static sys_error_code_t LSM6DSV320XTaskSensorInit(LSM6DSV320XTask *_this)
{
  ...
  uint8_t reg0 = 0;
  lsm6dsv320x_hg_xl_data_rate_t lsm6dsv320x_hg_xl_data_rate = LSM6DSV320X_HG_XL_ODR_OFF;
  lsm6dsv320x_data_rate_t lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_OFF;
  lsm6dsv320x_fifo_xl_batch_t lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_NOT_BATCHED;
  lsm6dsv320x_data_rate_t lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_OFF;
  lsm6dsv320x_fifo_gy_batch_t lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_NOT_BATCHED;
  int32_t ret_val = 0;
  ...
  ret_val = lsm6dsv320x_reset_set(p_sensor_drv, LSM6DSV320X_RESTORE_CTRL_REGS);
  do
  {
    lsm6dsv320x_reset_get(p_sensor_drv, &rst);
  } while (rst != LSM6DSV320X_READY);

  /* Enable Block Data Update */
  ret_val = lsm6dsv320x_block_data_update_set(p_sensor_drv, PROPERTY_ENABLE);

  ret_val = lsm6dsv320x_device_id_get(p_sensor_drv, (uint8_t *) &reg0);
  if (!ret_val)
  {
    ABusIFSetWhoAmI(_this->p_sensor_bus_if, reg0);
  }
  SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("LSM6DSV320X: sensor - I am 0x%x.\r\n", reg0));

  /* HG ACC fs */
  if (_this->hg_acc_sensor_status.type.mems.fs < 33.0f)
  {
    lsm6dsv320x_hg_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_32g);
  }
  else if (_this->hg_acc_sensor_status.type.mems.fs < 65.0f)
  {
    lsm6dsv320x_hg_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_64g);
  }
  else if (_this->hg_acc_sensor_status.type.mems.fs < 129.0f)
  {
    lsm6dsv320x_hg_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_128g);
  }
  else if (_this->hg_acc_sensor_status.type.mems.fs < 257.0f)
  {
    lsm6dsv320x_hg_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_256g);
  }
  else
  {
    lsm6dsv320x_hg_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_320g);
  }

  /* AXL fs */
  if (_this->acc_sensor_status.type.mems.fs < 3.0f)
  {
    lsm6dsv320x_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_2g);
  }
  else if (_this->acc_sensor_status.type.mems.fs < 5.0f)
  {
    lsm6dsv320x_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_4g);
  }
  else if (_this->acc_sensor_status.type.mems.fs < 9.0f)
  {
    lsm6dsv320x_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_8g);
  }
  else
  {
    lsm6dsv320x_xl_full_scale_set(p_sensor_drv, LSM6DSV320X_16g);
  }

  /* GYRO fs */
  if (_this->gyro_sensor_status.type.mems.fs < 251.0f)
  {
    lsm6dsv320x_gy_full_scale_set(p_sensor_drv, LSM6DSV320X_250dps);
  }
  else if (_this->gyro_sensor_status.type.mems.fs < 501.0f)
  {
    lsm6dsv320x_gy_full_scale_set(p_sensor_drv, LSM6DSV320X_500dps);
  }
  else if (_this->gyro_sensor_status.type.mems.fs < 1001.0f)
  {
    lsm6dsv320x_gy_full_scale_set(p_sensor_drv, LSM6DSV320X_1000dps);
  }
  else if (_this->gyro_sensor_status.type.mems.fs < 2001.0f)
  {
    lsm6dsv320x_gy_full_scale_set(p_sensor_drv, LSM6DSV320X_2000dps);
  }
  else
    lsm6dsv320x_gy_full_scale_set(p_sensor_drv, LSM6DSV320X_4000dps);

  /* High g accel ODR */
  if (_this->hg_acc_sensor_status.type.mems.odr < 481.0f)
  {
    lsm6dsv320x_hg_xl_data_rate = LSM6DSV320X_HG_XL_ODR_AT_480Hz;
  }
  else if (_this->hg_acc_sensor_status.type.mems.odr < 961.0f)
  {
    lsm6dsv320x_hg_xl_data_rate = LSM6DSV320X_HG_XL_ODR_AT_960Hz;
  }
  else if (_this->hg_acc_sensor_status.type.mems.odr < 1921.0f)
  {
    lsm6dsv320x_hg_xl_data_rate = LSM6DSV320X_HG_XL_ODR_AT_1920Hz;
  }
  else if (_this->hg_acc_sensor_status.type.mems.odr < 3841.0f)
  {
    lsm6dsv320x_hg_xl_data_rate = LSM6DSV320X_HG_XL_ODR_AT_3840Hz;
  }
  else
  {
    lsm6dsv320x_hg_xl_data_rate = LSM6DSV320X_HG_XL_ODR_AT_7680Hz;
  }

  if (_this->acc_sensor_status.type.mems.odr < 2.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_1Hz875;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_1Hz875;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 8.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_7Hz5;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_7Hz5;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 16.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_15Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_15Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 31.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_30Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_30Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 61.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_60Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_60Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 121.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_120Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_120Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 241.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_240Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_240Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 481.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_480Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_480Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 961.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_960Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_960Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 1921.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_1920Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_1920Hz;
  }
  else if (_this->acc_sensor_status.type.mems.odr < 3841.0f)
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_3840Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_3840Hz;
  }
  else
  {
    lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_AT_7680Hz;
    lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_BATCHED_AT_7680Hz;
  }

  if (_this->gyro_sensor_status.type.mems.odr < 8.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_7Hz5;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_7Hz5;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 16.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_15Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_15Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 31.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_30Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_30Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 61.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_60Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_60Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 121.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_120Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_120Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 241.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_240Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_240Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 481.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_480Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_480Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 961.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_960Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_960Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 1921.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_1920Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_1920Hz;
  }
  else if (_this->gyro_sensor_status.type.mems.odr < 3841.0f)
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_3840Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_3840Hz;
  }
  else
  {
    lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_AT_7680Hz;
    lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_BATCHED_AT_7680Hz;
  }

  if (_this->hg_acc_sensor_status.is_active)
  {
    lsm6dsv320x_hg_xl_data_rate_set(p_sensor_drv, lsm6dsv320x_hg_xl_data_rate, 1);
    lsm6dsv320x_fifo_hg_xl_batch_set(p_sensor_drv, 1);
  }
  else
  {
    lsm6dsv320x_hg_xl_data_rate_set(p_sensor_drv, LSM6DSV320X_HG_XL_ODR_OFF, 0);
  ...
  {
    lsm6dsv320x_xl_data_rate_set(p_sensor_drv, lsm6dsv320x_xl_data_rate);
    lsm6dsv320x_fifo_xl_batch_set(p_sensor_drv, lsm6dsv320x_fifo_xl_batch);
  }
  else
  {
    lsm6dsv320x_xl_data_rate_set(p_sensor_drv, LSM6DSV320X_ODR_OFF);
  ...
  {
    lsm6dsv320x_gy_data_rate_set(p_sensor_drv, lsm6dsv320x_gy_data_rate);
    lsm6dsv320x_fifo_gy_batch_set(p_sensor_drv, lsm6dsv320x_fifo_gy_batch);
  }
  else
  {
    lsm6dsv320x_gy_data_rate_set(p_sensor_drv, LSM6DSV320X_ODR_OFF);
...
#if LSM6DSV320X_FIFO_ENABLED
  uint16_t lsm6dsv320x_wtm_level = 0;
  uint16_t lsm6dsv320x_wtm_level_hg_acc = 0;
  uint16_t lsm6dsv320x_wtm_level_acc = 0;
  uint16_t lsm6dsv320x_wtm_level_gyro = 0;
  ...
  if (_this->samples_per_it == 0)
  {
    ...
    if (_this->hg_acc_sensor_status.is_active)
    {
      lsm6dsv320x_wtm_level_hg_acc = ((uint16_t) _this->hg_acc_sensor_status.type.mems.odr * (uint16_t) LSM6DSV320X_MAX_DRDY_PERIOD);
    }
    if (_this->acc_sensor_status.is_active)
    {
      lsm6dsv320x_wtm_level_acc = ((uint16_t) _this->acc_sensor_status.type.mems.odr * (uint16_t) LSM6DSV320X_MAX_DRDY_PERIOD);
    }
    if (_this->gyro_sensor_status.is_active)
    {
      lsm6dsv320x_wtm_level_gyro = ((uint16_t) _this->gyro_sensor_status.type.mems.odr * (uint16_t) LSM6DSV320X_MAX_DRDY_PERIOD);
    }

    uint8_t WmMax = 0;
    uint8_t WmMid = 0;
    uint8_t WmMin = 0;
    LSM6DSV320X_SensorSpeedSort(lsm6dsv320x_wtm_level_hg_acc, lsm6dsv320x_wtm_level_acc, lsm6dsv320x_wtm_level_gyro, &WmMax,
                                &WmMid, &WmMin);

    switch (WmMax)
    {
      case 1:
        lsm6dsv320x_wtm_level = lsm6dsv320x_wtm_level_hg_acc;
        break;
      case 2:
        lsm6dsv320x_wtm_level = lsm6dsv320x_wtm_level_acc;
        break;
      case 3:
        lsm6dsv320x_wtm_level = lsm6dsv320x_wtm_level_gyro;
        break;
      default:
        res = SYS_INVALID_PARAMETER_ERROR_CODE;
        return res;
    ...
    if (lsm6dsv320x_wtm_level > LSM6DSV320X_MAX_WTM_LEVEL)
    {
  ...
  /* Setup wtm for FIFO */
  lsm6dsv320x_fifo_watermark_set(p_sensor_drv, _this->samples_per_it);
  ...
  lsm6dsv320x_pin_int1_route_set(p_sensor_drv, &int1_route);

  lsm6dsv320x_fifo_mode_set(p_sensor_drv, LSM6DSV320X_STREAM_MODE);

#else

  uint8_t buff[6];
  lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_OUTX_L_A, &buff[0], 6);
  lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_OUTX_L_A, &buff[0], 6);
  lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_OUTX_L_G, &buff[0], 6);
...
#endif /* LSM6DSV320X_FIFO_ENABLED */

  /* Check configuration from UCF */
  lsm6dsv320x_mem_bank_set(p_sensor_drv, LSM6DSV320X_EMBED_FUNC_MEM_BANK);
  lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_MLC_INT1, &mlc_int1, 1);
  lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_MLC_INT2, &mlc_int2, 1);

  /* MLC must be handled in polling due to HW limitations: disable MLC INT */
  mlc_int1 = 0;
  mlc_int2 = 0;
  lsm6dsv320x_write_reg(p_sensor_drv, LSM6DSV320X_MLC_INT1, &mlc_int1, 1);
  lsm6dsv320x_write_reg(p_sensor_drv, LSM6DSV320X_MLC_INT2, &mlc_int2, 1);
  lsm6dsv320x_mem_bank_set(p_sensor_drv, LSM6DSV320X_MAIN_MEM_BANK);

  if (_this->mlc_enable == false)
  {
    lsm6dsv320x_mlc_set(p_sensor_drv, LSM6DSV320X_MLC_OFF);
  }
  else
  {
    SMMessage report;
  ...
  lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_FIFO_STATUS1, reg, 2);

  _this->fifo_level = ((reg[1] & 0x03) << 8) + reg[0];

  if (_this->fifo_level >= _this->samples_per_it)
  {
    lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_FIFO_DATA_OUT_TAG, _this->p_fast_sensor_data_buff,
                         _this->samples_per_it * 7);
  }
#endif

  float_t min_odr = 0;
  min_odr = LSM6DSV320X_FindMin(_this->hg_acc_sensor_status.type.mems.odr, _this->acc_sensor_status.type.mems.odr, _this->gyro_sensor_status.type.mems.odr);

  _this->lsm6dsv320x_task_cfg_timer_period_ms = (uint16_t)(min_odr);
#if LSM6DSV320X_FIFO_ENABLED
  _this->lsm6dsv320x_task_cfg_timer_period_ms = (uint16_t)((1000.0f / _this->lsm6dsv320x_task_cfg_timer_period_ms) * (((float_t)(_this->samples_per_it)) / 2.0f));
#else
  _this->lsm6dsv320x_task_cfg_timer_period_ms = (uint16_t)(1000.0f / _this->lsm6dsv320x_task_cfg_timer_period_ms);
#endif
...
static sys_error_code_t LSM6DSV320XTaskSensorReadData(LSM6DSV320XTask *_this)
{
  ...
  {
    lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_FIFO_DATA_OUT_TAG, _this->p_fast_sensor_data_buff, samples_per_it * 7);
    ...
    for (i = 0; i < samples_per_it; i++)
    {
      ...
      if ((_this->p_fast_sensor_data_buff[i * 7] >> 3) == LSM6DSV320X_TAG_HG_ACC)
      {
        *p16++ = dummyDataCounter_hg_acc++;
        *p16++ = dummyDataCounter_hg_acc++;
        *p16++ = dummyDataCounter_hg_acc++;
      }
      else if ((_this->p_fast_sensor_data_buff[i * 7] >> 3) == LSM6DSV320X_TAG_ACC)
      {
...
#endif
    {
      ...
      LSM6DSV320X_SensorSpeedSort(hg_acc_odr, acc_odr, gyro_odr, &fast_sensor, &medium_sensor, &slow_sensor);
      /* Assign fast buffer */
      switch (fast_sensor)
      {
        case 1:
      ...
      for (i = 0; i < samples_per_it; i++)
      {
        if (((*p_tag) >> 3) == LSM6DSV320X_TAG_HG_ACC)
        {
        ...
        else if (((*p_tag) >> 3) == LSM6DSV320X_TAG_ACC)
        {
          p16_src = (int16_t *)(p_tag + 1);
          *p_acc++ = *p16_src++;
          *p_acc++ = *p16_src++;
...
#else
  {
    lsm6dsv320x_status_reg_t val = {0};
    /* Read which sensor generated the INT */
    lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_STATUS_REG, (uint8_t *) &val, 1);
    /* hg_xl data available? */
    if (val.xlhgda == 1U)
    {
      lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_UI_OUTZ_L_A_OIS_HG, _this->p_hg_acc_sample, 6);
#if (HSD_USE_DUMMY_DATA == 1)
    ...
    if (val.xlda == 1U)
    {
      lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_OUTX_L_A, _this->p_acc_sample, 6);
#if (HSD_USE_DUMMY_DATA == 1)
    ...
    if (val.gda == 1U)
    {
      lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_OUTX_L_G, _this->p_gyro_sample, 6);
#if (HSD_USE_DUMMY_DATA == 1)
...
static sys_error_code_t LSM6DSV320XTaskSensorReadMLC(LSM6DSV320XTask *_this)
{
  ...
  {
    lsm6dsv320x_mem_bank_set(p_sensor_drv, LSM6DSV320X_EMBED_FUNC_MEM_BANK);
    lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_MLC_STATUS, (uint8_t *)(&mlc_status), 1);
    _this->p_mlc_sensor_data_buff[4] = (mlc_status.is_mlc1) | (mlc_status.is_mlc2 << 1) | (mlc_status.is_mlc3 << 2) | (mlc_status.is_mlc4 << 3);

    lsm6dsv320x_read_reg(p_sensor_drv, LSM6DSV320X_MLC1_SRC, (uint8_t *)(&mlc_output[0]), 4);
...
static sys_error_code_t LSM6DSV320XTaskSensorRegister(LSM6DSV320XTask *_this)
{
  ...
  ISensor_t *hg_acc_if = (ISensor_t *) LSM6DSV320XTaskGetHgAccSensorIF(_this);
  ISensor_t *acc_if = (ISensor_t *) LSM6DSV320XTaskGetAccSensorIF(_this);
  ISensor_t *gyro_if = (ISensor_t *) LSM6DSV320XTaskGetGyroSensorIF(_this);
  ISensor_t *mlc_if = (ISensor_t *) LSM6DSV320XTaskGetMlcSensorIF(_this);
...
static sys_error_code_t LSM6DSV320XTaskSensorInitTaskParams(LSM6DSV320XTask *_this)
{
  ...
  _this->hg_acc_sensor_status.type.mems.fs = 320.0f;
...
static sys_error_code_t LSM6DSV320XTaskSensorSetODR(LSM6DSV320XTask *_this, SMMessage report)
{
  ...
  else if (id == _this->mlc_id)
  {
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV320X: warning - MLC SetODR() not supported.\r\n"));
  }
  else
  {
    res = SYS_INVALID_PARAMETER_ERROR_CODE;
...
static sys_error_code_t LSM6DSV320XTaskSensorSetFS(LSM6DSV320XTask *_this, SMMessage report)
{
  ...
  else if (id == _this->mlc_id)
  {
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV320X: warning - MLC SetFS() not supported.\r\n"));
  }
  else
  {
    res = SYS_INVALID_PARAMETER_ERROR_CODE;
...
static sys_error_code_t LSM6DSV320XTaskSensorSetFifoWM(LSM6DSV320XTask *_this, SMMessage report)
{
  ...
  if (report.sensorMessage.nSensorId == _this->mlc_id)
  {
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_ALL, ("LSM6DSV320X: warning - MLC SetFifoWM() not supported.\r\n"));
  }

#if LSM6DSV320X_FIFO_ENABLED

  stmdev_ctx_t *p_sensor_drv = (stmdev_ctx_t *) &_this->p_sensor_bus_if->m_xConnector;
  uint16_t lsm6dsv320x_wtm_level = (uint16_t)report.sensorMessage.nParam;
  uint8_t id = report.sensorMessage.nSensorId;
  ...
  if ((id == _this->acc_id) || (id == _this->gyro_id) || (id == _this->hg_acc_id))
  {
    ...
    lsm6dsv320x_wtm_level = lsm6dsv320x_wtm_level + _this->samples_per_it;
...
static sys_error_code_t LSM6DSV320XTaskEnterLowPowerMode(const LSM6DSV320XTask *_this)
{
  ...
  lsm6dsv320x_hg_xl_data_rate_t lsm6dsv320x_hg_xl_data_rate = LSM6DSV320X_HG_XL_ODR_OFF;
  uint8_t lsm6dsv320x_fifo_hg_xl_batch = 0;
  lsm6dsv320x_data_rate_t lsm6dsv320x_xl_data_rate = LSM6DSV320X_ODR_OFF;
  lsm6dsv320x_fifo_xl_batch_t lsm6dsv320x_fifo_xl_batch = LSM6DSV320X_XL_NOT_BATCHED;
  lsm6dsv320x_data_rate_t lsm6dsv320x_gy_data_rate = LSM6DSV320X_ODR_OFF;
  lsm6dsv320x_fifo_gy_batch_t lsm6dsv320x_fifo_gy_batch = LSM6DSV320X_GY_NOT_BATCHED;

  lsm6dsv320x_hg_xl_data_rate_set(p_sensor_drv, lsm6dsv320x_hg_xl_data_rate, 0);
  lsm6dsv320x_fifo_hg_xl_batch_set(p_sensor_drv, lsm6dsv320x_fifo_hg_xl_batch);
  lsm6dsv320x_xl_data_rate_set(p_sensor_drv, lsm6dsv320x_xl_data_rate);
  lsm6dsv320x_fifo_xl_batch_set(p_sensor_drv, lsm6dsv320x_fifo_xl_batch);
  lsm6dsv320x_gy_data_rate_set(p_sensor_drv, lsm6dsv320x_gy_data_rate);
  lsm6dsv320x_fifo_gy_batch_set(p_sensor_drv, lsm6dsv320x_fifo_gy_batch);
...
static inline LSM6DSV320XTask *LSM6DSV320XTaskGetOwnerFromISensorIF(ISensor_t *p_if)
{
  ...
  LSM6DSV320XTask *p_if_owner = NULL;

  /* check if the virtual function has been called from the mlc sensor IF  */
  p_if_owner = (LSM6DSV320XTask *)((uint32_t) p_if - offsetof(LSM6DSV320XTask, mlc_sensor_if));
      ...
      || !(p_if_owner->super.vptr == &sTheClass.vtbl))
  {
    ...
    p_if_owner = (LSM6DSV320XTask *)((uint32_t) p_if - offsetof(LSM6DSV320XTask, gyro_sensor_if));
  }
  if (!(p_if_owner->acc_sensor_if.vptr == &sTheClass.acc_sensor_if_vtbl) || !(p_if_owner->super.vptr == &sTheClass.vtbl))
  {
    ...
    p_if_owner = (LSM6DSV320XTask *)((uint32_t) p_if - offsetof(LSM6DSV320XTask, acc_sensor_if));
  }
      ...
      || !(p_if_owner->super.vptr == &sTheClass.vtbl))
  {
    ...
    p_if_owner = (LSM6DSV320XTask *)((uint32_t) p_if - offsetof(LSM6DSV320XTask, hg_acc_sensor_if));
  }
  return p_if_owner;
}
...
static inline LSM6DSV320XTask *LSM6DSV320XTaskGetOwnerFromISensorLLIF(ISensorLL_t *p_if)
{
  assert_param(p_if != NULL);
  LSM6DSV320XTask *p_if_owner = NULL;
  p_if_owner = (LSM6DSV320XTask *)((uint32_t) p_if - offsetof(LSM6DSV320XTask, sensor_ll_if));
...
static void LSM6DSV320XTaskTimerCallbackFunction(ULONG param)
{
  LSM6DSV320XTask *p_obj = (LSM6DSV320XTask *) param;
  SMMessage report;
...
void LSM6DSV320XTask_EXTI_Callback(uint16_t nPin)
{
  MTMapValue_t *p_val;
  TX_QUEUE *p_queue;
  SMMessage report;
  ...
  if (p_val != NULL)
  {
    p_queue = &((LSM6DSV320XTask *)p_val->p_mtask_obj)->in_queue;
...
void INT2_DSV320X_EXTI_Callback(uint16_t nPin)
{
  MTMapValue_t *p_val;
  TX_QUEUE *p_queue;
  SMMessage report;
...
static sys_error_code_t LSM6DSV320X_ODR_Sync(LSM6DSV320XTask *_this)
{
  ...
  float_t odr = 0.0f;
  lsm6dsv320x_hg_xl_data_rate_t lsm6dsv320x_odr_hg_xl;
  uint8_t lsm6dsv320x_hg_xl_reg_out_en;
  if (lsm6dsv320x_hg_xl_data_rate_get(p_sensor_drv, &lsm6dsv320x_odr_hg_xl, &lsm6dsv320x_hg_xl_reg_out_en) == 0)
  {
    _this->hg_acc_sensor_status.is_active = TRUE;

    /* Update only the model */
    switch (lsm6dsv320x_odr_hg_xl)
    {
  ...
  odr = 0;
  lsm6dsv320x_data_rate_t lsm6dsv320x_odr_xl;
  if (lsm6dsv320x_xl_data_rate_get(p_sensor_drv, &lsm6dsv320x_odr_xl) == 0)
  {
    _this->acc_sensor_status.is_active = TRUE;

    /* Update only the model */
    switch (lsm6dsv320x_odr_xl)
    {
  ...
  odr = 0;
  lsm6dsv320x_data_rate_t lsm6dsv320x_odr_g;
  if (lsm6dsv320x_gy_data_rate_get(p_sensor_drv, &lsm6dsv320x_odr_g) == 0)
  {
    _this->gyro_sensor_status.is_active = TRUE;

    /* Update only the model */
    switch (lsm6dsv320x_odr_g)
    {
      case LSM6DSV320X_ODR_OFF:
        _this->gyro_sensor_status.is_active = FALSE;
        /* Do not update the model in case of odr = 0 */
...
static sys_error_code_t LSM6DSV320X_FS_Sync(LSM6DSV320XTask *_this)
{
  ...
  float_t fs = 32.0;
  lsm6dsv320x_hg_xl_full_scale_t fs_hg_xl;
  if (lsm6dsv320x_hg_xl_full_scale_get(p_sensor_drv, &fs_hg_xl) == 0)
  {
    switch (fs_hg_xl)
    {
  ...
  fs = 2.0;
  lsm6dsv320x_xl_full_scale_t fs_xl;
  if (lsm6dsv320x_xl_full_scale_get(p_sensor_drv, &fs_xl) == 0)
  {
    switch (fs_xl)
    {
      case LSM6DSV320X_2g:
  ...
  fs = 125;
  lsm6dsv320x_gy_full_scale_t fs_g;
  if (lsm6dsv320x_gy_full_scale_get(p_sensor_drv, &fs_g) == 0)
  {
    switch (fs_g)
    {
...
static float_t LSM6DSV320X_FindMax(float_t Val1,
                                   float_t Val2,
                                   float_t Val3)
{
  float_t Max = Val1;
...
/* Return Min of 3 non negative floats */
static float_t LSM6DSV320X_FindMin(float_t Val1,
                                   float_t Val2,
                                   float_t Val3)
{
  float_t Min = 0;
...
static sys_error_code_t LSM6DSV320X_SensorSpeedSort(float_t ODR1,
                                                    float_t ODR2,
                                                    float_t ODR3,
                                                    uint8_t *FastSensor,
