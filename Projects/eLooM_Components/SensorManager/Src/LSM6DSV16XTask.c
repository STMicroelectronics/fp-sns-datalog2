...
#define LSM6DSV16X_TASK_CFG_PRIORITY                 (TX_MAX_PRIORITIES - 1)
#endif
...
#endif
#ifndef LSM6DSV16X_TASK_CFG_MLC_TIMER_PERIOD_MS
#define LSM6DSV16X_TASK_CFG_MLC_TIMER_PERIOD_MS      200
#endif

#define LSM6DSV16X_TAG_ACC                           (0x02)

#ifndef LSM6DSV16X_TASK_CFG_MAX_INSTANCES_COUNT
#define LSM6DSV16X_TASK_CFG_MAX_INSTANCES_COUNT      1
#endif

#define SYS_DEBUGF(level, message)                   SYS_DEBUGF3(SYS_DBG_LSM6DSV16X, level, message)

#ifndef LSM6DSV16X_TASK_CFG_I2C_ADDRESS
#define LSM6DSV16X_TASK_CFG_I2C_ADDRESS              LSM6DSV16X_I2C_ADD_H
#endif
...
typedef struct _LSM6DSV16XTaskClass
{
  ...
  /**
    ...
    */
  MTMapElement_t task_map_elements[2 * LSM6DSV16X_TASK_CFG_MAX_INSTANCES_COUNT];
...
/**
  ...
  */
static void LSM6DSV16XTaskTimerCallbackFunction(ULONG param);
...
/**
  ...
  * @param param [IN] specifies an application defined parameter.
  */
static void LSM6DSV16XTaskMLCTimerCallbackFunction(ULONG param);
...
/**
  * The class object.
  */
static LSM6DSV16XTaskClass_t sTheClass =
{
  /* class virtual table */
  {
...
{
  LSM6DSV16XTask *p_new_obj = SysAlloc(sizeof(LSM6DSV16XTask));
...
AManagedTaskEx *LSM6DSV16XTaskAllocSetName(const void *pIRQConfig, const void *pMLCConfig, const void *pCSConfig,
                                           const char *p_name)
{
  LSM6DSV16XTask *p_new_obj = (LSM6DSV16XTask *) LSM6DSV16XTaskAlloc(pIRQConfig, pMLCConfig, pCSConfig);
...
{
  LSM6DSV16XTask *p_obj = (LSM6DSV16XTask *) p_mem_block;
...
{
  LSM6DSV16XTask *p_obj = (LSM6DSV16XTask *) LSM6DSV16XTaskStaticAlloc(p_mem_block, pIRQConfig, pMLCConfig, pCSConfig);
                                                 ...
                                                 ULONG *pParams)
{
  ...
  if (TX_SUCCESS != tx_queue_create(&p_obj->in_queue, "LSM6DSV16X_Q", item_size / 4u, p_queue_items_buff,
  ...
  if (TX_SUCCESS
      != tx_timer_create(&p_obj->read_timer, "LSM6DSV16X_T", LSM6DSV16XTaskTimerCallbackFunction, (ULONG)_this,
  ...
  if (TX_SUCCESS
      != tx_timer_create(&p_obj->mlc_timer, "LSM6DSV16X_MLC_T", LSM6DSV16XTaskMLCTimerCallbackFunction, (ULONG)_this,
  ...
  {
    p_obj->p_sensor_bus_if = I2CBusIFAlloc(LSM6DSV16X_ID, LSM6DSV16X_TASK_CFG_I2C_ADDRESS, 0);
    if (p_obj->p_sensor_bus_if == NULL)
    {
      res = SYS_TASK_HEAP_OUT_OF_MEMORY_ERROR_CODE;
      SYS_SET_SERVICE_LEVEL_ERROR_CODE(res);
  ...
  {
    (void) MTMap_Init(&sTheClass.task_map, sTheClass.task_map_elements, 2 * LSM6DSV16X_TASK_CFG_MAX_INSTANCES_COUNT);
  }
                                                     ...
                                                     const EPowerMode NewPowerMode)
{
  ...
  else if (NewPowerMode == E_POWER_MODE_SLEEP_1)
  {
    ...
    if (SYS_IS_ERROR_CODE(res))
    {
      SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV16X - Enter Low Power Mode failed.\r\n"));
    }
    if (p_obj->pIRQConfig != NULL)
    {
      LSM6DSV16XTaskConfigureIrqPin(p_obj, TRUE);
...
sys_error_code_t LSM6DSV16XTask_vtblHandleError(AManagedTask *_this, SysEvent xError)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  //  LSM6DSV16XTask *p_obj = (LSM6DSV16XTask*)_this;
...
sys_error_code_t LSM6DSV16XTask_vtblAccGetODR(ISensorMems_t *_this, float_t *p_measured, float_t *p_nominal)
{
  assert_param(_this != NULL);
...
float_t LSM6DSV16XTask_vtblAccGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV16XTask *p_if_owner = (LSM6DSV16XTask *)((uint32_t) _this - offsetof(LSM6DSV16XTask, acc_sensor_if));
...
float_t LSM6DSV16XTask_vtblAccGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV16XTask *p_if_owner = (LSM6DSV16XTask *)((uint32_t) _this - offsetof(LSM6DSV16XTask, acc_sensor_if));
...
sys_error_code_t LSM6DSV16XTask_vtblGyroGetODR(ISensorMems_t *_this, float_t *p_measured, float_t *p_nominal)
{
  assert_param(_this != NULL);
  /*get the object implementing the ISourceObservable IF */
  LSM6DSV16XTask *p_if_owner = (LSM6DSV16XTask *)((uint32_t) _this - offsetof(LSM6DSV16XTask, gyro_sensor_if));
...
float_t LSM6DSV16XTask_vtblGyroGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV16XTask *p_if_owner = (LSM6DSV16XTask *)((uint32_t) _this - offsetof(LSM6DSV16XTask, gyro_sensor_if));
...
float_t LSM6DSV16XTask_vtblGyroGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
  LSM6DSV16XTask *p_if_owner = (LSM6DSV16XTask *)((uint32_t) _this - offsetof(LSM6DSV16XTask, gyro_sensor_if));
...
sys_error_code_t LSM6DSV16XTask_vtblMlcGetODR(ISensorMems_t *_this, float_t *p_measured, float_t *p_nominal)
{
  assert_param(_this != NULL);
  /*get the object implementing the ISourceObservable IF */
  LSM6DSV16XTask *p_if_owner = (LSM6DSV16XTask *)((uint32_t) _this - offsetof(LSM6DSV16XTask, mlc_sensor_if));
...
float_t LSM6DSV16XTask_vtblMlcGetFS(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
...
float_t LSM6DSV16XTask_vtblMlcGetSensitivity(ISensorMems_t *_this)
{
  assert_param(_this != NULL);
...
sys_error_code_t LSM6DSV16XTask_vtblSensorSetODR(ISensorMems_t *_this, float_t odr)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV16XTask *p_if_owner = LSM6DSV16XTaskGetOwnerFromISensorIF((ISensor_t *)_this);
...
sys_error_code_t LSM6DSV16XTask_vtblSensorSetFS(ISensorMems_t *_this, float_t fs)
{
  assert_param(_this != NULL);
  sys_error_code_t res = SYS_NO_ERROR_CODE;
  LSM6DSV16XTask *p_if_owner = LSM6DSV16XTaskGetOwnerFromISensorIF((ISensor_t *)_this);
...
static sys_error_code_t LSM6DSV16XTaskSensorInit(LSM6DSV16XTask *_this)
{
  ...
  if (_this->samples_per_it == 0)
  {
    ...
    lsm6dsv16x_wtm_level_acc = ((uint16_t) _this->acc_sensor_status.type.mems.odr * (uint16_t) LSM6DSV16X_MAX_DRDY_PERIOD);
    lsm6dsv16x_wtm_level_gyro = ((uint16_t) _this->gyro_sensor_status.type.mems.odr * (uint16_t) LSM6DSV16X_MAX_DRDY_PERIOD);
...
#if LSM6DSV16X_FIFO_ENABLED
  _this->lsm6dsv16x_task_cfg_timer_period_ms = (uint16_t)((1000.0f / _this->lsm6dsv16x_task_cfg_timer_period_ms) * (((float_t)(_this->samples_per_it)) / 2.0f));
#else
  ...
  {
    _this->first_data_ready_threshold = 27;
  }
  else
  {
...
static sys_error_code_t LSM6DSV16XTaskSensorReadData(LSM6DSV16XTask *_this)
{
  ...
  {
    res = lsm6dsv16x_read_reg(p_sensor_drv, LSM6DSV16X_FIFO_DATA_OUT_TAG, _this->p_fast_sensor_data_buff, samples_per_it * 7);
  ...
  if ((_this->acc_sensor_status.is_active) && (_this->gyro_sensor_status.is_active))
  {
    ...
    if (val.xlda == 1U)
    {
      res = lsm6dsv16x_read_reg(p_sensor_drv, LSM6DSV16X_OUTX_L_A, _this->p_acc_sample, 6);
    ...
    if (val.gda == 1U)
    {
      res = lsm6dsv16x_read_reg(p_sensor_drv, LSM6DSV16X_OUTX_L_G, _this->p_gyro_sample, 6);
  ...
  {
    res = lsm6dsv16x_read_reg(p_sensor_drv, LSM6DSV16X_OUTX_L_A, _this->p_acc_sample, samples_per_it * 6);
  ...
  {
    res = lsm6dsv16x_read_reg(p_sensor_drv, LSM6DSV16X_OUTX_L_G, _this->p_gyro_sample, samples_per_it * 6);
...
static sys_error_code_t LSM6DSV16XTaskSensorSetODR(LSM6DSV16XTask *_this, SMMessage report)
{
  ...
  else if (id == _this->mlc_id)
  {
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV16X: warning - MLC SetODR() not supported.\r\n"));
  }
  else
  {
    res = SYS_INVALID_PARAMETER_ERROR_CODE;
...
static sys_error_code_t LSM6DSV16XTaskSensorSetFS(LSM6DSV16XTask *_this, SMMessage report)
{
  ...
  else if (id == _this->mlc_id)
  {
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_WARNING, ("LSM6DSV16X: warning - MLC SetFS() not supported.\r\n"));
  }
  else
  {
    res = SYS_INVALID_PARAMETER_ERROR_CODE;
...
static sys_error_code_t LSM6DSV16XTaskSensorSetFifoWM(LSM6DSV16XTask *_this, SMMessage report)
{
  ...
  stmdev_ctx_t *p_sensor_drv = (stmdev_ctx_t *) &_this->p_sensor_bus_if->m_xConnector;
  uint16_t lsm6dsv16x_wtm_level = (uint16_t)report.sensorMessage.nParam;
  uint8_t id = report.sensorMessage.nSensorId;
...
static void LSM6DSV16XTaskTimerCallbackFunction(ULONG param)
{
  LSM6DSV16XTask *p_obj = (LSM6DSV16XTask *) param;
  SMMessage report;
...
void LSM6DSV16XTask_EXTI_Callback(uint16_t nPin)
{
  ...
  if (p_val != NULL)
  {
    p_queue = &((LSM6DSV16XTask *)p_val->p_mtask_obj)->in_queue;
...
void INT2_DSV16X_EXTI_Callback(uint16_t nPin)
{
  MTMapValue_t *p_val;
  TX_QUEUE *p_queue;
  SMMessage report;
