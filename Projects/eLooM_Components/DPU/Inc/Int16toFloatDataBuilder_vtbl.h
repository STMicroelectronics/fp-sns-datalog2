...
sys_error_code_t Int16ToFloatDB_vtblOnReset(IDataBuilder_t *_this,
...
sys_error_code_t Int16ToFloatDB_vtblOnNewInData(IDataBuilder_t *_this, EMData_t *p_target_data,
                                                const EMData_t *p_new_in_data, IDB_BuildStrategy_e build_strategy,
                                                DataBuffAllocator_f data_buff_alloc);  ///< @sa IDataBuilder_OnNewInData
