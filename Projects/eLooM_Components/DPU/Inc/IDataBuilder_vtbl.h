...
struct _IDataBuilder_vtbl_t
{
  ...
  sys_error_code_t (*OnNewInData)(IDataBuilder_t *_this, EMData_t *p_target_data, const EMData_t *p_new_in_data,
...
static inline
sys_error_code_t IDataBuilder_OnNewInData(IDataBuilder_t *_this, EMData_t *p_target_data, const EMData_t *p_new_in_data,
                                          IDB_BuildStrategy_e build_strategy, DataBuffAllocator_f data_buff_alloc)
{
