...
/**
  ...
  */
static inline sys_error_code_t IDPU2_AttachToDataSource(IDPU2_t *_this, ISourceObservable *p_data_source,
...
/**
  ...
  * @return SYS_NO_ERROR_CODE if success, an error code otherwise.
  */
static inline sys_error_code_t IDPU2_DetachFromDataSource(IDPU2_t *_this, ISourceObservable *p_data_source,
...
/**
  ...
  * @return SYS_NO_ERROR_CODE if success, an error code otherwise.
  */
static inline sys_error_code_t IDPU2_AttachToDPU(IDPU2_t *_this, IDPU2_t *p_next_dpu, IDataBuilder_t *p_builder,
...
/**
  ...
  * or NULL if out of memory error occurs.
  */
static inline sys_error_code_t IDPU2_RegisterNotifyCallback(IDPU2_t *_this, DPU2_ReadyToProcessCallback_t callback,
                                                            void *p_param);
