                                           ...
                                           uint8_t pretty)
{
  ...
  int32_t temp_i = 0;
  ism330dhcx_gyro_get_fs(&temp_i);
  enum_id = 0;
  if (temp_i == ism330dhcx_gyro_fs_dps125)
  {
    enum_id = 0;
  }
  else if (temp_i == ism330dhcx_gyro_fs_dps250)
  {
    enum_id = 1;
  }
  else if (temp_i == ism330dhcx_gyro_fs_dps500)
  {
    enum_id = 2;
  }
  else if (temp_i == ism330dhcx_gyro_fs_dps1000)
  {
    enum_id = 3;
  }
  else if (temp_i == ism330dhcx_gyro_fs_dps2000)
  {
    enum_id = 4;
  }
  else if (temp_i == ism330dhcx_gyro_fs_dps4000)
  {
    enum_id = 5;
  }
                                             ...
                                             uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "ism330dhcx_gyro.sensor_annotation"))
  {
    ...
    if (ret == 0)
    {
      json_object_dotset_string(respJSONObject, "ism330dhcx_gyro.sensor_annotation.value", sensor_annotation);
    }
    else
    {
      json_object_dotset_string(respJSONObject, "ism330dhcx_gyro.sensor_annotation.value", "PNPL_SET_ERROR");
    }
  }
  json_value_free(tempJSON);
  if (pretty == 1)
