/**
  ******************************************************************************
  * @file    App_model_Lps22hh_Temp.c
  * @author  SRA
  * @brief   Lps22hh_Temp PnPL Components APIs
  ******************************************************************************
  * @attention
  *
...
uint8_t lps22hh_temp_comp_init(void)
{
  ...
  lps22hh_temp_set_st_ble_stream__id(id, NULL);

  lps22hh_temp_model.sensor_status = SMSensorGetStatusPointer(id);
  ...
  lps22hh_temp_set_st_ble_stream__temp_format("float_t", NULL);

  addSensorToAppModel(id, &lps22hh_temp_model);

  lps22hh_temp_set_sensor_annotation("\0", NULL);
  lps22hh_temp_set_odr(pnpl_lps22hh_temp_odr_hz200, NULL);
...
uint8_t lps22hh_temp_get_odr(pnpl_lps22hh_temp_odr_t *enum_id)
{
  float_t odr = lps22hh_temp_model.sensor_status->type.mems.odr;
  if (odr < 2.0f)
  {
    *enum_id = pnpl_lps22hh_temp_odr_hz1;
  }
  else if (odr < 11.0f)
  {
    *enum_id = pnpl_lps22hh_temp_odr_hz10;
  }
  else if (odr < 26.0f)
  {
    *enum_id = pnpl_lps22hh_temp_odr_hz25;
  }
  else if (odr < 51.0f)
  {
    *enum_id = pnpl_lps22hh_temp_odr_hz50;
  }
  else if (odr < 76.0f)
  {
    *enum_id = pnpl_lps22hh_temp_odr_hz75;
  }
  else if (odr < 101.0f)
  {
    *enum_id = pnpl_lps22hh_temp_odr_hz100;
  }
  else
  {
    *enum_id = pnpl_lps22hh_temp_odr_hz200;
  }
  return PNPL_NO_ERROR_CODE;
}

uint8_t lps22hh_temp_get_fs(pnpl_lps22hh_temp_fs_t *enum_id)
{
  float_t fs = lps22hh_temp_model.sensor_status->type.mems.fs;
  if (fs > 1259.0f && fs < 1261.0f)
  {
    *enum_id = pnpl_lps22hh_temp_fs_hpa1260;
  }
  else
  {
    return 1;
...
uint8_t lps22hh_temp_get_ioffset(float_t *value)
{
...
uint8_t lps22hh_temp_get_measodr(float_t *value)
{
...
uint8_t lps22hh_temp_get_sensitivity(float_t *value)
{
...
uint8_t lps22hh_temp_get_st_ble_stream__id(int32_t *value)
{
  /* USER Code */
  *value = lps22hh_temp_model.st_ble_stream.st_ble_stream_id;
  return PNPL_NO_ERROR_CODE;
}
...
uint8_t lps22hh_temp_get_st_ble_stream__temp_multiply_factor(float_t *value)
{
  /* USER Code */
...
uint8_t lps22hh_temp_set_odr(pnpl_lps22hh_temp_odr_t enum_id, char **response_message)
{
  ...
  switch (enum_id)
  {
    case pnpl_lps22hh_temp_odr_hz1:
      value = 1.0f;
      break;
    case pnpl_lps22hh_temp_odr_hz10:
      value = 10.0f;
      break;
    case pnpl_lps22hh_temp_odr_hz25:
      value = 25.0f;
      break;
    case pnpl_lps22hh_temp_odr_hz50:
      value = 50.0f;
      break;
    case pnpl_lps22hh_temp_odr_hz75:
      value = 75.0f;
      break;
    case pnpl_lps22hh_temp_odr_hz100:
      value = 100.0f;
      break;
    case pnpl_lps22hh_temp_odr_hz200:
      value = 200.0f;
      break;
    default:
      return 1;
  }
  ret = SMSensorSetODR(lps22hh_temp_model.id, value);
...
uint8_t lps22hh_temp_set_enable(bool value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lps22hh_temp_set_samples_per_ts(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lps22hh_temp_set_sensor_annotation(const char *value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
...
uint8_t lps22hh_temp_set_st_ble_stream__id(int32_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22hh_temp_model.st_ble_stream.st_ble_stream_id = value;
  return ret;
}
...
uint8_t lps22hh_temp_set_st_ble_stream__temp_enable(bool value, char **response_message)
{
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22hh_temp_model.st_ble_stream.st_ble_stream_objects.status = value;
  return ret;
}
...
uint8_t lps22hh_temp_set_st_ble_stream__temp_unit(const char *value, char **response_message)
{
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  strcpy(lps22hh_temp_model.st_ble_stream.st_ble_stream_objects.unit, value);
  return ret;
}
...
uint8_t lps22hh_temp_set_st_ble_stream__temp_format(const char *value, char **response_message)
{
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  strcpy(lps22hh_temp_model.st_ble_stream.st_ble_stream_objects.format, value);
  return ret;
}
...
uint8_t lps22hh_temp_set_st_ble_stream__temp_elements(int32_t value, char **response_message)
{
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22hh_temp_model.st_ble_stream.st_ble_stream_objects.elements = value;
  return ret;
}
...
uint8_t lps22hh_temp_set_st_ble_stream__temp_channels(int32_t value, char **response_message)
{
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22hh_temp_model.st_ble_stream.st_ble_stream_objects.channel = value;
  return ret;
}

uint8_t lps22hh_temp_set_st_ble_stream__temp_multiply_factor(float_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
  ...
  uint8_t ret = PNPL_NO_ERROR_CODE;
  lps22hh_temp_model.st_ble_stream.st_ble_stream_objects.multiply_factor = value;
  return ret;
}
