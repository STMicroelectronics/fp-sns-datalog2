...
uint8_t lps22hh_press_comp_init(void)
{
  ...
  lps22hh_press_set_st_ble_stream__press_unit("hPa", NULL);
  lps22hh_press_set_st_ble_stream__press_format("float_t", NULL);
  ...
  lps22hh_press_set_st_ble_stream__press_channels(value, NULL);
  float_t sensitivity = 0.0f;
  lps22hh_press_get_sensitivity(&sensitivity);
  lps22hh_press_set_st_ble_stream__press_multiply_factor(sensitivity, NULL);
...
{
  float_t odr = lps22hh_press_model.sensor_status->type.mems.odr;
  if (odr < 2.0f)
  {
...
{
  float_t fs = lps22hh_press_model.sensor_status->type.mems.fs;
...
uint8_t lps22hh_press_get_ioffset(float_t *value)
{
...
uint8_t lps22hh_press_get_measodr(float_t *value)
{
...
uint8_t lps22hh_press_get_sensitivity(float_t *value)
{
...
uint8_t lps22hh_press_get_st_ble_stream__press_multiply_factor(float_t *value)
{
  /* USER Code */
...
uint8_t lps22hh_press_set_st_ble_stream__press_multiply_factor(float_t value, char **response_message)
{
  if (response_message != NULL)
  {
    *response_message = "";
