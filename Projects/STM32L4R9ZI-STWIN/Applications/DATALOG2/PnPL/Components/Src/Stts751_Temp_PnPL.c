                                          ...
                                          uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream"))
  {
    ...
    {
      bool st_ble_stream__temp__enable = json_object_dotget_boolean(tempJSONObject, "stts751_temp.st_ble_stream.temp.enable");
      ret = stts751_temp_set_st_ble_stream__temp__enable(st_ble_stream__temp__enable, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts751_temp_get_st_ble_stream__temp__enable(&old_st_ble_stream__temp__enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream.temp.unit"))
    {
      ...
      ret = stts751_temp_set_st_ble_stream__temp__unit(st_ble_stream__temp__unit, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts751_temp_get_st_ble_stream__temp__unit(&old_st_ble_stream__temp__unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream.temp.format"))
    {
      ...
      ret = stts751_temp_set_st_ble_stream__temp__format(st_ble_stream__temp__format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts751_temp_get_st_ble_stream__temp__format(&old_st_ble_stream__temp__format);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream.temp.elements"))
    {
      ...
      ret = stts751_temp_set_st_ble_stream__temp__elements(st_ble_stream__temp__elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts751_temp_get_st_ble_stream__temp__elements(&old_st_ble_stream__temp__elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream.temp.channels"))
    {
      ...
      ret = stts751_temp_set_st_ble_stream__temp__channels(st_ble_stream__temp__channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts751_temp_get_st_ble_stream__temp__channels(&old_st_ble_stream__temp__channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream.temp.multiply_factor"))
    {
      ...
      ret = stts751_temp_set_st_ble_stream__temp__multiply_factor(st_ble_stream__temp__multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts751_temp_get_st_ble_stream__temp__multiply_factor(&old_st_ble_stream__temp__multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "stts751_temp.st_ble_stream.temp.odr"))
    {
      ...
      ret = stts751_temp_set_st_ble_stream__temp__odr(st_ble_stream__temp__odr, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        stts751_temp_get_st_ble_stream__temp__odr(&old_st_ble_stream__temp__odr);
