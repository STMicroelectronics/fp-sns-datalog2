                                        ...
                                        uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream.acc.enable"))
    {
      ...
      else
      {
        ...
        iis2dh_acc_get_st_ble_stream__acc_enable(&old_st_ble_stream__acc_enable);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream.acc.unit"))
    {
      ...
      else
      {
        ...
        iis2dh_acc_get_st_ble_stream__acc_unit(&old_st_ble_stream__acc_unit);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream.acc.format"))
    {
      ...
      valid_property = true;
      ret = iis2dh_acc_set_st_ble_stream__acc_format(st_ble_stream__acc_format, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dh_acc_get_st_ble_stream__acc_format(&old_st_ble_stream__acc_format);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream.acc.elements"))
    {
      ...
      valid_property = true;
      ret = iis2dh_acc_set_st_ble_stream__acc_elements(st_ble_stream__acc_elements, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dh_acc_get_st_ble_stream__acc_elements(&old_st_ble_stream__acc_elements);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream.acc.channels"))
    {
      ...
      valid_property = true;
      ret = iis2dh_acc_set_st_ble_stream__acc_channels(st_ble_stream__acc_channels, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dh_acc_get_st_ble_stream__acc_channels(&old_st_ble_stream__acc_channels);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream.acc.multiply_factor"))
    {
      ...
      valid_property = true;
      ret = iis2dh_acc_set_st_ble_stream__acc_multiply_factor(st_ble_stream__acc_multiply_factor, &resp_msg);
      json_object_dotset_string(respJSONObject, "PnPL_Response.message", resp_msg);
      if (ret == PNPL_NO_ERROR_CODE)
      {
      ...
      else
      {
        ...
        iis2dh_acc_get_st_ble_stream__acc_multiply_factor(&old_st_ble_stream__acc_multiply_factor);
  ...
  if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "iis2dh_acc.st_ble_stream.acc.odr"))
    {
      ...
      else
      {
        ...
        iis2dh_acc_get_st_ble_stream__acc_odr(&old_st_ble_stream__acc_odr);
  ...
  else
  {
    ...
    char *log_message = "Invalid property for iis2dh_acc";
