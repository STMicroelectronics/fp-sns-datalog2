...
#ifndef _PNPL_STTS751_TEMP_H_
#define _PNPL_STTS751_TEMP_H_

typedef enum
{
  pnpl_stts751_temp_odr_hz1 = 0,
  pnpl_stts751_temp_odr_hz2 = 1,
  pnpl_stts751_temp_odr_hz4 = 2,
  pnpl_stts751_temp_odr_hz8 = 3,
} pnpl_stts751_temp_odr_t;
typedef enum
{
  pnpl_stts751_temp_fs_cdeg100 = 0,
} pnpl_stts751_temp_fs_t;
...
/**
  * Create a type name for _Stts751_Temp_PnPL.
 */
typedef struct _Stts751_Temp_PnPL Stts751_Temp_PnPL;

/* Public API declaration ----------------------------------------------------*/

IPnPLComponent_t *Stts751_Temp_PnPLAlloc(void);
 ...
 */
IPnPLComponent_t *Stts751_Temp_PnPLGetComponentIF(Stts751_Temp_PnPL *_this);

#ifdef __cplusplus
}
#endif

#endif /* _PNPL_STTS751_TEMP_H_ */
