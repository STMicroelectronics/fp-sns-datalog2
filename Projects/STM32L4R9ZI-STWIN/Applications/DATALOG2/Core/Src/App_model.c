...
uint8_t iis2dh_acc_get_odr(int32_t *value)
{
  ...
  iis2dh_acc_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)iis2dh_acc_model.sensor_status.type.mems.odr;
  /* USER Code */
  return 0;
}
uint8_t iis2dh_acc_get_fs(int32_t *value)
{
  uint16_t id = iis2dh_acc_model.id;
  iis2dh_acc_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)iis2dh_acc_model.sensor_status.type.mems.fs;
  /* USER Code */
  return 0;
}
...
uint8_t stts751_temp_get_odr(int32_t *value)
{
  ...
  stts751_temp_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)stts751_temp_model.sensor_status.type.mems.odr;
  /* USER Code */
  return 0;
}
uint8_t stts751_temp_get_fs(int32_t *value)
{
  uint16_t id = stts751_temp_model.id;
  stts751_temp_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)stts751_temp_model.sensor_status.type.mems.fs;
  /* USER Code */
  return 0;
}
...
uint8_t lps22hh_press_get_odr(int32_t *value)
{
  ...
  lps22hh_press_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)lps22hh_press_model.sensor_status.type.mems.odr;
  /* USER Code */
  return 0;
}
uint8_t lps22hh_press_get_fs(int32_t *value)
{
  uint16_t id = lps22hh_press_model.id;
  lps22hh_press_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)lps22hh_press_model.sensor_status.type.mems.fs;
  /* USER Code */
  return 0;
}
...
uint8_t lps22hh_temp_get_odr(int32_t *value)
{
  ...
  lps22hh_temp_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)lps22hh_temp_model.sensor_status.type.mems.odr;
  /* USER Code */
  return 0;
}
uint8_t lps22hh_temp_get_fs(int32_t *value)
{
  uint16_t id = lps22hh_temp_model.id;
  lps22hh_temp_model.sensor_status = SMSensorGetStatus(id);
  *value = (int32_t)lps22hh_temp_model.sensor_status.type.mems.fs;
  /* USER Code */
  return 0;
}
      ...
      if (app_model.s_models[i] != NULL)
      {
        if (app_model.s_models[i]->sensor_status.is_active == true)
        {
          ...
          if (app_model.log_controller_model.interface == LOG_CTRL_MODE_SD)
          {
            ...
            app_model.s_models[i]->stream_params.sd_dps = (uint32_t)(app_model.s_models[i]->stream_params.bandwidth * 0.31f);
