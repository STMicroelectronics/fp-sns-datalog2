...
/**
  ...
  * dtmi:vespucci:nucleo_h7a3zi_q:x_nucleo_iks02a1:fpSnsDatalog2_datalog2;1
  *
...
{
  *value = iis2dlpc_acc_model.streamParams.sd_dps;
  return 0;
}
...
uint8_t acquisition_info_comp_init(void)
{
  ...
  acquisition_info_set_name("NUCLEO-H7A3ZI-Q_acquisition");
...
uint8_t firmware_info_comp_init(void)
{
  ...
  char default_alias[DEVICE_ALIAS_LENGTH] = "NUCLEO-H7A3ZI-Q";
...
{
  *value = "NUCLEO-H7A3ZI-Q";
  return 0;
}
uint8_t firmware_info_get_device_url(char **value)
{
  *value = "https://www.st.com/en/evaluation-tools/nucleo-h7a3zi-q.html";
  return 0;
}
