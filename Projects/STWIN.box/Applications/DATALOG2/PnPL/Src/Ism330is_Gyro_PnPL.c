...
uint8_t Ism330is_Gyro_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size, uint8_t pretty)
{
  ...
  else if(temp_f == dps250)
  {
    enum_id = 1;
  }
  else if(temp_f == dps500)
  {
    enum_id = 2;
  }
  else if(temp_f == dps1000)
  {
    enum_id = 3;
  }
  else if(temp_f == dps2000)
  {
    enum_id = 4;
  }
...
uint8_t Ism330is_Gyro_PnPL_vtblSetProperty(IPnPLComponent_t *_this, char *serializedJSON)
{
  ...
  if(json_object_dothas_value(tempJSONObject, "ism330is_gyro.odr"))
  {
    ...
    {
    case 0:
      ism330is_gyro_set_odr(hz12_5);
      break;
    case 1:
      ism330is_gyro_set_odr(hz26);
      break;
    case 2:
      ism330is_gyro_set_odr(hz52);
      break;
    case 3:
      ism330is_gyro_set_odr(hz104);
      break;
    case 4:
      ism330is_gyro_set_odr(hz208);
      break;
    case 5:
      ism330is_gyro_set_odr(hz416);
      break;
    case 6:
      ism330is_gyro_set_odr(hz833);
      break;
    case 7:
      ism330is_gyro_set_odr(hz1667);
      break;
    case 8:
      ism330is_gyro_set_odr(hz3333);
      break;
    case 9:
      ism330is_gyro_set_odr(hz6667);
      break;
    }
  }
  if(json_object_dothas_value(tempJSONObject, "ism330is_gyro.fs"))
  {
    ...
    {
    case 0:
      ism330is_gyro_set_fs(dps125);
      break;
    case 1:
      ism330is_gyro_set_fs(dps250);
      break;
    case 2:
      ism330is_gyro_set_fs(dps500);
      break;
    case 3:
      ism330is_gyro_set_fs(dps1000);
      break;
    case 4:
      ism330is_gyro_set_fs(dps2000);
      break;
    }
  }
