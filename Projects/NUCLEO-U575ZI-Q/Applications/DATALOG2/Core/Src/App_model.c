...
/**
  ...
  * dtmi:vespucci:nucleo_u575zi_q:x_nucleo_iks02a1:fpSnsDatalog2_datalog2;1
  *
...
uint8_t acquisition_info_comp_init(void)
{
  ...
  acquisition_info_set_name("NUCLEO-U575ZI-Q_acquisition");
...
uint8_t firmware_info_comp_init(void)
{
  ...
  char default_alias[DEVICE_ALIAS_LENGTH] = "NUCLEO-U575ZI-Q";
...
{
  *value = "https://www.st.com/en/evaluation-tools/nucleo-u575zi-q.html";
  return 0;
}
