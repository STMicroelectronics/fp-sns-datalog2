...
/**
  ...
  * dtmi:vespucci:nucleo_u575zi_q:x_nucleo_iks02a1:fpSnsDatalog2_datalog2:sensors:ism330dhcx_acc;1
  *
...
uint8_t ism330dhcx_acc_comp_init(void)
{
  ...
  ism330dhcx_acc_set_odr(pnpl_ism330dhcx_acc_odr_hz833, NULL);
