...
/**
  ...
  * dtmi:vespucci:nucleo_u575zi_q:x_nucleo_iks4a1:FP_SNS_DATALOG2_Datalog2:sensors:lps22df_press;1
  *
...
uint8_t lps22df_press_comp_init(void)
{
  ...
  lps22df_press_set_odr(pnpl_lps22df_press_odr_hz100, NULL);
  lps22df_press_set_enable(true, NULL);
#if (HSD_USE_DUMMY_DATA == 1)
  lps22df_press_set_samples_per_ts(0, NULL);
#else
  lps22df_press_set_samples_per_ts(100, NULL);
#endif
