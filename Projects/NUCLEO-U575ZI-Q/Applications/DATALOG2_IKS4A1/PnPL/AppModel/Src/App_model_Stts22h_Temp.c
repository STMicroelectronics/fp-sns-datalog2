...
/**
  ...
  * dtmi:vespucci:nucleo_u575zi_q:x_nucleo_iks4a1:FP_SNS_DATALOG2_Datalog2:sensors:stts22h_temp;1
  *
...
uint8_t stts22h_temp_comp_init(void)
{
  ...
  stts22h_temp_set_odr(pnpl_stts22h_temp_odr_hz100, NULL);
  stts22h_temp_set_enable(true, NULL);
#if (HSD_USE_DUMMY_DATA == 1)
  stts22h_temp_set_samples_per_ts(0, NULL);
#else
  stts22h_temp_set_samples_per_ts(100, NULL);
#endif
