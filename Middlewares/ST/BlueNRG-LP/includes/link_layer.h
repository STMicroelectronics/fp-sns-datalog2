...
/** Accept only advertising and scan response PDUs from devices where
  * the address of the advertiser address is in the White List. Directed advertising PDUs
...
/** Accept all advertising and scan response PDUs except directed advertising
  * PDUs where the identity of the initiator identity address does not address this
  * device.
  *
  * Note: Directed advertising PDUs where the identity of the initiator is a
...
/** Accept all advertising and scan response PDUs except:
  * @liadvertising and scan response PDUs where the identity of the initiator
  * address is not in the White List; and
  * @li directed advertising PDUs where the identity of the initiator address does
