...
/* Supported but optional (i.e. a Legacy Pairing may be accepted) */
#define SC_IS_SUPPORTED     (0x01)
/* Supported but mandatory (i.e. do not accept Legacy Pairing but only Secure Connections v.4.2 Pairing) */
#define SC_IS_MANDATORY     (0x02)
