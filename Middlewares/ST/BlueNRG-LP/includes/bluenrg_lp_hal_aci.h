...
/**
  ...
  *        supported_max_tx_octets, supported_max_tx_time, supported_max_rx_octets,
  *        supported_max_rx_time, in little-endian order.         (default
  *        251,2120,251,2120).
  *        Values:
...
/**
  ...
  *        Values:
  *        - 0x0001 ... 0xFFFF
  * @param notifications_write_cmds
  *        Values:
  *        - 0x00: Notifications
  *        - 0x01: Write Commands
  * @retval Value indicating success or error code.
