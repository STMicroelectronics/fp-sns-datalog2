...
#ifndef _BLUENRG_LP_EVENTS_H_
#define _BLUENRG_LP_EVENTS_H_
...
/**
  ...
  *
  * @param      connection_handle  Connection handle for which the command is given. Range:
  ...
  * @return  Error code
  */
ble_status_t hci_rx_acl_data_event(uint16_t connection_handle, uint8_t  pb_flag, uint8_t  bc_flag,
                                   uint16_t  data_length, uint8_t  *pdu_data);
/**
  * @}
  */
/**
...
typedef struct extended_advertising_report_t_s
{
  ...
  /** data_length[i] octets of advertising or scan response data formatted as defined
    ...
    */
  uint8_t *data;
} extended_advertising_report_t;
/** Documentation for C struct samples_t */
typedef struct samples_t_s
{
...
/**
  ...
  *        - 0x01: CRC was incorrect and the Length and CTETime fields of the packet were used
  *                to determine sampling points
  *        - 0x02: CRC was incorrect but the Controller has determined the position and length
  *                of the Constant Tone Extension in some other way
