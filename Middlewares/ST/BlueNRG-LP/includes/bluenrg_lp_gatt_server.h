...
#define GATT_FLUSHABLE_NOTIFICATION                (0x01)
...
/** The application will be notified when a write request, a write cmd
...
/** The application will be notified when a read request of any type is received for this attribute. **/
