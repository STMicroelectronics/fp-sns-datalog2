...
ble_status_t hci_authenticated_payload_timeout_expired_event_process(uint8_t *buffer_in);
...
ble_status_t aci_hal_le_test_end_event_process(uint8_t *buffer_in);
...
ble_status_t aci_l2cap_cfc_connection_event_process(uint8_t *buffer_in);
ble_status_t aci_l2cap_disconnection_complete_event_process(uint8_t *buffer_in);
ble_status_t aci_l2cap_flow_control_credit_event_process(uint8_t *buffer_in);
ble_status_t aci_l2cap_sdu_data_tx_nwk_event_process(uint8_t *buffer_in);
ble_status_t aci_l2cap_sdu_data_rx_nwk_event_process(uint8_t *buffer_in);
ble_status_t aci_l2cap_command_reject_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_srv_attribute_modified_event_process(uint8_t *buffer_in);
...
ble_status_t aci_att_clt_find_info_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_find_by_type_value_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_read_by_type_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_read_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_read_blob_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_read_multiple_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_read_by_group_type_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_prepare_write_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_att_clt_exec_write_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_clt_indication_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_clt_notification_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_clt_proc_complete_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_clt_error_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_clt_disc_read_char_by_uuid_resp_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_tx_pool_available_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_srv_confirmation_event_process(uint8_t *buffer_in);
ble_status_t aci_att_srv_exec_write_req_event_process(uint8_t *buffer_in);
ble_status_t aci_gatt_srv_authorize_nwk_event_process(uint8_t *buffer_in);
...
ble_status_t hci_le_phy_update_complete_event_process(uint8_t *buffer_in);
ble_status_t hci_le_extended_advertising_report_event_process(uint8_t *buffer_in);
ble_status_t hci_le_periodic_advertising_sync_established_event_process(uint8_t *buffer_in);
ble_status_t hci_le_periodic_advertising_report_event_process(uint8_t *buffer_in);
ble_status_t hci_le_periodic_advertising_sync_lost_event_process(uint8_t *buffer_in);
ble_status_t hci_le_scan_timeout_event_process(uint8_t *buffer_in);
ble_status_t hci_le_advertising_set_terminated_event_process(uint8_t *buffer_in);
ble_status_t hci_le_scan_request_received_event_process(uint8_t *buffer_in);
ble_status_t hci_le_channel_selection_algorithm_event_process(uint8_t *buffer_in);
ble_status_t hci_le_connectionless_iq_report_event_process(uint8_t *buffer_in);
ble_status_t hci_le_connection_iq_report_event_process(uint8_t *buffer_in);
ble_status_t hci_le_cte_request_failed_event_process(uint8_t *buffer_in);
ble_status_t hci_le_periodic_advertising_sync_transfer_received_event_process(uint8_t *buffer_in);
ble_status_t hci_le_path_loss_threshold_event_process(uint8_t *buffer_in);
ble_status_t hci_le_transmit_power_reporting_event_process(uint8_t *buffer_in);
const hci_events_table_type_t hci_events_table[8] =
{
  ...
  {0x0057, hci_authenticated_payload_timeout_expired_event_process}
};
const hci_le_meta_events_table_type_t hci_le_meta_events_table[25] =
{
  ...
  {0x000d, hci_le_extended_advertising_report_event_process},
  /* hci_le_periodic_advertising_sync_established_event */
  {0x000e, hci_le_periodic_advertising_sync_established_event_process},
  /* hci_le_periodic_advertising_report_event */
  {0x000f, hci_le_periodic_advertising_report_event_process},
  /* hci_le_periodic_advertising_sync_lost_event */
  {0x0010, hci_le_periodic_advertising_sync_lost_event_process},
  /* hci_le_scan_timeout_event */
  {0x0011, hci_le_scan_timeout_event_process},
  /* hci_le_advertising_set_terminated_event */
  {0x0012, hci_le_advertising_set_terminated_event_process},
  /* hci_le_scan_request_received_event */
  {0x0013, hci_le_scan_request_received_event_process},
  /* hci_le_channel_selection_algorithm_event */
  {0x0014, hci_le_channel_selection_algorithm_event_process},
  /* hci_le_connectionless_iq_report_event */
  {0x0015, hci_le_connectionless_iq_report_event_process},
  /* hci_le_connection_iq_report_event */
  {0x0016, hci_le_connection_iq_report_event_process},
  /* hci_le_cte_request_failed_event */
  {0x0017, hci_le_cte_request_failed_event_process},
  /* hci_le_periodic_advertising_sync_transfer_received_event */
  {0x0018, hci_le_periodic_advertising_sync_transfer_received_event_process},
  /* hci_le_path_loss_threshold_event */
  {0x0020, hci_le_path_loss_threshold_event_process},
  /* hci_le_transmit_power_reporting_event */
  {0x0021, hci_le_transmit_power_reporting_event_process}
};
const hci_vendor_specific_events_table_type_t hci_vendor_specific_events_table[46] =
{
  ...
  {0x0007, aci_hal_le_test_end_event_process},
  ...
  {0x0803, aci_l2cap_cfc_connection_event_process},
  /* aci_l2cap_disconnection_complete_event */
  {0x0804, aci_l2cap_disconnection_complete_event_process},
  /* aci_l2cap_flow_control_credit_event */
  {0x0805, aci_l2cap_flow_control_credit_event_process},
  /* aci_l2cap_sdu_data_tx_nwk_event */
  {0x0806, aci_l2cap_sdu_data_tx_nwk_event_process},
  /* aci_l2cap_sdu_data_rx_nwk_event */
  {0x0807, aci_l2cap_sdu_data_rx_nwk_event_process},
  /* aci_l2cap_command_reject_event */
  {0x080a, aci_l2cap_command_reject_event_process},
  /* aci_gatt_srv_attribute_modified_event */
  {0x0c01, aci_gatt_srv_attribute_modified_event_process},
  ...
  {0x0c04, aci_att_clt_find_info_resp_event_process},
  /* aci_att_clt_find_by_type_value_resp_event */
  {0x0c05, aci_att_clt_find_by_type_value_resp_event_process},
  /* aci_att_clt_read_by_type_resp_event */
  {0x0c06, aci_att_clt_read_by_type_resp_event_process},
  /* aci_att_clt_read_resp_event */
  {0x0c07, aci_att_clt_read_resp_event_process},
  /* aci_att_clt_read_blob_resp_event */
  {0x0c08, aci_att_clt_read_blob_resp_event_process},
  /* aci_att_clt_read_multiple_resp_event */
  {0x0c09, aci_att_clt_read_multiple_resp_event_process},
  /* aci_att_clt_read_by_group_type_resp_event */
  {0x0c0a, aci_att_clt_read_by_group_type_resp_event_process},
  /* aci_att_clt_prepare_write_resp_event */
  {0x0c0c, aci_att_clt_prepare_write_resp_event_process},
  /* aci_att_clt_exec_write_resp_event */
  {0x0c0d, aci_att_clt_exec_write_resp_event_process},
  /* aci_gatt_clt_indication_event */
  {0x0c0e, aci_gatt_clt_indication_event_process},
  /* aci_gatt_clt_notification_event */
  {0x0c0f, aci_gatt_clt_notification_event_process},
  /* aci_gatt_clt_proc_complete_event */
  {0x0c10, aci_gatt_clt_proc_complete_event_process},
  /* aci_gatt_clt_error_resp_event */
  {0x0c11, aci_gatt_clt_error_resp_event_process},
  /* aci_gatt_clt_disc_read_char_by_uuid_resp_event */
  {0x0c12, aci_gatt_clt_disc_read_char_by_uuid_resp_event_process},
  /* aci_gatt_tx_pool_available_event */
  {0x0c16, aci_gatt_tx_pool_available_event_process},
  /* aci_gatt_srv_confirmation_event */
  {0x0c17, aci_gatt_srv_confirmation_event_process},
  /* aci_att_srv_exec_write_req_event */
  {0x0c1c, aci_att_srv_exec_write_req_event_process},
  /* aci_gatt_srv_authorize_nwk_event */
  {0x0c1d, aci_gatt_srv_authorize_nwk_event_process}
};
/* hci_disconnection_complete_event */
/* Event len: 1 + 2 + 1 */
/**
...
ble_status_t hci_number_of_completed_packets_event_process(uint8_t *buffer_in)
{
  ...
  for (index = 0; index < rp0->number_of_handles; index++)
  {
    handle_packets_pair_entry[index].connection_handle = rp0->handle_packets_pair_entry[index].connection_handle;
    size += 2;
    handle_packets_pair_entry[index].hc_num_of_completed_packets =
      rp0->handle_packets_pair_entry[index].hc_num_of_completed_packets;
    size += 2;
  }
...
ble_status_t hci_authenticated_payload_timeout_expired_event_process(uint8_t *buffer_in)
{
  ble_status_t status = BLE_STATUS_SUCCESS;
  /* Input params */
  hci_authenticated_payload_timeout_expired_event_rp0 *rp0 =
    (hci_authenticated_payload_timeout_expired_event_rp0 *)buffer_in;
...
ble_status_t aci_att_clt_find_by_type_value_resp_event_process(uint8_t *buffer_in)
{
  ...
  uint8_t size = 3;
  uint32_t index;
  attribute_group_handle_pair_t attr_group_handle_pair[HCI_MAX_PAYLOAD_SIZE /
                                                       sizeof(attribute_group_handle_pair_t)];
  for (index = 0; index < rp0->num_of_handle_pair; index++)
  {
    attr_group_handle_pair[index].found_attribute_handle =
      rp0->attr_group_handle_pair[index].found_attribute_handle;
    size += 2;
    attr_group_handle_pair[index].group_end_handle = rp0->attr_group_handle_pair[index].group_end_handle;
    size += 2;
  }
  aci_att_clt_find_by_type_value_resp_event(rp0->connection_handle,
                                            rp0->num_of_handle_pair,
                                            attr_group_handle_pair);
...
/**
  ...
  *        (vol.3, Part G, ch. 3.3.1), index.e. it is composed by: Characteristic
...
ble_status_t aci_gatt_clt_disc_read_char_by_uuid_resp_event_process(uint8_t *buffer_in)
{
  ble_status_t status = BLE_STATUS_SUCCESS;
  /* Input params */
  aci_gatt_clt_disc_read_char_by_uuid_resp_event_rp0 *rp0 =
    (aci_gatt_clt_disc_read_char_by_uuid_resp_event_rp0 *)buffer_in;
...
/**
  ...
  *        (index.e. an attribute with a size greater than ATT_MTU -3) or more than
...
ble_status_t hci_le_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  for (index = 0; index < rp0->num_reports; index++)
  {
    advertising_report[index].event_type = rp0->advertising_report[index].event_type;
    size += 1;
    advertising_report[index].address_type = rp0->advertising_report[index].address_type;
    size += 1;
    BLUENRG_MEMCPY((void *) advertising_report[index].address,
                   (const void *) rp0->advertising_report[index].address,
                   6);
    size += 6;
    advertising_report[index].data_length = rp0->advertising_report[index].data_length;
    size += 1;
    advertising_report[index].data = rp0->advertising_report[index].data;
    size += rp0->advertising_report[index].data_length;
    advertising_report[index].rssi = (uint8_t)buffer_in[size];
    size += 1;
  }
...
ble_status_t hci_le_direct_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  for (index = 0; index < rp0->num_reports; index++)
  {
    direct_advertising_report[index].event_type = rp0->direct_advertising_report[index].event_type;
    size += 1;
    direct_advertising_report[index].address_type = rp0->direct_advertising_report[index].address_type;
    size += 1;
    BLUENRG_MEMCPY((void *) direct_advertising_report[index].address,
                   (const void *) rp0->direct_advertising_report[index].address,
                   6);
    size += 6;
    direct_advertising_report[index].direct_address_type = rp0->direct_advertising_report[index].direct_address_type;
    size += 1;
    BLUENRG_MEMCPY((void *) direct_advertising_report[index].direct_address,
                   (const void *) rp0->direct_advertising_report[index].direct_address, 6);
    size += 6;
    direct_advertising_report[index].rssi = rp0->direct_advertising_report[index].rssi;
    size += 1;
  }
...
ble_status_t hci_le_extended_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  uint8_t size = 1;
  uint32_t index;
  extended_advertising_report_t extended_adv_report[HCI_MAX_PAYLOAD_SIZE /
                                                    sizeof(extended_advertising_report_t)];
  for (index = 0; index < rp0->num_reports; index++)
  {
    extended_adv_report[index].event_type = rp0->extended_adv_report[index].event_type;
    size += 2;
    extended_adv_report[index].address_type = rp0->extended_adv_report[index].address_type;
    size += 1;
    BLUENRG_MEMCPY((void *) extended_adv_report[index].address,
                   (const void *) rp0->extended_adv_report[index].address, 6);
    size += 6;
    extended_adv_report[index].primary_phy = rp0->extended_adv_report[index].primary_phy;
    size += 1;
    extended_adv_report[index].secondary_phy = rp0->extended_adv_report[index].secondary_phy;
    size += 1;
    extended_adv_report[index].advertising_sid = rp0->extended_adv_report[index].advertising_sid;
    size += 1;
    extended_adv_report[index].tx_power = rp0->extended_adv_report[index].tx_power;
    size += 1;
    extended_adv_report[index].rssi = rp0->extended_adv_report[index].rssi;
    size += 1;
    extended_adv_report[index].periodic_advertising_interval =
      rp0->extended_adv_report[index].periodic_advertising_interval;
    size += 2;
    extended_adv_report[index].direct_address_type =
      rp0->extended_adv_report[index].direct_address_type;
    size += 1;
    BLUENRG_MEMCPY((void *) extended_adv_report[index].direct_address,
                   (const void *) rp0->extended_adv_report[index].direct_address, 6);
    size += 6;
    extended_adv_report[index].data_length = rp0->extended_adv_report[index].data_length;
    size += 1;
    extended_adv_report[index].data = rp0->extended_adv_report[index].data;
    size += rp0->extended_adv_report[index].data_length;
  }
...
ble_status_t hci_le_periodic_advertising_sync_established_event_process(uint8_t *buffer_in)
{
  ble_status_t status = BLE_STATUS_SUCCESS;
  /* Input params */
  hci_le_periodic_advertising_sync_established_event_rp0 *rp0 =
    (hci_le_periodic_advertising_sync_established_event_rp0 *)buffer_in;
  hci_le_periodic_advertising_sync_established_event(rp0->status,
                                                     rp0->sync_handle,
                                                     rp0->advertising_sid,
                                                     rp0->advertiser_address_type,
                                                     rp0->advertising_address,
                                                     rp0->advertiser_phy,
...
/**
  ...
  *        of i_sample[index] and q_sample[index] shall equal 0x80. The slot_durations
...
ble_status_t hci_le_connectionless_iq_report_event_process(uint8_t *buffer_in)
{
  ...
  for (index = 0; index < rp0->sample_count; index++)
  {
    Samples[index].i_sample = rp0->Samples[index].i_sample;
    size += 1;
    Samples[index].q_sample = rp0->Samples[index].q_sample;
    size += 1;
  }
...
ble_status_t hci_le_periodic_advertising_sync_transfer_received_event_process(uint8_t *buffer_in)
{
  ble_status_t status = BLE_STATUS_SUCCESS;
  /* Input params */
  hci_le_periodic_advertising_sync_transfer_received_event_rp0 *rp0 =
    (hci_le_periodic_advertising_sync_transfer_received_event_rp0 *)buffer_in;
