/**
  ...
  * @date    10 March 2022
  * @brief   Source file for external uC - BlueNRG-x in network coprocessor mode (Event callbacks)
...
const hci_events_table_type hci_events_table[8] = {
...
const hci_le_meta_events_table_type hci_le_meta_events_table[25] = {
...
const hci_vendor_specific_events_table_type hci_vendor_specific_events_table[46] = {
