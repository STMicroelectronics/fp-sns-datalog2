                                                        ...
                                                        Whitelist_Entry_t Whitelist_Entry[])
{
  ...
  /* var_len_data input */
  {
    for (int i = 0; i < Num_of_Whitelist_Entries; i++) {
      cp0->Whitelist_Entry[i].Peer_Address_Type = Whitelist_Entry[i].Peer_Address_Type;
      BLUENRG_memcpy((void *) &cp0->Whitelist_Entry[i].Peer_Address, (const void *) &Whitelist_Entry[i].Peer_Address, 6);
    }
                                      ...
                                      Whitelist_Entry_t Whitelist_Entry[])
{
  ...
  /* var_len_data input */
  {
    ...
    for (int i = 0; i < Num_of_Whitelist_Entries; i++) {
      ...
      BLUENRG_memcpy((void *) &cp1->Whitelist_Entry[i].Peer_Address, (const void *) &Whitelist_Entry[i].Peer_Address, 6);
    }
    index_input += Num_of_Whitelist_Entries*7;
  }
  BLUENRG_memset(&rq, 0, sizeof(rq));
                                                 ...
                                                 uint8_t Clear_Resolving_List)
{
  ...
  /* var_len_data input */
  {
    for (int i = 0; i < Num_of_Resolving_list_Entries; i++) {
      cp0->Whitelist_Identity_Entry[i].Peer_Identity_Address_Type = Whitelist_Identity_Entry[i].Peer_Identity_Address_Type;
      BLUENRG_memcpy((void *) &cp0->Whitelist_Identity_Entry[i].Peer_Identity_Address, (const void *) &Whitelist_Identity_Entry[i].Peer_Identity_Address, 6);
    }
