...
/**
  * @brief This event is generated in response to an Exchange MTU request (local or from the peer). See @ref aci_gatt_exchange_config.
...
void aci_blue_crash_info_event(uint8_t Crash_Type,
                               ...
                               uint8_t Debug_Data[]);
/**
  * @brief 'This event is generated when the device completes a radio activity and provide information when a new radio activity will be performed.
