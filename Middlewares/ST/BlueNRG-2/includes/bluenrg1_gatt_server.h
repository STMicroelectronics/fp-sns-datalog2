...
/* The application will be notified when a write request, a write cmd or a signed write cmd
   are received by the server for this attribute. An @ref EVT_BLUE_GATT_WRITE_PERMIT_REQ will be issued. */
#define GATT_NOTIFY_WRITE_REQ_AND_WAIT_FOR_APPL_RESP  (0x02)
/* The application will be notified when a read request of any type is
...
/**
  ...
  * @{
  */
typedef PACKED(struct) _charact_format
{
  uint8_t format;
  int8_t exp;
  uint16_t unit;
