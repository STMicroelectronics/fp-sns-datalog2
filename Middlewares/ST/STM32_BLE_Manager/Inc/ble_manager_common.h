...
#ifndef _UUID_BLE_MANAGER_COMMON_H_
#define _UUID_BLE_MANAGER_COMMON_H_
...
{\
  (uuid_struct[0 ] = uuid_0) ; (uuid_struct[1 ] = uuid_1) ; (uuid_struct[2 ] = uuid_2) ; \
  (uuid_struct[3 ] = uuid_3) ; (uuid_struct[4 ] = uuid_4) ; (uuid_struct[5 ] = uuid_5) ; \
  (uuid_struct[6 ] = uuid_6) ; (uuid_struct[7 ] = uuid_7) ; (uuid_struct[8 ] = uuid_8) ; \
  (uuid_struct[9 ] = uuid_9) ; (uuid_struct[10] = uuid_10); (uuid_struct[11] = uuid_11); \
  (uuid_struct[12] = uuid_12); (uuid_struct[13] = uuid_13); (uuid_struct[14] = uuid_14); \
...
#endif /* _UUID_BLE_MANAGER_COMMON_H_ */
