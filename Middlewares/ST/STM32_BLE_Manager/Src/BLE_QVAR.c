...
/* Private define ------------------------------------------------------------*/
#define COPY_QVAR_CHAR_UUID(uuid_struct)  COPY_UUID_128(uuid_struct,0x00,0x00,0x00,0x16,0x00,0x02,0x11,0xe1,0xac,0x36,0x00,0x02,0xa5,0xd5,0xc5,0x1b)
...
/* Private functions ---------------------------------------------------------*/
static void AttrMod_Request_QVAR(void *BleCharPointer,uint16_t attr_handle, uint16_t Offset, uint8_t data_length, uint8_t *att_data);
...
* @retval None
*/
static void AttrMod_Request_QVAR(void *VoidCharPointer,uint16_t attr_handle, uint16_t Offset, uint8_t data_length, uint8_t *att_data)
{
