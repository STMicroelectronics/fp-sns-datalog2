/**
  ...
  * @brief   Add Gesture Naviagtion service using vendor specific profiles.
  ******************************************************************************
  * @attention
  *
...
/* Private define ------------------------------------------------------------*/
#define COPY_GESTURE_NAVIGATION_CHAR_UUID(uuid_struct) COPY_UUID_128(uuid_struct,0x00,0x00,0x00,0x1F,0x00,0x02,0x11,0xe1,0xac,0x36,0x00,0x02,0xa5,0xd5,0xc5,0x1b)
...
/* Private functions ---------------------------------------------------------*/
static void AttrMod_Request_GestureNavigation(void *BleCharPointer,uint16_t attr_handle, uint16_t Offset, uint8_t data_length, uint8_t *att_data);
 ...
 */
tBleStatus BLE_GestureNavigationUpdate(BLE_GestureNavigation_t GestureNavigation,BLE_ButtonNavigation_t ButtonNavigation)
{  
  tBleStatus ret;
  uint8_t buff[2+1+1];
 ...
 * @retval None
 */
static void AttrMod_Request_GestureNavigation(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset, uint8_t data_length, uint8_t *att_data)
{
