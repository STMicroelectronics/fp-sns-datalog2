...
/* Private functions ---------------------------------------------------------*/
static void AttrMod_Request_MotionIntensity(void *BleCharPointer, uint16_t attr_handle, uint16_t Offset,
...
/**
  ...
  * @retval None
  */
static void AttrMod_Request_MotionIntensity(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset,
                                            uint8_t data_length, uint8_t *att_data)
{
