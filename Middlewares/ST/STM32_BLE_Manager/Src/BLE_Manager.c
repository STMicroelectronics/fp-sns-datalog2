...
/* BLE Stack */
BLE_StackTypeDef BLE_StackValue = {0};
...
/**
  ...
  * @retval None
  */
static void AttrMod_Request_Config(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset, uint8_t data_length,
                                   uint8_t *att_data)
{
...
/**
  ...
  * @retval None
  */
static void Write_Request_Config(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset, uint8_t data_length,
                                 uint8_t *att_data)
{
...
/**
  ...
  * @retval None
  */
static void AttrMod_Request_StdErr(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset, uint8_t data_length,
                                   uint8_t *att_data)
{
  if (att_data[0] == 01U)
  {
...
/**
  ...
  * @retval None
  */
static void AttrMod_Request_Term(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset, uint8_t data_length,
                                 uint8_t *att_data)
{
  if (att_data[0] == 01U)
  {
  ...
  if (CommandBufLen)
  {
    ...
    switch (CommandType)
    {
      case EXT_CONFIG_COM_READ_COMMAND:
      {
        ...
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_SET_DFU].CommandString);
        }
        if (CustomExtConfigPowerOffCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_SET_OFF].CommandString);
        }
        if (CustomExtConfigSetNameCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_SET_NAME].CommandString);
        }
        if (CustomExtConfigSetTimeCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_SET_TIME].CommandString);
        }
        if (CustomExtConfigSetDateCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_SET_DATE].CommandString);
        }
        if (CustomExtConfigSetWiFiCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_SET_WIFI].CommandString);
        }
        if (CustomExtConfigChangePinCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_CHANGE_PIN].CommandString);
        }
        if (CustomExtConfigClearDBCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_CLEAR_DB].CommandString);
        }
        if (CustomExtConfigReadBanksFwIdCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_READ_BANKS_FW_ID].CommandString);
        }
        if (CustomExtConfigBanksSwapCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_BANKS_SWAP].CommandString);
        }
        if (CustomExtConfigReadCertCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_READ_CERT].CommandString);
        }
        if (CustomExtConfigSetCertCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_SET_CERT].CommandString);
        }
        if (CustomExtConfigUidCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_READ_UID].CommandString);
        }
        if (CustomExtConfigInfoCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_READ_INFO].CommandString);
        }
        if (CustomExtConfigHelpCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_READ_HELP].CommandString);
        }
        if (CustomExtConfigPowerStatusCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_READ_POWER].CommandString);
        }
        if (CustomExtConfigVersionFwCommandCallback != NULL)
        {
          WritingPointer += sprintf((char *)LocalBufferToWrite + WritingPointer, "%s,",
                                    StandardExtConfigCommands[EXT_CONFIG_COM_READ_VER_FW].CommandString);
        }
...
BLE_CustomCommadResult_t *ParseCustomCommand(BLE_ExtCustomCommand_t *LocCustomCommands, uint8_t *hs_command_buffer)
{
  ...
  while ((ValidCustomCommand == 0U) && (LocLastCustomCommand != NULL))
  {
    ...
    if (strncmp(json_object_dotget_string(JSON_ParseHandler, "command"), LocLastCustomCommand->CommandName,
...
/**
  ...
  */
uint8_t GenericAddCustomCommand(BLE_ExtCustomCommand_t **LocCustomCommands,
                                BLE_ExtCustomCommand_t **LocLastCustomCommand,
                                char *CommandName, BLE_CustomCommandTypes_t CommandType, int32_t DefaultValue,
                                int32_t Min, int32_t Max, int32_t *ValidValuesInt,
                                char **ValidValuesString, char *ShortDesc,
...
/**
  ...
  * @retval None
  */
static void Write_Request_Term(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset, uint8_t data_length,
                               uint8_t *att_data)
{
...
static BLE_ExtConfigCommandType BLE_ExtConfig_ExtractCommandType(uint8_t *hs_command_buffer)
{
  ...
  if (json_object_dothas_value(JSON_ParseHandler, "command"))
  {
    ...
    {
      if (strncmp(json_object_dotget_string(JSON_ParseHandler, "command"),
                  StandardExtConfigCommands[SearchCommand].CommandString, strlen(json_object_dotget_string(JSON_ParseHandler,
                                                                                 "command"))) == 0)
      {
...
void updateAdvData()
{
  ...
  manuf_data[14] = BLE_StackValue.BoardId; /* BoardType */
  manuf_data[15] = 0x00U;
  manuf_data[16] = 0x00U;
  manuf_data[17] = 0x00U;
  manuf_data[18] = 0x00U;
...
void setConnectable(void)
{
  ...
  manuf_data[17] = BLE_StackValue.BoardId; /* BoardType*/
