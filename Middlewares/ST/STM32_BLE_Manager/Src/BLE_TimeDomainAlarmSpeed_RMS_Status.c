...
/* Private functions ---------------------------------------------------------*/
static void AttrMod_Request_TD_AlarmSpeed_RMS_Status(void *BleCharPointer,uint16_t attr_handle, uint16_t Offset, uint8_t data_length, uint8_t *att_data);
 ...
 */
tBleStatus BLE_TD_AlarmSpeed_RMS_StatusUpdate(sBLE_TD_AlarmSpeed_RMS_Status_t Alarm, BLE_TD_AlarmSpeed_RMS_StatusGenericValue_t SpeedRmsValue)
{
  tBleStatus ret;
 ...
 *         With this function it's possible to understand if Time Domain Alarm Speed RMS Status is subscribed or not to the one service
 ...
 * @retval None
 */
static void AttrMod_Request_TD_AlarmSpeed_RMS_Status(void *VoidCharPointer, uint16_t attr_handle, uint16_t Offset, uint8_t data_length, uint8_t *att_data)
{
