...
tBleStatus BLE_Neai1ClassClassificationUpdate(BLE_1CC_output_t output)
{
  ...
  uint8_t buff[/*Timestamp*/ 2 + /*For future use*/ 2 + /* Type Selector */ 1 + /*Phase*/ 1 + /* State*/ 1 + /* Is Outlier */ 1];
...
tBleStatus BLE_NeaiNClassClassificationUpdate(BLE_NCC_output_t output)
{
  ...
  uint8_t buff[/*Timestamp*/ 2 + /*For future use*/ 2 + /* Type Selector */ 1U + /*Phase*/ 1U + /* State*/ 1U + /*Most Probable Class*/ 1U + /*Classes Probability*/ + CLASS_NUMBER_NCC ];
