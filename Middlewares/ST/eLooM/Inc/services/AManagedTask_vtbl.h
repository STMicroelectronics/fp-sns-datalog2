...
sys_error_code_t AMTOnCreateTask(AManagedTask *_this, tx_entry_function_t *pvTaskCode, CHAR **pcName,
                                 ...
                                 ULONG *pnParams)
{
  return _this->vptr->OnCreateTask(_this, pvTaskCode, pcName, pvStackStart, pnStackSize, pnPriority, pnPreemptThreshold,
                                   pnTimeSlice, pnAutoStart, pnParams);
}

SYS_DEFINE_STATIC_INLINE
sys_error_code_t AMTDoEnterPowerMode(AManagedTask *_this, const EPowerMode eActivePowerMode,
