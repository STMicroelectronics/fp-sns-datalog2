...
def main():
    ...
    mainWindow.setAppTitle("AI Toolkit SW")
    mainWindow.setAppCredits("AI Toolkit SW")
    mainWindow.setWindowTitle("AI Toolkit SW")
    mainWindow.setAppVersion("v0.0.1")
    mainWindow.setAIClassifierImages(["Stationary", "Walking", "Jogging", "Biking", "Unknown"])
