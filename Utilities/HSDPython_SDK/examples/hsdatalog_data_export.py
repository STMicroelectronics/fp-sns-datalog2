...
- Export data in different formats (TXT, CSV, TSV, PARQUET).
...
from st_hsdatalog.HSD_utils.exceptions import DataCorruptedException, MissingDeviceModelError, MissingTagsException, MissingISPUOutputDescriptorException
...
@click.option('-f', '--file_format', help="Exported file format", type=click.Choice(['TXT', 'CSV', 'TSV', 'PARQUET'], case_sensitive=False))
