...
if [ -z $1 ]
then
	python3 -m pip install st_hsdatalog/dist/noGUI/st_hsdatalog-3.4.0-py3-none-any.whl
else
	python3 -m pip install st_hsdatalog/dist/noGUI/st_hsdatalog-3.4.0-py3-none-any.whl --proxy=$1
fi
