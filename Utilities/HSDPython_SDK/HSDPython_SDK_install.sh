...
if [ -z $1 ]
then
	python -m pip install st_hsdatalog/dist/GUI/st_hsdatalog-2.0.1-py3-none-any.whl
else
	python -m pip install st_hsdatalog/dist/GUI/st_hsdatalog-2.0.1-py3-none-any.whl --proxy=$1
fi
