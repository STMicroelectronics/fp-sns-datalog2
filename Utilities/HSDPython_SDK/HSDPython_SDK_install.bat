...
ECHO ===========================================
if "%proxy_string%"=="" (python -m pip install st_pnpl\dist\st_pnpl-2.1.0-py3-none-any.whl) else (python -m pip install st_pnpl\dist\st_pnpl-2.1.0-py3-none-any.whl --proxy %proxy_string%) 
:: Section 2: st_dtdl_gui
ECHO ===========================================
ECHO installing st_dtdl_gui...
ECHO ===========================================
if "%proxy_string%"=="" (python -m pip install st_dtdl_gui\dist\st_dtdl_gui-2.1.0-py3-none-any.whl) else (python -m pip install st_dtdl_gui\dist\st_dtdl_gui-2.1.0-py3-none-any.whl --proxy %proxy_string%) 
:: Section 3: st_hsdatalog (GUI version)
ECHO ===========================================
ECHO installing st_hsdatalog (GUI version)...
ECHO ===========================================
if "%proxy_string%"=="" (python -m pip install st_hsdatalog\dist\GUI\st_hsdatalog-3.0.1-py3-none-any.whl) else (python -m pip install st_hsdatalog\dist\GUI\st_hsdatalog-3.0.1-py3-none-any.whl --proxy %proxy_string%) 
