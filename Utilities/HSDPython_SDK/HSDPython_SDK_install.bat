...
ECHO ===========================================
if "%proxy_string%"=="" (python -m pip install st_hsdatalog\dist\GUI\st_hsdatalog-2.2.1-py3-none-any.whl) else (python -m pip install st_hsdatalog\dist\GUI\st_hsdatalog-2.2.1-py3-none-any.whl --proxy %proxy_string%) 
