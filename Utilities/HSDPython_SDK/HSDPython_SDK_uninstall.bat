...
ECHO ===========================================
python -m pip uninstall st_pnpl\dist\st_pnpl-1.2.0-py3-none-any.whl
:: Section 2: st_dtdl_gui
ECHO ===========================================
ECHO uninstalling st_dtdl_gui...
ECHO ===========================================
python -m pip uninstall st_dtdl_gui\dist\st_dtdl_gui-1.2.0-py3-none-any.whl
:: Section 3.1: st_hsdatalog (GUI version)
ECHO ===========================================
ECHO uninstalling st_hsdatalog (GUI version)...
ECHO ===========================================
python -m pip uninstall st_hsdatalog\dist\GUI\st_hsdatalog-2.2.0-py3-none-any.whl
:: Section 3.2: st_hsdatalog (NO GUI version)
ECHO ===========================================
ECHO uninstalling st_hsdatalog (NO GUI version)...
ECHO ===========================================
python -m pip uninstall st_hsdatalog\dist\noGUI\st_hsdatalog-2.2.0-py3-none-any.whl
