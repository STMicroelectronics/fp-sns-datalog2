...
STM32_Programmer_CLI.exe -c port=SWD freq=8000 ap=0 -d ..\..\..\Projects\STM32U585AI-SensorTile.boxPro\Applications\DATALOG2\Binary\DATALOG2_Release.bin 0x08000000 -rst
